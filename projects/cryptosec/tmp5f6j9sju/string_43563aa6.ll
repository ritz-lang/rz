...
define linkonce_odr i32 @"vec_set$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg", i8 %"item.arg") !dbg !52
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !513, metadata !7), !dbg !514
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !515, metadata !7), !dbg !514
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !516, metadata !7), !dbg !514
  %".10" = load i8, i8* %"item", !dbg !517
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !517
  %".12" = load i8*, i8** %".11", !dbg !517
  %".13" = load i64, i64* %"idx", !dbg !517
  %".14" = getelementptr i8, i8* %".12", i64 %".13" , !dbg !517
  store i8 %".10", i8* %".14", !dbg !517
  %".16" = trunc i64 0 to i32 , !dbg !518
  ret i32 %".16", !dbg !518
}

define linkonce_odr i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"needed.arg") !dbg !53
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !524
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !519, metadata !7), !dbg !520
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !521, metadata !7), !dbg !520
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !522
  %".8" = load i64, i64* %".7", !dbg !522
  %".9" = load i64, i64* %"needed", !dbg !522
  %".10" = icmp sge i64 %".8", %".9" , !dbg !522
  br i1 %".10", label %"if.then", label %"if.end", !dbg !522
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !523
  ret i32 %".12", !dbg !523
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !524
  %".15" = load i64, i64* %".14", !dbg !524
  store i64 %".15", i64* %"new_cap.addr", !dbg !524
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !525, metadata !7), !dbg !526
  %".18" = load i64, i64* %"new_cap.addr", !dbg !527
  %".19" = icmp eq i64 %".18", 0 , !dbg !527
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !527
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !528
  br label %"if.end.1", !dbg !528
if.end.1:
  br label %"while.cond", !dbg !529
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !529
  %".25" = load i64, i64* %"needed", !dbg !529
  %".26" = icmp slt i64 %".24", %".25" , !dbg !529
  br i1 %".26", label %"while.body", label %"while.end", !dbg !529
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !530
  %".29" = mul i64 %".28", 2, !dbg !530
  store i64 %".29", i64* %"new_cap.addr", !dbg !530
  br label %"while.cond", !dbg !530
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !531
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !531
  ret i32 %".33", !dbg !531
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !532, metadata !7), !dbg !533
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !534
  %".5" = load i8*, i8** %".4", !dbg !534
  %".6" = icmp ne i8* %".5", null , !dbg !534
  br i1 %".6", label %"if.then", label %"if.end", !dbg !534
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !534
  %".9" = load i8*, i8** %".8", !dbg !534
  %".10" = call i32 @"free"(i8* %".9"), !dbg !534
  br label %"if.end", !dbg !534
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !535
  store i8* null, i8** %".12", !dbg !535
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !536
  store i64 0, i64* %".14", !dbg !536
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !537
  store i64 0, i64* %".16", !dbg !537
  ret i32 0, !dbg !537
}

define linkonce_odr i8 @"vec_pop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !55
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !538, metadata !7), !dbg !539
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !540
  %".5" = load i64, i64* %".4", !dbg !540
  %".6" = sub i64 %".5", 1, !dbg !540
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !540
  store i64 %".6", i64* %".7", !dbg !540
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !541
  %".10" = load i8*, i8** %".9", !dbg !541
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !541
  %".12" = load i64, i64* %".11", !dbg !541
  %".13" = getelementptr i8, i8* %".10", i64 %".12" , !dbg !541
  %".14" = load i8, i8* %".13", !dbg !541
  ret i8 %".14", !dbg !541
}

define linkonce_odr i32 @"vec_push$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", %"struct.ritz_module_1.LineBounds" %"item.arg") !dbg !56
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !544, metadata !7), !dbg !545
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !547, metadata !7), !dbg !545
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !548
  %".8" = load i64, i64* %".7", !dbg !548
  %".9" = add i64 %".8", 1, !dbg !548
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !548
  %".11" = sext i32 %".10" to i64 , !dbg !548
  %".12" = icmp ne i64 %".11", 0 , !dbg !548
  br i1 %".12", label %"if.then", label %"if.end", !dbg !548
if.then:
  %".14" = sub i64 0, 1, !dbg !549
  %".15" = trunc i64 %".14" to i32 , !dbg !549
  ret i32 %".15", !dbg !549
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !550
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !550
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !550
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !550
  %".21" = load i64, i64* %".20", !dbg !550
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !550
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !550
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !551
  %".25" = load i64, i64* %".24", !dbg !551
  %".26" = add i64 %".25", 1, !dbg !551
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !551
  store i64 %".26", i64* %".27", !dbg !551
  %".29" = trunc i64 0 to i32 , !dbg !552
  ret i32 %".29", !dbg !552
}

define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !57
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !553, metadata !7), !dbg !554
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !555, metadata !7), !dbg !554
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !556
  %".8" = load i64, i64* %".7", !dbg !556
  %".9" = add i64 %".8", 1, !dbg !556
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !556
  %".11" = sext i32 %".10" to i64 , !dbg !556
  %".12" = icmp ne i64 %".11", 0 , !dbg !556
  br i1 %".12", label %"if.then", label %"if.end", !dbg !556
if.then:
  %".14" = sub i64 0, 1, !dbg !557
  %".15" = trunc i64 %".14" to i32 , !dbg !557
  ret i32 %".15", !dbg !557
if.end:
  %".17" = load i8, i8* %"item", !dbg !558
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !558
  %".19" = load i8*, i8** %".18", !dbg !558
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !558
  %".21" = load i64, i64* %".20", !dbg !558
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !558
  store i8 %".17", i8* %".22", !dbg !558
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !559
  %".25" = load i64, i64* %".24", !dbg !559
  %".26" = add i64 %".25", 1, !dbg !559
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !559
  store i64 %".26", i64* %".27", !dbg !559
  %".29" = trunc i64 0 to i32 , !dbg !560
  ret i32 %".29", !dbg !560
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !58
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !563
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !561, metadata !7), !dbg !562
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !564, metadata !7), !dbg !565
  %".6" = load i64, i64* %"cap", !dbg !566
  %".7" = icmp sle i64 %".6", 0 , !dbg !566
  br i1 %".7", label %"if.then", label %"if.end", !dbg !566
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !567
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !567
  store i8* null, i8** %".10", !dbg !567
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !568
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !568
  store i64 0, i64* %".13", !dbg !568
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !569
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !569
  store i64 0, i64* %".16", !dbg !569
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !570
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !570
if.end:
  %".20" = load i64, i64* %"cap", !dbg !571
  %".21" = mul i64 %".20", 1, !dbg !571
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !572
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !572
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !572
  store i8* %".22", i8** %".24", !dbg !572
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !573
  %".27" = load i8*, i8** %".26", !dbg !573
  %".28" = icmp eq i8* %".27", null , !dbg !573
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !573
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !574
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !574
  store i64 0, i64* %".31", !dbg !574
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !575
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !575
  store i64 0, i64* %".34", !dbg !575
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !576
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !576
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !577
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !577
  store i64 0, i64* %".39", !dbg !577
  %".41" = load i64, i64* %"cap", !dbg !578
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !578
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !578
  store i64 %".41", i64* %".43", !dbg !578
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !579
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !579
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !59
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !580, metadata !7), !dbg !581
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !582, metadata !7), !dbg !581
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !583
  %".8" = load i8*, i8** %".7", !dbg !583
  %".9" = load i64, i64* %"idx", !dbg !583
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !583
  %".11" = load i8, i8* %".10", !dbg !583
  ret i8 %".11", !dbg !583
}
...
entry:
  ...
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !586
  store i64 0, i64* %".4", !dbg !586
  ret i32 0, !dbg !586
}

define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !61
{
entry:
  %"i" = alloca i64, !dbg !591
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !587, metadata !7), !dbg !588
  %"data" = alloca i8*
  store i8* %"data.arg", i8** %"data"
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !589, metadata !7), !dbg !588
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !590, metadata !7), !dbg !588
  %".10" = load i64, i64* %"len", !dbg !591
  store i64 0, i64* %"i", !dbg !591
  br label %"for.cond", !dbg !591
for.cond:
  %".13" = load i64, i64* %"i", !dbg !591
  %".14" = icmp slt i64 %".13", %".10" , !dbg !591
  br i1 %".14", label %"for.body", label %"for.end", !dbg !591
for.body:
  %".16" = load i8*, i8** %"data", !dbg !591
  %".17" = load i64, i64* %"i", !dbg !591
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !591
  %".19" = load i8, i8* %".18", !dbg !591
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !591
  %".21" = sext i32 %".20" to i64 , !dbg !591
  %".22" = icmp ne i64 %".21", 0 , !dbg !591
  br i1 %".22", label %"if.then", label %"if.end", !dbg !591
for.incr:
  %".28" = load i64, i64* %"i", !dbg !592
  %".29" = add i64 %".28", 1, !dbg !592
  store i64 %".29", i64* %"i", !dbg !592
  br label %"for.cond", !dbg !592
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !593
  ret i32 %".32", !dbg !593
if.then:
  %".24" = sub i64 0, 1, !dbg !592
  %".25" = trunc i64 %".24" to i32 , !dbg !592
  ret i32 %".25", !dbg !592
if.end:
  br label %"for.incr", !dbg !592
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_new$u8"() !dbg !62
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !594
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !595, metadata !7), !dbg !596
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !597
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !597
  store i8* null, i8** %".4", !dbg !597
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !598
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !598
  store i64 0, i64* %".7", !dbg !598
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !599
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !599
  store i64 0, i64* %".10", !dbg !599
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !600
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !600
}
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/cryptosec/ritz/ritzlib", filename: "string.ritz")
...
!52 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 235, name: "vec_set$u8", scopeLine: 235, type: !4, unit: !1)
!53 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$u8", scopeLine: 193, type: !4, unit: !1)
!54 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
!55 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 219, name: "vec_pop$u8", scopeLine: 219, type: !4, unit: !1)
!56 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$LineBounds", scopeLine: 210, type: !4, unit: !1)
!57 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!58 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
!59 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
!60 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
!61 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 288, name: "vec_push_bytes$u8", scopeLine: 288, type: !4, unit: !1)
!62 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
...
!513 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !52, type: !512)
!514 = !DILocation(column: 1, line: 235, scope: !52)
!515 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !52, type: !11)
!516 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !52, type: !12)
!517 = !DILocation(column: 5, line: 236, scope: !52)
!518 = !DILocation(column: 5, line: 237, scope: !52)
!519 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !53, type: !512)
!520 = !DILocation(column: 1, line: 193, scope: !53)
!521 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !53, type: !11)
!522 = !DILocation(column: 5, line: 194, scope: !53)
!523 = !DILocation(column: 9, line: 195, scope: !53)
!524 = !DILocation(column: 5, line: 197, scope: !53)
!525 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !53, type: !11)
!526 = !DILocation(column: 1, line: 197, scope: !53)
!527 = !DILocation(column: 5, line: 198, scope: !53)
!528 = !DILocation(column: 9, line: 199, scope: !53)
!529 = !DILocation(column: 5, line: 200, scope: !53)
!530 = !DILocation(column: 9, line: 201, scope: !53)
!531 = !DILocation(column: 5, line: 203, scope: !53)
!532 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !54, type: !512)
!533 = !DILocation(column: 1, line: 148, scope: !54)
!534 = !DILocation(column: 5, line: 149, scope: !54)
!535 = !DILocation(column: 5, line: 151, scope: !54)
!536 = !DILocation(column: 5, line: 152, scope: !54)
!537 = !DILocation(column: 5, line: 153, scope: !54)
!538 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !55, type: !512)
!539 = !DILocation(column: 1, line: 219, scope: !55)
!540 = !DILocation(column: 5, line: 220, scope: !55)
!541 = !DILocation(column: 5, line: 221, scope: !55)
!542 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!543 = !DIDerivedType(baseType: !542, size: 64, tag: DW_TAG_reference_type)
!544 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !56, type: !543)
!545 = !DILocation(column: 1, line: 210, scope: !56)
!546 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!547 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !56, type: !546)
!548 = !DILocation(column: 5, line: 211, scope: !56)
!549 = !DILocation(column: 9, line: 212, scope: !56)
!550 = !DILocation(column: 5, line: 213, scope: !56)
!551 = !DILocation(column: 5, line: 214, scope: !56)
!552 = !DILocation(column: 5, line: 215, scope: !56)
!553 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !57, type: !512)
!554 = !DILocation(column: 1, line: 210, scope: !57)
!555 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !57, type: !12)
!556 = !DILocation(column: 5, line: 211, scope: !57)
!557 = !DILocation(column: 9, line: 212, scope: !57)
!558 = !DILocation(column: 5, line: 213, scope: !57)
!559 = !DILocation(column: 5, line: 214, scope: !57)
!560 = !DILocation(column: 5, line: 215, scope: !57)
!561 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !58, type: !11)
!562 = !DILocation(column: 1, line: 124, scope: !58)
!563 = !DILocation(column: 5, line: 125, scope: !58)
!564 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !58, type: !511)
!565 = !DILocation(column: 1, line: 125, scope: !58)
!566 = !DILocation(column: 5, line: 126, scope: !58)
!567 = !DILocation(column: 9, line: 127, scope: !58)
!568 = !DILocation(column: 9, line: 128, scope: !58)
!569 = !DILocation(column: 9, line: 129, scope: !58)
!570 = !DILocation(column: 9, line: 130, scope: !58)
!571 = !DILocation(column: 5, line: 132, scope: !58)
!572 = !DILocation(column: 5, line: 133, scope: !58)
!573 = !DILocation(column: 5, line: 134, scope: !58)
!574 = !DILocation(column: 9, line: 135, scope: !58)
!575 = !DILocation(column: 9, line: 136, scope: !58)
!576 = !DILocation(column: 9, line: 137, scope: !58)
!577 = !DILocation(column: 5, line: 139, scope: !58)
!578 = !DILocation(column: 5, line: 140, scope: !58)
!579 = !DILocation(column: 5, line: 141, scope: !58)
!580 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !59, type: !512)
!581 = !DILocation(column: 1, line: 225, scope: !59)
!582 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !59, type: !11)
!583 = !DILocation(column: 5, line: 226, scope: !59)
!584 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !60, type: !512)
!585 = !DILocation(column: 1, line: 244, scope: !60)
!586 = !DILocation(column: 5, line: 245, scope: !60)
!587 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !61, type: !512)
!588 = !DILocation(column: 1, line: 288, scope: !61)
!589 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !61, type: !89)
!590 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !61, type: !11)
!591 = !DILocation(column: 5, line: 289, scope: !61)
!592 = !DILocation(column: 13, line: 291, scope: !61)
!593 = !DILocation(column: 5, line: 292, scope: !61)
!594 = !DILocation(column: 5, line: 117, scope: !62)
!595 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !62, type: !511)
!596 = !DILocation(column: 1, line: 117, scope: !62)
!597 = !DILocation(column: 5, line: 118, scope: !62)
!598 = !DILocation(column: 5, line: 119, scope: !62)
!599 = !DILocation(column: 5, line: 120, scope: !62)
!600 = !DILocation(column: 5, line: 121, scope: !62)
...
!613 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !64, type: !543)
...
!626 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !65, type: !543)
