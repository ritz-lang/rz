...
define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !22
{
entry:
  %"i" = alloca i64, !dbg !119
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !115, metadata !7), !dbg !116
  %"data" = alloca i8*
  store i8* %"data.arg", i8** %"data"
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !117, metadata !7), !dbg !116
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !118, metadata !7), !dbg !116
  %".10" = load i64, i64* %"len", !dbg !119
  store i64 0, i64* %"i", !dbg !119
  br label %"for.cond", !dbg !119
for.cond:
  %".13" = load i64, i64* %"i", !dbg !119
  %".14" = icmp slt i64 %".13", %".10" , !dbg !119
  br i1 %".14", label %"for.body", label %"for.end", !dbg !119
for.body:
  %".16" = load i8*, i8** %"data", !dbg !119
  %".17" = load i64, i64* %"i", !dbg !119
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !119
  %".19" = load i8, i8* %".18", !dbg !119
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !119
  %".21" = sext i32 %".20" to i64 , !dbg !119
  %".22" = icmp ne i64 %".21", 0 , !dbg !119
  br i1 %".22", label %"if.then", label %"if.end", !dbg !119
for.incr:
  %".28" = load i64, i64* %"i", !dbg !120
  %".29" = add i64 %".28", 1, !dbg !120
  store i64 %".29", i64* %"i", !dbg !120
  br label %"for.cond", !dbg !120
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !121
  ret i32 %".32", !dbg !121
if.then:
  %".24" = sub i64 0, 1, !dbg !120
  %".25" = trunc i64 %".24" to i32 , !dbg !120
  ret i32 %".25", !dbg !120
if.end:
  br label %"for.incr", !dbg !120
}

define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !23
{
entry:
  ...
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !125
  %".8" = load i64, i64* %".7", !dbg !125
  %".9" = add i64 %".8", 1, !dbg !125
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !125
  %".11" = sext i32 %".10" to i64 , !dbg !125
  %".12" = icmp ne i64 %".11", 0 , !dbg !125
  br i1 %".12", label %"if.then", label %"if.end", !dbg !125
if.then:
  %".14" = sub i64 0, 1, !dbg !126
  %".15" = trunc i64 %".14" to i32 , !dbg !126
  ret i32 %".15", !dbg !126
if.end:
  %".17" = load i8, i8* %"item", !dbg !127
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !127
  %".19" = load i8*, i8** %".18", !dbg !127
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !127
  %".21" = load i64, i64* %".20", !dbg !127
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !127
  store i8 %".17", i8* %".22", !dbg !127
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !128
  %".25" = load i64, i64* %".24", !dbg !128
  %".26" = add i64 %".25", 1, !dbg !128
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !128
  store i64 %".26", i64* %".27", !dbg !128
  %".29" = trunc i64 0 to i32 , !dbg !129
  ret i32 %".29", !dbg !129
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !130, metadata !7), !dbg !131
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !132, metadata !7), !dbg !131
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !133
  %".8" = load i64, i64* %".7", !dbg !133
  %".9" = add i64 %".8", 1, !dbg !133
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !133
...
if.then:
  ...
  ret i32 %".15", !dbg !134
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !135
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !135
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !135
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !135
  %".21" = load i64, i64* %".20", !dbg !135
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !135
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !135
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !136
  %".25" = load i64, i64* %".24", !dbg !136
  %".26" = add i64 %".25", 1, !dbg !136
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !136
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/cryptosec/ritz/ritzlib", filename: "gvec.ritz")
...
!22 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 288, name: "vec_push_bytes$u8", scopeLine: 288, type: !4, unit: !1)
!23 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
...
!115 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !22, type: !29)
!116 = !DILocation(column: 1, line: 288, scope: !22)
!117 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !22, type: !32)
!118 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !22, type: !11)
!119 = !DILocation(column: 5, line: 289, scope: !22)
!120 = !DILocation(column: 13, line: 291, scope: !22)
!121 = !DILocation(column: 5, line: 292, scope: !22)
!122 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !23, type: !29)
!123 = !DILocation(column: 1, line: 210, scope: !23)
!124 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !23, type: !12)
!125 = !DILocation(column: 5, line: 211, scope: !23)
!126 = !DILocation(column: 9, line: 212, scope: !23)
!127 = !DILocation(column: 5, line: 213, scope: !23)
!128 = !DILocation(column: 5, line: 214, scope: !23)
!129 = !DILocation(column: 5, line: 215, scope: !23)
!130 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !24, type: !74)
!131 = !DILocation(column: 1, line: 210, scope: !24)
!132 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !24, type: !85)
