...
define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !40
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !276
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !274, metadata !7), !dbg !275
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !278, metadata !7), !dbg !279
  %".6" = load i64, i64* %"cap", !dbg !280
  %".7" = icmp sle i64 %".6", 0 , !dbg !280
  br i1 %".7", label %"if.then", label %"if.end", !dbg !280
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !281
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !281
  store i8* null, i8** %".10", !dbg !281
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !282
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !282
  store i64 0, i64* %".13", !dbg !282
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !283
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !283
  store i64 0, i64* %".16", !dbg !283
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !284
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !284
if.end:
  %".20" = load i64, i64* %"cap", !dbg !285
  %".21" = mul i64 %".20", 1, !dbg !285
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !286
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !286
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !286
  store i8* %".22", i8** %".24", !dbg !286
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !287
  %".27" = load i8*, i8** %".26", !dbg !287
  %".28" = icmp eq i8* %".27", null , !dbg !287
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !287
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !288
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !288
  store i64 0, i64* %".31", !dbg !288
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !289
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !289
  store i64 0, i64* %".34", !dbg !289
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !290
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !290
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !291
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !291
  store i64 0, i64* %".39", !dbg !291
  %".41" = load i64, i64* %"cap", !dbg !292
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !292
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !292
  store i64 %".41", i64* %".43", !dbg !292
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !293
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !293
}

define linkonce_odr i32 @"vec_drop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !41
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !295, metadata !7), !dbg !296
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !297
  %".5" = load i8*, i8** %".4", !dbg !297
  %".6" = icmp ne i8* %".5", null , !dbg !297
  br i1 %".6", label %"if.then", label %"if.end", !dbg !297
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !297
  %".9" = load i8*, i8** %".8", !dbg !297
  %".10" = call i32 @"free"(i8* %".9"), !dbg !297
  br label %"if.end", !dbg !297
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !298
  store i8* null, i8** %".12", !dbg !298
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !299
  store i64 0, i64* %".14", !dbg !299
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !300
  store i64 0, i64* %".16", !dbg !300
  ret i32 0, !dbg !300
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !42
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !301, metadata !7), !dbg !302
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !303, metadata !7), !dbg !302
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !304
  %".8" = load i8*, i8** %".7", !dbg !304
  %".9" = load i64, i64* %"idx", !dbg !304
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !304
  %".11" = load i8, i8* %".10", !dbg !304
  ret i8 %".11", !dbg !304
}

define linkonce_odr i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"needed.arg") !dbg !43
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !310
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !305, metadata !7), !dbg !306
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !307, metadata !7), !dbg !306
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !308
  %".8" = load i64, i64* %".7", !dbg !308
  %".9" = load i64, i64* %"needed", !dbg !308
  %".10" = icmp sge i64 %".8", %".9" , !dbg !308
  br i1 %".10", label %"if.then", label %"if.end", !dbg !308
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !309
  ret i32 %".12", !dbg !309
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !310
  %".15" = load i64, i64* %".14", !dbg !310
  store i64 %".15", i64* %"new_cap.addr", !dbg !310
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !311, metadata !7), !dbg !312
  %".18" = load i64, i64* %"new_cap.addr", !dbg !313
  %".19" = icmp eq i64 %".18", 0 , !dbg !313
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !313
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !314
  br label %"if.end.1", !dbg !314
if.end.1:
  br label %"while.cond", !dbg !315
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !315
  %".25" = load i64, i64* %"needed", !dbg !315
  %".26" = icmp slt i64 %".24", %".25" , !dbg !315
  br i1 %".26", label %"while.body", label %"while.end", !dbg !315
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !316
  %".29" = mul i64 %".28", 2, !dbg !316
  store i64 %".29", i64* %"new_cap.addr", !dbg !316
  br label %"while.cond", !dbg !316
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !317
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !317
  ret i32 %".33", !dbg !317
}

define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !44
{
entry:
  %"i" = alloca i64, !dbg !322
  ...
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !320, metadata !7), !dbg !319
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !321, metadata !7), !dbg !319
  %".10" = load i64, i64* %"len", !dbg !322
  store i64 0, i64* %"i", !dbg !322
  br label %"for.cond", !dbg !322
for.cond:
  %".13" = load i64, i64* %"i", !dbg !322
  %".14" = icmp slt i64 %".13", %".10" , !dbg !322
  br i1 %".14", label %"for.body", label %"for.end", !dbg !322
for.body:
  %".16" = load i8*, i8** %"data", !dbg !322
  %".17" = load i64, i64* %"i", !dbg !322
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !322
  %".19" = load i8, i8* %".18", !dbg !322
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !322
  %".21" = sext i32 %".20" to i64 , !dbg !322
  %".22" = icmp ne i64 %".21", 0 , !dbg !322
  br i1 %".22", label %"if.then", label %"if.end", !dbg !322
for.incr:
  %".28" = load i64, i64* %"i", !dbg !323
  %".29" = add i64 %".28", 1, !dbg !323
  store i64 %".29", i64* %"i", !dbg !323
  br label %"for.cond", !dbg !323
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !324
  ret i32 %".32", !dbg !324
if.then:
  %".24" = sub i64 0, 1, !dbg !323
  %".25" = trunc i64 %".24" to i32 , !dbg !323
  ret i32 %".25", !dbg !323
if.end:
  br label %"for.incr", !dbg !323
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_new$u8"() !dbg !45
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !325
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !326, metadata !7), !dbg !327
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !328
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !328
  store i8* null, i8** %".4", !dbg !328
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !329
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !329
  store i64 0, i64* %".7", !dbg !329
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !330
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !330
  store i64 0, i64* %".10", !dbg !330
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !331
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !331
}

define linkonce_odr i8 @"vec_pop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !46
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !332, metadata !7), !dbg !333
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !334
  %".5" = load i64, i64* %".4", !dbg !334
  %".6" = sub i64 %".5", 1, !dbg !334
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !334
  store i64 %".6", i64* %".7", !dbg !334
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !335
  %".10" = load i8*, i8** %".9", !dbg !335
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !335
  %".12" = load i64, i64* %".11", !dbg !335
  %".13" = getelementptr i8, i8* %".10", i64 %".12" , !dbg !335
  %".14" = load i8, i8* %".13", !dbg !335
  ret i8 %".14", !dbg !335
}

define linkonce_odr i32 @"vec_set$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg", i8 %"item.arg") !dbg !47
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !336, metadata !7), !dbg !337
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !338, metadata !7), !dbg !337
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !339, metadata !7), !dbg !337
  %".10" = load i8, i8* %"item", !dbg !340
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !340
  %".12" = load i8*, i8** %".11", !dbg !340
  %".13" = load i64, i64* %"idx", !dbg !340
  %".14" = getelementptr i8, i8* %".12", i64 %".13" , !dbg !340
  store i8 %".10", i8* %".14", !dbg !340
  %".16" = trunc i64 0 to i32 , !dbg !341
  ret i32 %".16", !dbg !341
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !344, metadata !7), !dbg !345
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !347, metadata !7), !dbg !345
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !348
  %".8" = load i64, i64* %".7", !dbg !348
  %".9" = add i64 %".8", 1, !dbg !348
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !348
  %".11" = sext i32 %".10" to i64 , !dbg !348
  %".12" = icmp ne i64 %".11", 0 , !dbg !348
  br i1 %".12", label %"if.then", label %"if.end", !dbg !348
if.then:
  %".14" = sub i64 0, 1, !dbg !349
  %".15" = trunc i64 %".14" to i32 , !dbg !349
  ret i32 %".15", !dbg !349
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !350
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !350
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !350
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !350
  %".21" = load i64, i64* %".20", !dbg !350
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !350
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !350
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !351
  %".25" = load i64, i64* %".24", !dbg !351
  %".26" = add i64 %".25", 1, !dbg !351
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !351
  store i64 %".26", i64* %".27", !dbg !351
  %".29" = trunc i64 0 to i32 , !dbg !352
  ret i32 %".29", !dbg !352
}

define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !49
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !353, metadata !7), !dbg !354
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !355, metadata !7), !dbg !354
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !356
  %".8" = load i64, i64* %".7", !dbg !356
  %".9" = add i64 %".8", 1, !dbg !356
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !356
  %".11" = sext i32 %".10" to i64 , !dbg !356
  %".12" = icmp ne i64 %".11", 0 , !dbg !356
  br i1 %".12", label %"if.then", label %"if.end", !dbg !356
if.then:
  %".14" = sub i64 0, 1, !dbg !357
  %".15" = trunc i64 %".14" to i32 , !dbg !357
  ret i32 %".15", !dbg !357
if.end:
  %".17" = load i8, i8* %"item", !dbg !358
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !358
  %".19" = load i8*, i8** %".18", !dbg !358
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !358
  %".21" = load i64, i64* %".20", !dbg !358
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !358
  store i8 %".17", i8* %".22", !dbg !358
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !359
  %".25" = load i64, i64* %".24", !dbg !359
  %".26" = add i64 %".25", 1, !dbg !359
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !359
  store i64 %".26", i64* %".27", !dbg !359
  %".29" = trunc i64 0 to i32 , !dbg !360
  ret i32 %".29", !dbg !360
}

define linkonce_odr i32 @"vec_clear$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !50
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !361, metadata !7), !dbg !362
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !363
  store i64 0, i64* %".4", !dbg !363
  ret i32 0, !dbg !363
}
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/cryptosec/ritz/ritzlib", filename: "io.ritz")
...
!40 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
!41 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
!42 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
!43 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$u8", scopeLine: 193, type: !4, unit: !1)
!44 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 288, name: "vec_push_bytes$u8", scopeLine: 288, type: !4, unit: !1)
!45 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
!46 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 219, name: "vec_pop$u8", scopeLine: 219, type: !4, unit: !1)
!47 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 235, name: "vec_set$u8", scopeLine: 235, type: !4, unit: !1)
...
!49 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!50 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
...
!274 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !40, type: !11)
!275 = !DILocation(column: 1, line: 124, scope: !40)
!276 = !DILocation(column: 5, line: 125, scope: !40)
!277 = !DICompositeType(align: 64, file: !0, name: "Vec$u8", size: 192, tag: DW_TAG_structure_type)
!278 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !40, type: !277)
!279 = !DILocation(column: 1, line: 125, scope: !40)
!280 = !DILocation(column: 5, line: 126, scope: !40)
!281 = !DILocation(column: 9, line: 127, scope: !40)
!282 = !DILocation(column: 9, line: 128, scope: !40)
!283 = !DILocation(column: 9, line: 129, scope: !40)
!284 = !DILocation(column: 9, line: 130, scope: !40)
!285 = !DILocation(column: 5, line: 132, scope: !40)
!286 = !DILocation(column: 5, line: 133, scope: !40)
!287 = !DILocation(column: 5, line: 134, scope: !40)
!288 = !DILocation(column: 9, line: 135, scope: !40)
!289 = !DILocation(column: 9, line: 136, scope: !40)
!290 = !DILocation(column: 9, line: 137, scope: !40)
!291 = !DILocation(column: 5, line: 139, scope: !40)
!292 = !DILocation(column: 5, line: 140, scope: !40)
!293 = !DILocation(column: 5, line: 141, scope: !40)
!294 = !DIDerivedType(baseType: !277, size: 64, tag: DW_TAG_reference_type)
!295 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !41, type: !294)
!296 = !DILocation(column: 1, line: 148, scope: !41)
!297 = !DILocation(column: 5, line: 149, scope: !41)
!298 = !DILocation(column: 5, line: 151, scope: !41)
!299 = !DILocation(column: 5, line: 152, scope: !41)
!300 = !DILocation(column: 5, line: 153, scope: !41)
!301 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !42, type: !294)
!302 = !DILocation(column: 1, line: 225, scope: !42)
!303 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !42, type: !11)
!304 = !DILocation(column: 5, line: 226, scope: !42)
!305 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !43, type: !294)
!306 = !DILocation(column: 1, line: 193, scope: !43)
!307 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !43, type: !11)
!308 = !DILocation(column: 5, line: 194, scope: !43)
!309 = !DILocation(column: 9, line: 195, scope: !43)
!310 = !DILocation(column: 5, line: 197, scope: !43)
!311 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !43, type: !11)
!312 = !DILocation(column: 1, line: 197, scope: !43)
!313 = !DILocation(column: 5, line: 198, scope: !43)
!314 = !DILocation(column: 9, line: 199, scope: !43)
!315 = !DILocation(column: 5, line: 200, scope: !43)
!316 = !DILocation(column: 9, line: 201, scope: !43)
!317 = !DILocation(column: 5, line: 203, scope: !43)
!318 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !44, type: !294)
!319 = !DILocation(column: 1, line: 288, scope: !44)
!320 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !44, type: !61)
!321 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !44, type: !11)
!322 = !DILocation(column: 5, line: 289, scope: !44)
!323 = !DILocation(column: 13, line: 291, scope: !44)
!324 = !DILocation(column: 5, line: 292, scope: !44)
!325 = !DILocation(column: 5, line: 117, scope: !45)
!326 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !45, type: !277)
!327 = !DILocation(column: 1, line: 117, scope: !45)
!328 = !DILocation(column: 5, line: 118, scope: !45)
!329 = !DILocation(column: 5, line: 119, scope: !45)
!330 = !DILocation(column: 5, line: 120, scope: !45)
!331 = !DILocation(column: 5, line: 121, scope: !45)
!332 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !46, type: !294)
!333 = !DILocation(column: 1, line: 219, scope: !46)
!334 = !DILocation(column: 5, line: 220, scope: !46)
!335 = !DILocation(column: 5, line: 221, scope: !46)
!336 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !47, type: !294)
!337 = !DILocation(column: 1, line: 235, scope: !47)
!338 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !47, type: !11)
!339 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !47, type: !12)
!340 = !DILocation(column: 5, line: 236, scope: !47)
!341 = !DILocation(column: 5, line: 237, scope: !47)
...
!344 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !48, type: !343)
!345 = !DILocation(column: 1, line: 210, scope: !48)
!346 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!347 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !48, type: !346)
!348 = !DILocation(column: 5, line: 211, scope: !48)
!349 = !DILocation(column: 9, line: 212, scope: !48)
!350 = !DILocation(column: 5, line: 213, scope: !48)
!351 = !DILocation(column: 5, line: 214, scope: !48)
!352 = !DILocation(column: 5, line: 215, scope: !48)
!353 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !49, type: !294)
!354 = !DILocation(column: 1, line: 210, scope: !49)
!355 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !49, type: !12)
!356 = !DILocation(column: 5, line: 211, scope: !49)
!357 = !DILocation(column: 9, line: 212, scope: !49)
!358 = !DILocation(column: 5, line: 213, scope: !49)
!359 = !DILocation(column: 5, line: 214, scope: !49)
!360 = !DILocation(column: 5, line: 215, scope: !49)
!361 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !50, type: !294)
!362 = !DILocation(column: 1, line: 244, scope: !50)
!363 = !DILocation(column: 5, line: 245, scope: !50)
!364 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !51, type: !343)
...
!377 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !52, type: !294)
...
!389 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !53, type: !343)
