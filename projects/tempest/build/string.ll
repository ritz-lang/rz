...
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !518
  ...
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !515, metadata !7), !dbg !514
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !516
  %".8" = load i64, i64* %".7", !dbg !516
  %".9" = load i64, i64* %"needed", !dbg !516
  %".10" = icmp sge i64 %".8", %".9" , !dbg !516
  br i1 %".10", label %"if.then", label %"if.end", !dbg !516
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !517
  ret i32 %".12", !dbg !517
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !518
  %".15" = load i64, i64* %".14", !dbg !518
  store i64 %".15", i64* %"new_cap.addr", !dbg !518
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !519, metadata !7), !dbg !520
  %".18" = load i64, i64* %"new_cap.addr", !dbg !521
  %".19" = icmp eq i64 %".18", 0 , !dbg !521
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !521
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !522
  br label %"if.end.1", !dbg !522
if.end.1:
  br label %"while.cond", !dbg !523
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !523
  %".25" = load i64, i64* %"needed", !dbg !523
  %".26" = icmp slt i64 %".24", %".25" , !dbg !523
  br i1 %".26", label %"while.body", label %"while.end", !dbg !523
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !524
  %".29" = mul i64 %".28", 2, !dbg !524
  store i64 %".29", i64* %"new_cap.addr", !dbg !524
  br label %"while.cond", !dbg !524
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !525
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !525
  ret i32 %".33", !dbg !525
}
...
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !526
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !527, metadata !7), !dbg !528
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !529
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !529
  store i8* null, i8** %".4", !dbg !529
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !530
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !530
  store i64 0, i64* %".7", !dbg !530
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !531
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !531
  store i64 0, i64* %".10", !dbg !531
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !532
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !532
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !54
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !535
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !533, metadata !7), !dbg !534
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !536, metadata !7), !dbg !537
  %".6" = load i64, i64* %"cap", !dbg !538
  %".7" = icmp sle i64 %".6", 0 , !dbg !538
  br i1 %".7", label %"if.then", label %"if.end", !dbg !538
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !539
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !539
  store i8* null, i8** %".10", !dbg !539
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !540
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !540
  store i64 0, i64* %".13", !dbg !540
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !541
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !541
  store i64 0, i64* %".16", !dbg !541
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !542
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !542
if.end:
  %".20" = load i64, i64* %"cap", !dbg !543
  %".21" = mul i64 %".20", 1, !dbg !543
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !544
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !544
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !544
  store i8* %".22", i8** %".24", !dbg !544
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !545
  %".27" = load i8*, i8** %".26", !dbg !545
  %".28" = icmp eq i8* %".27", null , !dbg !545
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !545
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !546
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !546
  store i64 0, i64* %".31", !dbg !546
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !547
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !547
  store i64 0, i64* %".34", !dbg !547
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !548
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !548
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !549
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !549
  store i64 0, i64* %".39", !dbg !549
  %".41" = load i64, i64* %"cap", !dbg !550
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !550
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !550
  store i64 %".41", i64* %".43", !dbg !550
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !551
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !551
}

define linkonce_odr i8 @"vec_pop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !55
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !552, metadata !7), !dbg !553
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !554
  %".5" = load i64, i64* %".4", !dbg !554
  %".6" = sub i64 %".5", 1, !dbg !554
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !554
  store i64 %".6", i64* %".7", !dbg !554
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !555
  %".10" = load i8*, i8** %".9", !dbg !555
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !555
  %".12" = load i64, i64* %".11", !dbg !555
  %".13" = getelementptr i8, i8* %".10", i64 %".12" , !dbg !555
  %".14" = load i8, i8* %".13", !dbg !555
  ret i8 %".14", !dbg !555
}

define linkonce_odr i32 @"vec_set$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg", i8 %"item.arg") !dbg !56
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !556, metadata !7), !dbg !557
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !558, metadata !7), !dbg !557
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !559, metadata !7), !dbg !557
  %".10" = load i8, i8* %"item", !dbg !560
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !560
  %".12" = load i8*, i8** %".11", !dbg !560
  %".13" = load i64, i64* %"idx", !dbg !560
  %".14" = getelementptr i8, i8* %".12", i64 %".13" , !dbg !560
  store i8 %".10", i8* %".14", !dbg !560
  %".16" = trunc i64 0 to i32 , !dbg !561
  ret i32 %".16", !dbg !561
}
...
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !564, metadata !7), !dbg !563
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !565, metadata !7), !dbg !563
  %".10" = load i64, i64* %"len", !dbg !566
  store i64 0, i64* %"i", !dbg !566
  br label %"for.cond", !dbg !566
for.cond:
  %".13" = load i64, i64* %"i", !dbg !566
  %".14" = icmp slt i64 %".13", %".10" , !dbg !566
  br i1 %".14", label %"for.body", label %"for.end", !dbg !566
for.body:
  %".16" = load i8*, i8** %"data", !dbg !566
  %".17" = load i64, i64* %"i", !dbg !566
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !566
  %".19" = load i8, i8* %".18", !dbg !566
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !566
  %".21" = sext i32 %".20" to i64 , !dbg !566
  %".22" = icmp ne i64 %".21", 0 , !dbg !566
  br i1 %".22", label %"if.then", label %"if.end", !dbg !566
for.incr:
  %".28" = load i64, i64* %"i", !dbg !567
  %".29" = add i64 %".28", 1, !dbg !567
  store i64 %".29", i64* %"i", !dbg !567
  br label %"for.cond", !dbg !567
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !568
  ret i32 %".32", !dbg !568
if.then:
  %".24" = sub i64 0, 1, !dbg !567
  %".25" = trunc i64 %".24" to i32 , !dbg !567
  ret i32 %".25", !dbg !567
if.end:
  br label %"for.incr", !dbg !567
}

define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !58
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !569, metadata !7), !dbg !570
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !571, metadata !7), !dbg !570
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !572
  %".8" = load i64, i64* %".7", !dbg !572
  %".9" = add i64 %".8", 1, !dbg !572
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !572
  %".11" = sext i32 %".10" to i64 , !dbg !572
  %".12" = icmp ne i64 %".11", 0 , !dbg !572
  br i1 %".12", label %"if.then", label %"if.end", !dbg !572
if.then:
  %".14" = sub i64 0, 1, !dbg !573
  %".15" = trunc i64 %".14" to i32 , !dbg !573
  ret i32 %".15", !dbg !573
if.end:
  %".17" = load i8, i8* %"item", !dbg !574
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !574
  %".19" = load i8*, i8** %".18", !dbg !574
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !574
  %".21" = load i64, i64* %".20", !dbg !574
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !574
  store i8 %".17", i8* %".22", !dbg !574
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !575
  %".25" = load i64, i64* %".24", !dbg !575
  %".26" = add i64 %".25", 1, !dbg !575
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !575
  store i64 %".26", i64* %".27", !dbg !575
  %".29" = trunc i64 0 to i32 , !dbg !576
  ret i32 %".29", !dbg !576
}

define linkonce_odr i32 @"vec_clear$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !59
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !577, metadata !7), !dbg !578
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !579
  store i64 0, i64* %".4", !dbg !579
  ret i32 0, !dbg !579
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !60
{
entry:
...
entry:
  ...
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !586
  %".5" = load i8*, i8** %".4", !dbg !586
  %".6" = icmp ne i8* %".5", null , !dbg !586
  br i1 %".6", label %"if.then", label %"if.end", !dbg !586
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !586
  %".9" = load i8*, i8** %".8", !dbg !586
  %".10" = call i32 @"free"(i8* %".9"), !dbg !586
  br label %"if.end", !dbg !586
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !587
  store i8* null, i8** %".12", !dbg !587
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !588
  store i64 0, i64* %".14", !dbg !588
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !589
  store i64 0, i64* %".16", !dbg !589
  ret i32 0, !dbg !589
}

define linkonce_odr i32 @"vec_push$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", %"struct.ritz_module_1.LineBounds" %"item.arg") !dbg !62
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !592, metadata !7), !dbg !593
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !595, metadata !7), !dbg !593
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !596
  %".8" = load i64, i64* %".7", !dbg !596
  %".9" = add i64 %".8", 1, !dbg !596
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !596
  %".11" = sext i32 %".10" to i64 , !dbg !596
  %".12" = icmp ne i64 %".11", 0 , !dbg !596
  br i1 %".12", label %"if.then", label %"if.end", !dbg !596
if.then:
  %".14" = sub i64 0, 1, !dbg !597
  %".15" = trunc i64 %".14" to i32 , !dbg !597
  ret i32 %".15", !dbg !597
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !598
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !598
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !598
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !598
  %".21" = load i64, i64* %".20", !dbg !598
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !598
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !598
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !599
  %".25" = load i64, i64* %".24", !dbg !599
  %".26" = add i64 %".25", 1, !dbg !599
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !599
  store i64 %".26", i64* %".27", !dbg !599
  %".29" = trunc i64 0 to i32 , !dbg !600
  ret i32 %".29", !dbg !600
}
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/ritzunit/ritz/ritzlib", filename: "string.ritz")
...
!54 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
!55 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 219, name: "vec_pop$u8", scopeLine: 219, type: !4, unit: !1)
!56 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 235, name: "vec_set$u8", scopeLine: 235, type: !4, unit: !1)
...
!58 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!59 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
!60 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
!61 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
!62 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$LineBounds", scopeLine: 210, type: !4, unit: !1)
...
!513 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !52, type: !512)
!514 = !DILocation(column: 1, line: 193, scope: !52)
!515 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !52, type: !11)
!516 = !DILocation(column: 5, line: 194, scope: !52)
!517 = !DILocation(column: 9, line: 195, scope: !52)
!518 = !DILocation(column: 5, line: 197, scope: !52)
!519 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !52, type: !11)
!520 = !DILocation(column: 1, line: 197, scope: !52)
!521 = !DILocation(column: 5, line: 198, scope: !52)
!522 = !DILocation(column: 9, line: 199, scope: !52)
!523 = !DILocation(column: 5, line: 200, scope: !52)
!524 = !DILocation(column: 9, line: 201, scope: !52)
!525 = !DILocation(column: 5, line: 203, scope: !52)
!526 = !DILocation(column: 5, line: 117, scope: !53)
!527 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !53, type: !511)
!528 = !DILocation(column: 1, line: 117, scope: !53)
!529 = !DILocation(column: 5, line: 118, scope: !53)
!530 = !DILocation(column: 5, line: 119, scope: !53)
!531 = !DILocation(column: 5, line: 120, scope: !53)
!532 = !DILocation(column: 5, line: 121, scope: !53)
!533 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !54, type: !11)
!534 = !DILocation(column: 1, line: 124, scope: !54)
!535 = !DILocation(column: 5, line: 125, scope: !54)
!536 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !54, type: !511)
!537 = !DILocation(column: 1, line: 125, scope: !54)
!538 = !DILocation(column: 5, line: 126, scope: !54)
!539 = !DILocation(column: 9, line: 127, scope: !54)
!540 = !DILocation(column: 9, line: 128, scope: !54)
!541 = !DILocation(column: 9, line: 129, scope: !54)
!542 = !DILocation(column: 9, line: 130, scope: !54)
!543 = !DILocation(column: 5, line: 132, scope: !54)
!544 = !DILocation(column: 5, line: 133, scope: !54)
!545 = !DILocation(column: 5, line: 134, scope: !54)
!546 = !DILocation(column: 9, line: 135, scope: !54)
!547 = !DILocation(column: 9, line: 136, scope: !54)
!548 = !DILocation(column: 9, line: 137, scope: !54)
!549 = !DILocation(column: 5, line: 139, scope: !54)
!550 = !DILocation(column: 5, line: 140, scope: !54)
!551 = !DILocation(column: 5, line: 141, scope: !54)
!552 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !55, type: !512)
!553 = !DILocation(column: 1, line: 219, scope: !55)
!554 = !DILocation(column: 5, line: 220, scope: !55)
!555 = !DILocation(column: 5, line: 221, scope: !55)
!556 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !56, type: !512)
!557 = !DILocation(column: 1, line: 235, scope: !56)
!558 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !56, type: !11)
!559 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !56, type: !12)
!560 = !DILocation(column: 5, line: 236, scope: !56)
!561 = !DILocation(column: 5, line: 237, scope: !56)
!562 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !57, type: !512)
!563 = !DILocation(column: 1, line: 288, scope: !57)
!564 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !57, type: !89)
!565 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !57, type: !11)
!566 = !DILocation(column: 5, line: 289, scope: !57)
!567 = !DILocation(column: 13, line: 291, scope: !57)
!568 = !DILocation(column: 5, line: 292, scope: !57)
!569 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !58, type: !512)
!570 = !DILocation(column: 1, line: 210, scope: !58)
!571 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !58, type: !12)
!572 = !DILocation(column: 5, line: 211, scope: !58)
!573 = !DILocation(column: 9, line: 212, scope: !58)
!574 = !DILocation(column: 5, line: 213, scope: !58)
!575 = !DILocation(column: 5, line: 214, scope: !58)
!576 = !DILocation(column: 5, line: 215, scope: !58)
!577 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !59, type: !512)
!578 = !DILocation(column: 1, line: 244, scope: !59)
!579 = !DILocation(column: 5, line: 245, scope: !59)
!580 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !60, type: !512)
!581 = !DILocation(column: 1, line: 225, scope: !60)
!582 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !60, type: !11)
!583 = !DILocation(column: 5, line: 226, scope: !60)
!584 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !61, type: !512)
!585 = !DILocation(column: 1, line: 148, scope: !61)
!586 = !DILocation(column: 5, line: 149, scope: !61)
!587 = !DILocation(column: 5, line: 151, scope: !61)
!588 = !DILocation(column: 5, line: 152, scope: !61)
!589 = !DILocation(column: 5, line: 153, scope: !61)
!590 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!591 = !DIDerivedType(baseType: !590, size: 64, tag: DW_TAG_reference_type)
!592 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !62, type: !591)
!593 = !DILocation(column: 1, line: 210, scope: !62)
!594 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!595 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !62, type: !594)
!596 = !DILocation(column: 5, line: 211, scope: !62)
!597 = !DILocation(column: 9, line: 212, scope: !62)
!598 = !DILocation(column: 5, line: 213, scope: !62)
!599 = !DILocation(column: 5, line: 214, scope: !62)
!600 = !DILocation(column: 5, line: 215, scope: !62)
...
!613 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !64, type: !591)
...
!626 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !65, type: !591)
