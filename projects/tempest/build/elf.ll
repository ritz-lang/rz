...
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !197
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !195, metadata !7), !dbg !196
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !199, metadata !7), !dbg !200
  %".6" = load i64, i64* %"cap", !dbg !201
  %".7" = icmp sle i64 %".6", 0 , !dbg !201
  br i1 %".7", label %"if.then", label %"if.end", !dbg !201
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !202
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !202
  store i8* null, i8** %".10", !dbg !202
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !203
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !203
  store i64 0, i64* %".13", !dbg !203
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !204
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !204
  store i64 0, i64* %".16", !dbg !204
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !205
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !205
if.end:
  %".20" = load i64, i64* %"cap", !dbg !206
  %".21" = mul i64 %".20", 1, !dbg !206
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !207
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !207
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !207
  store i8* %".22", i8** %".24", !dbg !207
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !208
  %".27" = load i8*, i8** %".26", !dbg !208
  %".28" = icmp eq i8* %".27", null , !dbg !208
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !208
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !209
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !209
  store i64 0, i64* %".31", !dbg !209
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !210
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !210
  store i64 0, i64* %".34", !dbg !210
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !211
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !211
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !212
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !212
  store i64 0, i64* %".39", !dbg !212
  %".41" = load i64, i64* %"cap", !dbg !213
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !213
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !213
  store i64 %".41", i64* %".43", !dbg !213
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !214
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !214
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_new$u8"() !dbg !31
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !215
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !216, metadata !7), !dbg !217
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !218
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !218
  store i8* null, i8** %".4", !dbg !218
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !219
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !219
  store i64 0, i64* %".7", !dbg !219
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !220
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !220
  store i64 0, i64* %".10", !dbg !220
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !221
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !221
}

define linkonce_odr i32 @"vec_drop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !32
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !223, metadata !7), !dbg !224
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !225
  %".5" = load i8*, i8** %".4", !dbg !225
  %".6" = icmp ne i8* %".5", null , !dbg !225
  br i1 %".6", label %"if.then", label %"if.end", !dbg !225
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !225
  %".9" = load i8*, i8** %".8", !dbg !225
  %".10" = call i32 @"free"(i8* %".9"), !dbg !225
  br label %"if.end", !dbg !225
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !226
  store i8* null, i8** %".12", !dbg !226
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !227
  store i64 0, i64* %".14", !dbg !227
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !228
  store i64 0, i64* %".16", !dbg !228
  ret i32 0, !dbg !228
}
...
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !231, metadata !7), !dbg !230
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !232, metadata !7), !dbg !230
  %".10" = load i8, i8* %"item", !dbg !233
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !233
  %".12" = load i8*, i8** %".11", !dbg !233
  %".13" = load i64, i64* %"idx", !dbg !233
  %".14" = getelementptr i8, i8* %".12", i64 %".13" , !dbg !233
  store i8 %".10", i8* %".14", !dbg !233
  %".16" = trunc i64 0 to i32 , !dbg !234
  ret i32 %".16", !dbg !234
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !34
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !235, metadata !7), !dbg !236
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !237, metadata !7), !dbg !236
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !238
  %".8" = load i8*, i8** %".7", !dbg !238
  %".9" = load i64, i64* %"idx", !dbg !238
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !238
  %".11" = load i8, i8* %".10", !dbg !238
  ret i8 %".11", !dbg !238
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !241, metadata !7), !dbg !242
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !244, metadata !7), !dbg !242
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !245
  %".8" = load i64, i64* %".7", !dbg !245
  %".9" = add i64 %".8", 1, !dbg !245
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !245
  %".11" = sext i32 %".10" to i64 , !dbg !245
  %".12" = icmp ne i64 %".11", 0 , !dbg !245
  br i1 %".12", label %"if.then", label %"if.end", !dbg !245
if.then:
  %".14" = sub i64 0, 1, !dbg !246
  %".15" = trunc i64 %".14" to i32 , !dbg !246
  ret i32 %".15", !dbg !246
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !247
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !247
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !247
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !247
  %".21" = load i64, i64* %".20", !dbg !247
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !247
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !247
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !248
  %".25" = load i64, i64* %".24", !dbg !248
  %".26" = add i64 %".25", 1, !dbg !248
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !248
  store i64 %".26", i64* %".27", !dbg !248
  %".29" = trunc i64 0 to i32 , !dbg !249
  ret i32 %".29", !dbg !249
}

define linkonce_odr i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"needed.arg") !dbg !36
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !255
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !250, metadata !7), !dbg !251
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !252, metadata !7), !dbg !251
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !253
  %".8" = load i64, i64* %".7", !dbg !253
  %".9" = load i64, i64* %"needed", !dbg !253
  %".10" = icmp sge i64 %".8", %".9" , !dbg !253
  br i1 %".10", label %"if.then", label %"if.end", !dbg !253
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !254
  ret i32 %".12", !dbg !254
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !255
  %".15" = load i64, i64* %".14", !dbg !255
  store i64 %".15", i64* %"new_cap.addr", !dbg !255
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !256, metadata !7), !dbg !257
  %".18" = load i64, i64* %"new_cap.addr", !dbg !258
  %".19" = icmp eq i64 %".18", 0 , !dbg !258
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !258
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !259
  br label %"if.end.1", !dbg !259
if.end.1:
  br label %"while.cond", !dbg !260
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !260
  %".25" = load i64, i64* %"needed", !dbg !260
  %".26" = icmp slt i64 %".24", %".25" , !dbg !260
  br i1 %".26", label %"while.body", label %"while.end", !dbg !260
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !261
  %".29" = mul i64 %".28", 2, !dbg !261
  store i64 %".29", i64* %"new_cap.addr", !dbg !261
  br label %"while.cond", !dbg !261
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !262
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !262
  ret i32 %".33", !dbg !262
}
...
entry:
  ...
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !265
  %".5" = load i64, i64* %".4", !dbg !265
  %".6" = sub i64 %".5", 1, !dbg !265
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !265
  store i64 %".6", i64* %".7", !dbg !265
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !266
  %".10" = load i8*, i8** %".9", !dbg !266
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !266
  %".12" = load i64, i64* %".11", !dbg !266
  %".13" = getelementptr i8, i8* %".10", i64 %".12" , !dbg !266
  %".14" = load i8, i8* %".13", !dbg !266
  ret i8 %".14", !dbg !266
}

define linkonce_odr i32 @"vec_clear$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !38
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !267, metadata !7), !dbg !268
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !269
  store i64 0, i64* %".4", !dbg !269
  ret i32 0, !dbg !269
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !270, metadata !7), !dbg !271
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !272, metadata !7), !dbg !271
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !273
  %".8" = load i64, i64* %".7", !dbg !273
  %".9" = add i64 %".8", 1, !dbg !273
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !273
  %".11" = sext i32 %".10" to i64 , !dbg !273
  %".12" = icmp ne i64 %".11", 0 , !dbg !273
  br i1 %".12", label %"if.then", label %"if.end", !dbg !273
if.then:
  %".14" = sub i64 0, 1, !dbg !274
  %".15" = trunc i64 %".14" to i32 , !dbg !274
  ret i32 %".15", !dbg !274
if.end:
  %".17" = load i8, i8* %"item", !dbg !275
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !275
  %".19" = load i8*, i8** %".18", !dbg !275
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !275
  %".21" = load i64, i64* %".20", !dbg !275
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !275
  store i8 %".17", i8* %".22", !dbg !275
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !276
  %".25" = load i64, i64* %".24", !dbg !276
  %".26" = add i64 %".25", 1, !dbg !276
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !276
  store i64 %".26", i64* %".27", !dbg !276
  %".29" = trunc i64 0 to i32 , !dbg !277
  ret i32 %".29", !dbg !277
}
...
{
entry:
  %"i" = alloca i64, !dbg !282
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !278, metadata !7), !dbg !279
  %"data" = alloca i8*
  store i8* %"data.arg", i8** %"data"
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !280, metadata !7), !dbg !279
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !281, metadata !7), !dbg !279
  %".10" = load i64, i64* %"len", !dbg !282
  store i64 0, i64* %"i", !dbg !282
  br label %"for.cond", !dbg !282
for.cond:
  %".13" = load i64, i64* %"i", !dbg !282
  %".14" = icmp slt i64 %".13", %".10" , !dbg !282
  br i1 %".14", label %"for.body", label %"for.end", !dbg !282
for.body:
  %".16" = load i8*, i8** %"data", !dbg !282
  %".17" = load i64, i64* %"i", !dbg !282
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !282
  %".19" = load i8, i8* %".18", !dbg !282
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !282
  %".21" = sext i32 %".20" to i64 , !dbg !282
  %".22" = icmp ne i64 %".21", 0 , !dbg !282
  br i1 %".22", label %"if.then", label %"if.end", !dbg !282
for.incr:
  %".28" = load i64, i64* %"i", !dbg !283
  %".29" = add i64 %".28", 1, !dbg !283
  store i64 %".29", i64* %"i", !dbg !283
  br label %"for.cond", !dbg !283
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !284
  ret i32 %".32", !dbg !284
if.then:
  %".24" = sub i64 0, 1, !dbg !283
  %".25" = trunc i64 %".24" to i32 , !dbg !283
  ret i32 %".25", !dbg !283
if.end:
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/ritzunit/ritz/ritzlib", filename: "elf.ritz")
...
!31 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
!32 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
!33 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 235, name: "vec_set$u8", scopeLine: 235, type: !4, unit: !1)
!34 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
...
!36 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$u8", scopeLine: 193, type: !4, unit: !1)
!37 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 219, name: "vec_pop$u8", scopeLine: 219, type: !4, unit: !1)
!38 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
...
!195 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !30, type: !11)
!196 = !DILocation(column: 1, line: 124, scope: !30)
!197 = !DILocation(column: 5, line: 125, scope: !30)
!198 = !DICompositeType(align: 64, file: !0, name: "Vec$u8", size: 192, tag: DW_TAG_structure_type)
!199 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !30, type: !198)
!200 = !DILocation(column: 1, line: 125, scope: !30)
!201 = !DILocation(column: 5, line: 126, scope: !30)
!202 = !DILocation(column: 9, line: 127, scope: !30)
!203 = !DILocation(column: 9, line: 128, scope: !30)
!204 = !DILocation(column: 9, line: 129, scope: !30)
!205 = !DILocation(column: 9, line: 130, scope: !30)
!206 = !DILocation(column: 5, line: 132, scope: !30)
!207 = !DILocation(column: 5, line: 133, scope: !30)
!208 = !DILocation(column: 5, line: 134, scope: !30)
!209 = !DILocation(column: 9, line: 135, scope: !30)
!210 = !DILocation(column: 9, line: 136, scope: !30)
!211 = !DILocation(column: 9, line: 137, scope: !30)
!212 = !DILocation(column: 5, line: 139, scope: !30)
!213 = !DILocation(column: 5, line: 140, scope: !30)
!214 = !DILocation(column: 5, line: 141, scope: !30)
!215 = !DILocation(column: 5, line: 117, scope: !31)
!216 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !31, type: !198)
!217 = !DILocation(column: 1, line: 117, scope: !31)
!218 = !DILocation(column: 5, line: 118, scope: !31)
!219 = !DILocation(column: 5, line: 119, scope: !31)
!220 = !DILocation(column: 5, line: 120, scope: !31)
!221 = !DILocation(column: 5, line: 121, scope: !31)
!222 = !DIDerivedType(baseType: !198, size: 64, tag: DW_TAG_reference_type)
!223 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !32, type: !222)
!224 = !DILocation(column: 1, line: 148, scope: !32)
!225 = !DILocation(column: 5, line: 149, scope: !32)
!226 = !DILocation(column: 5, line: 151, scope: !32)
!227 = !DILocation(column: 5, line: 152, scope: !32)
!228 = !DILocation(column: 5, line: 153, scope: !32)
!229 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !33, type: !222)
!230 = !DILocation(column: 1, line: 235, scope: !33)
!231 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !33, type: !11)
!232 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !33, type: !12)
!233 = !DILocation(column: 5, line: 236, scope: !33)
!234 = !DILocation(column: 5, line: 237, scope: !33)
!235 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !34, type: !222)
!236 = !DILocation(column: 1, line: 225, scope: !34)
!237 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !34, type: !11)
!238 = !DILocation(column: 5, line: 226, scope: !34)
!239 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!240 = !DIDerivedType(baseType: !239, size: 64, tag: DW_TAG_reference_type)
!241 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !35, type: !240)
!242 = !DILocation(column: 1, line: 210, scope: !35)
!243 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!244 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !35, type: !243)
!245 = !DILocation(column: 5, line: 211, scope: !35)
!246 = !DILocation(column: 9, line: 212, scope: !35)
!247 = !DILocation(column: 5, line: 213, scope: !35)
!248 = !DILocation(column: 5, line: 214, scope: !35)
!249 = !DILocation(column: 5, line: 215, scope: !35)
!250 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !36, type: !222)
!251 = !DILocation(column: 1, line: 193, scope: !36)
!252 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !36, type: !11)
!253 = !DILocation(column: 5, line: 194, scope: !36)
!254 = !DILocation(column: 9, line: 195, scope: !36)
!255 = !DILocation(column: 5, line: 197, scope: !36)
!256 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !36, type: !11)
!257 = !DILocation(column: 1, line: 197, scope: !36)
!258 = !DILocation(column: 5, line: 198, scope: !36)
!259 = !DILocation(column: 9, line: 199, scope: !36)
!260 = !DILocation(column: 5, line: 200, scope: !36)
!261 = !DILocation(column: 9, line: 201, scope: !36)
!262 = !DILocation(column: 5, line: 203, scope: !36)
!263 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !37, type: !222)
!264 = !DILocation(column: 1, line: 219, scope: !37)
!265 = !DILocation(column: 5, line: 220, scope: !37)
!266 = !DILocation(column: 5, line: 221, scope: !37)
!267 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !38, type: !222)
!268 = !DILocation(column: 1, line: 244, scope: !38)
!269 = !DILocation(column: 5, line: 245, scope: !38)
!270 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !39, type: !222)
!271 = !DILocation(column: 1, line: 210, scope: !39)
!272 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !39, type: !12)
!273 = !DILocation(column: 5, line: 211, scope: !39)
!274 = !DILocation(column: 9, line: 212, scope: !39)
!275 = !DILocation(column: 5, line: 213, scope: !39)
!276 = !DILocation(column: 5, line: 214, scope: !39)
!277 = !DILocation(column: 5, line: 215, scope: !39)
!278 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !40, type: !222)
!279 = !DILocation(column: 1, line: 288, scope: !40)
!280 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !40, type: !48)
!281 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !40, type: !11)
!282 = !DILocation(column: 5, line: 289, scope: !40)
!283 = !DILocation(column: 13, line: 291, scope: !40)
!284 = !DILocation(column: 5, line: 292, scope: !40)
!285 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !41, type: !240)
...
!298 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !42, type: !222)
...
!310 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !43, type: !240)
