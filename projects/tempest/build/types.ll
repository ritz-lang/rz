...
define linkonce_odr i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"new_cap.arg") !dbg !24
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !104, metadata !7), !dbg !105
  %"new_cap" = alloca i64
  store i64 %"new_cap.arg", i64* %"new_cap"
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap", metadata !106, metadata !7), !dbg !105
  %".7" = load i64, i64* %"new_cap", !dbg !107
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !107
  %".9" = load i64, i64* %".8", !dbg !107
  %".10" = icmp sle i64 %".7", %".9" , !dbg !107
  br i1 %".10", label %"if.then", label %"if.end", !dbg !107
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !108
  ret i32 %".12", !dbg !108
if.end:
  %".14" = load i64, i64* %"new_cap", !dbg !109
  %".15" = mul i64 %".14", 1, !dbg !109
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !110
  %".17" = load i8*, i8** %".16", !dbg !110
  %".18" = call i8* @"realloc"(i8* %".17", i64 %".15"), !dbg !110
  %".19" = icmp eq i8* %".18", null , !dbg !111
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !111
if.then.1:
  %".21" = sub i64 0, 1, !dbg !112
  %".22" = trunc i64 %".21" to i32 , !dbg !112
  ret i32 %".22", !dbg !112
if.end.1:
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !113
  store i8* %".18", i8** %".24", !dbg !113
  %".26" = load i64, i64* %"new_cap", !dbg !114
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !114
  store i64 %".26", i64* %".27", !dbg !114
  %".29" = trunc i64 0 to i32 , !dbg !115
  ret i32 %".29", !dbg !115
}
...
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !121
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !116, metadata !7), !dbg !117
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !118, metadata !7), !dbg !117
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !119
  %".8" = load i64, i64* %".7", !dbg !119
  %".9" = load i64, i64* %"needed", !dbg !119
  %".10" = icmp sge i64 %".8", %".9" , !dbg !119
  br i1 %".10", label %"if.then", label %"if.end", !dbg !119
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !120
  ret i32 %".12", !dbg !120
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !121
  %".15" = load i64, i64* %".14", !dbg !121
  store i64 %".15", i64* %"new_cap.addr", !dbg !121
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !122, metadata !7), !dbg !123
  %".18" = load i64, i64* %"new_cap.addr", !dbg !124
  %".19" = icmp eq i64 %".18", 0 , !dbg !124
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !124
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !125
  br label %"if.end.1", !dbg !125
if.end.1:
  br label %"while.cond", !dbg !126
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !126
  %".25" = load i64, i64* %"needed", !dbg !126
  %".26" = icmp slt i64 %".24", %".25" , !dbg !126
  br i1 %".26", label %"while.body", label %"while.end", !dbg !126
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !127
  %".29" = mul i64 %".28", 2, !dbg !127
  store i64 %".29", i64* %"new_cap.addr", !dbg !127
  br label %"while.cond", !dbg !127
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !128
  %".33" = call i32 @"vec_grow$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".32"), !dbg !128
  ret i32 %".33", !dbg !128
}
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/ritzunit/src", filename: "types.ritz")
...
!24 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 179, name: "vec_grow$u8", scopeLine: 179, type: !4, unit: !1)
...
!104 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !24, type: !63)
!105 = !DILocation(column: 1, line: 179, scope: !24)
!106 = !DILocalVariable(file: !0, line: 179, name: "new_cap", scope: !24, type: !11)
!107 = !DILocation(column: 5, line: 180, scope: !24)
!108 = !DILocation(column: 9, line: 181, scope: !24)
!109 = !DILocation(column: 5, line: 183, scope: !24)
!110 = !DILocation(column: 5, line: 184, scope: !24)
!111 = !DILocation(column: 5, line: 185, scope: !24)
!112 = !DILocation(column: 9, line: 186, scope: !24)
!113 = !DILocation(column: 5, line: 188, scope: !24)
!114 = !DILocation(column: 5, line: 189, scope: !24)
!115 = !DILocation(column: 5, line: 190, scope: !24)
!116 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !25, type: !94)
!117 = !DILocation(column: 1, line: 193, scope: !25)
!118 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !25, type: !11)
!119 = !DILocation(column: 5, line: 194, scope: !25)
!120 = !DILocation(column: 9, line: 195, scope: !25)
!121 = !DILocation(column: 5, line: 197, scope: !25)
!122 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !25, type: !11)
!123 = !DILocation(column: 1, line: 197, scope: !25)
!124 = !DILocation(column: 5, line: 198, scope: !25)
!125 = !DILocation(column: 9, line: 199, scope: !25)
!126 = !DILocation(column: 5, line: 200, scope: !25)
!127 = !DILocation(column: 9, line: 201, scope: !25)
!128 = !DILocation(column: 5, line: 203, scope: !25)
