...
define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !22
{
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !112, metadata !7), !dbg !111
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !113
  %".8" = load i64, i64* %".7", !dbg !113
  %".9" = add i64 %".8", 1, !dbg !113
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !113
  %".11" = sext i32 %".10" to i64 , !dbg !113
  %".12" = icmp ne i64 %".11", 0 , !dbg !113
  br i1 %".12", label %"if.then", label %"if.end", !dbg !113
if.then:
  %".14" = sub i64 0, 1, !dbg !114
  %".15" = trunc i64 %".14" to i32 , !dbg !114
  ret i32 %".15", !dbg !114
if.end:
  %".17" = load i8, i8* %"item", !dbg !115
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !115
  %".19" = load i8*, i8** %".18", !dbg !115
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !115
  %".21" = load i64, i64* %".20", !dbg !115
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !115
  store i8 %".17", i8* %".22", !dbg !115
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !116
  %".25" = load i64, i64* %".24", !dbg !116
  %".26" = add i64 %".25", 1, !dbg !116
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !116
  store i64 %".26", i64* %".27", !dbg !116
  %".29" = trunc i64 0 to i32 , !dbg !117
  ret i32 %".29", !dbg !117
}
...
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !123
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !118, metadata !7), !dbg !119
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !120, metadata !7), !dbg !119
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !121
  %".8" = load i64, i64* %".7", !dbg !121
  %".9" = load i64, i64* %"needed", !dbg !121
  %".10" = icmp sge i64 %".8", %".9" , !dbg !121
  br i1 %".10", label %"if.then", label %"if.end", !dbg !121
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !122
  ret i32 %".12", !dbg !122
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !123
  %".15" = load i64, i64* %".14", !dbg !123
  store i64 %".15", i64* %"new_cap.addr", !dbg !123
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !124, metadata !7), !dbg !125
  %".18" = load i64, i64* %"new_cap.addr", !dbg !126
  %".19" = icmp eq i64 %".18", 0 , !dbg !126
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !126
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !127
  br label %"if.end.1", !dbg !127
if.end.1:
  br label %"while.cond", !dbg !128
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !128
  %".25" = load i64, i64* %"needed", !dbg !128
  %".26" = icmp slt i64 %".24", %".25" , !dbg !128
  br i1 %".26", label %"while.body", label %"while.end", !dbg !128
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !129
  %".29" = mul i64 %".28", 2, !dbg !129
  store i64 %".29", i64* %"new_cap.addr", !dbg !129
  br label %"while.cond", !dbg !129
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !130
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !130
  ret i32 %".33", !dbg !130
}
...
entry:
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !131, metadata !7), !dbg !132
  %"data" = alloca i8*
  store i8* %"data.arg", i8** %"data"
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !133, metadata !7), !dbg !132
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !134, metadata !7), !dbg !132
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/iris/ritzunit/ritz/ritzlib", filename: "gvec.ritz")
...
!22 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
...
!110 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !22, type: !29)
!111 = !DILocation(column: 1, line: 210, scope: !22)
!112 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !22, type: !12)
!113 = !DILocation(column: 5, line: 211, scope: !22)
!114 = !DILocation(column: 9, line: 212, scope: !22)
!115 = !DILocation(column: 5, line: 213, scope: !22)
!116 = !DILocation(column: 5, line: 214, scope: !22)
!117 = !DILocation(column: 5, line: 215, scope: !22)
!118 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !23, type: !29)
!119 = !DILocation(column: 1, line: 193, scope: !23)
!120 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !23, type: !11)
!121 = !DILocation(column: 5, line: 194, scope: !23)
!122 = !DILocation(column: 9, line: 195, scope: !23)
!123 = !DILocation(column: 5, line: 197, scope: !23)
!124 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !23, type: !11)
!125 = !DILocation(column: 1, line: 197, scope: !23)
!126 = !DILocation(column: 5, line: 198, scope: !23)
!127 = !DILocation(column: 9, line: 199, scope: !23)
!128 = !DILocation(column: 5, line: 200, scope: !23)
!129 = !DILocation(column: 9, line: 201, scope: !23)
!130 = !DILocation(column: 5, line: 203, scope: !23)
!131 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !24, type: !29)
!132 = !DILocation(column: 1, line: 288, scope: !24)
!133 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !24, type: !32)
!134 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !24, type: !11)
!135 = !DILocation(column: 5, line: 289, scope: !24)
!136 = !DILocation(column: 13, line: 291, scope: !24)
!137 = !DILocation(column: 5, line: 292, scope: !24)
