...
define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !40
{
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !278, metadata !7), !dbg !277
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !279
  %".8" = load i64, i64* %".7", !dbg !279
  %".9" = add i64 %".8", 1, !dbg !279
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !279
  %".11" = sext i32 %".10" to i64 , !dbg !279
  %".12" = icmp ne i64 %".11", 0 , !dbg !279
  br i1 %".12", label %"if.then", label %"if.end", !dbg !279
if.then:
  %".14" = sub i64 0, 1, !dbg !280
  %".15" = trunc i64 %".14" to i32 , !dbg !280
  ret i32 %".15", !dbg !280
if.end:
  %".17" = load i8, i8* %"item", !dbg !281
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !281
  %".19" = load i8*, i8** %".18", !dbg !281
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !281
  %".21" = load i64, i64* %".20", !dbg !281
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !281
  store i8 %".17", i8* %".22", !dbg !281
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !282
  %".25" = load i64, i64* %".24", !dbg !282
  %".26" = add i64 %".25", 1, !dbg !282
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !282
  store i64 %".26", i64* %".27", !dbg !282
  %".29" = trunc i64 0 to i32 , !dbg !283
  ret i32 %".29", !dbg !283
}

define linkonce_odr i8 @"vec_pop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !41
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !284, metadata !7), !dbg !285
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !286
  %".5" = load i64, i64* %".4", !dbg !286
  %".6" = sub i64 %".5", 1, !dbg !286
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !286
  store i64 %".6", i64* %".7", !dbg !286
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !287
  %".10" = load i8*, i8** %".9", !dbg !287
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !287
  %".12" = load i64, i64* %".11", !dbg !287
  %".13" = getelementptr i8, i8* %".10", i64 %".12" , !dbg !287
  %".14" = load i8, i8* %".13", !dbg !287
  ret i8 %".14", !dbg !287
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !288, metadata !7), !dbg !289
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !290
  store i64 0, i64* %".4", !dbg !290
  ret i32 0, !dbg !290
}

define linkonce_odr i32 @"vec_push$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", %"struct.ritz_module_1.LineBounds" %"item.arg") !dbg !43
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !293, metadata !7), !dbg !294
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !296, metadata !7), !dbg !294
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !297
  %".8" = load i64, i64* %".7", !dbg !297
  %".9" = add i64 %".8", 1, !dbg !297
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !297
  %".11" = sext i32 %".10" to i64 , !dbg !297
  %".12" = icmp ne i64 %".11", 0 , !dbg !297
  br i1 %".12", label %"if.then", label %"if.end", !dbg !297
if.then:
  %".14" = sub i64 0, 1, !dbg !298
  %".15" = trunc i64 %".14" to i32 , !dbg !298
  ret i32 %".15", !dbg !298
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !299
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !299
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !299
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !299
  %".21" = load i64, i64* %".20", !dbg !299
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !299
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !299
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !300
  %".25" = load i64, i64* %".24", !dbg !300
  %".26" = add i64 %".25", 1, !dbg !300
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !300
  store i64 %".26", i64* %".27", !dbg !300
  %".29" = trunc i64 0 to i32 , !dbg !301
  ret i32 %".29", !dbg !301
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !44
{
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !304, metadata !7), !dbg !303
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !305
  %".8" = load i8*, i8** %".7", !dbg !305
  %".9" = load i64, i64* %"idx", !dbg !305
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !305
  %".11" = load i8, i8* %".10", !dbg !305
  ret i8 %".11", !dbg !305
}

define linkonce_odr i32 @"vec_set$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg", i8 %"item.arg") !dbg !45
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !306, metadata !7), !dbg !307
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !308, metadata !7), !dbg !307
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !309, metadata !7), !dbg !307
  %".10" = load i8, i8* %"item", !dbg !310
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !310
  %".12" = load i8*, i8** %".11", !dbg !310
  %".13" = load i64, i64* %"idx", !dbg !310
  %".14" = getelementptr i8, i8* %".12", i64 %".13" , !dbg !310
  store i8 %".10", i8* %".14", !dbg !310
  %".16" = trunc i64 0 to i32 , !dbg !311
  ret i32 %".16", !dbg !311
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_new$u8"() !dbg !46
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !312
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !313, metadata !7), !dbg !314
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !315
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !315
  store i8* null, i8** %".4", !dbg !315
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !316
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !316
  store i64 0, i64* %".7", !dbg !316
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !317
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !317
  store i64 0, i64* %".10", !dbg !317
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !318
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !318
}

define linkonce_odr i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"needed.arg") !dbg !47
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !324
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !319, metadata !7), !dbg !320
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !321, metadata !7), !dbg !320
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !322
  %".8" = load i64, i64* %".7", !dbg !322
  %".9" = load i64, i64* %"needed", !dbg !322
  %".10" = icmp sge i64 %".8", %".9" , !dbg !322
  br i1 %".10", label %"if.then", label %"if.end", !dbg !322
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !323
  ret i32 %".12", !dbg !323
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !324
  %".15" = load i64, i64* %".14", !dbg !324
  store i64 %".15", i64* %"new_cap.addr", !dbg !324
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !325, metadata !7), !dbg !326
  %".18" = load i64, i64* %"new_cap.addr", !dbg !327
  %".19" = icmp eq i64 %".18", 0 , !dbg !327
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !327
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !328
  br label %"if.end.1", !dbg !328
if.end.1:
  br label %"while.cond", !dbg !329
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !329
  %".25" = load i64, i64* %"needed", !dbg !329
  %".26" = icmp slt i64 %".24", %".25" , !dbg !329
  br i1 %".26", label %"while.body", label %"while.end", !dbg !329
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !330
  %".29" = mul i64 %".28", 2, !dbg !330
  store i64 %".29", i64* %"new_cap.addr", !dbg !330
  br label %"while.cond", !dbg !330
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !331
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !331
  ret i32 %".33", !dbg !331
}

define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !48
{
entry:
  %"i" = alloca i64, !dbg !336
  ...
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !334, metadata !7), !dbg !333
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !335, metadata !7), !dbg !333
  %".10" = load i64, i64* %"len", !dbg !336
  store i64 0, i64* %"i", !dbg !336
  br label %"for.cond", !dbg !336
for.cond:
  %".13" = load i64, i64* %"i", !dbg !336
  %".14" = icmp slt i64 %".13", %".10" , !dbg !336
  br i1 %".14", label %"for.body", label %"for.end", !dbg !336
for.body:
  %".16" = load i8*, i8** %"data", !dbg !336
  %".17" = load i64, i64* %"i", !dbg !336
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !336
  %".19" = load i8, i8* %".18", !dbg !336
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !336
  %".21" = sext i32 %".20" to i64 , !dbg !336
  %".22" = icmp ne i64 %".21", 0 , !dbg !336
  br i1 %".22", label %"if.then", label %"if.end", !dbg !336
for.incr:
  %".28" = load i64, i64* %"i", !dbg !337
  %".29" = add i64 %".28", 1, !dbg !337
  store i64 %".29", i64* %"i", !dbg !337
  br label %"for.cond", !dbg !337
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !338
  ret i32 %".32", !dbg !338
if.then:
  %".24" = sub i64 0, 1, !dbg !337
  %".25" = trunc i64 %".24" to i32 , !dbg !337
  ret i32 %".25", !dbg !337
if.end:
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !339, metadata !7), !dbg !340
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !341
  %".5" = load i8*, i8** %".4", !dbg !341
  %".6" = icmp ne i8* %".5", null , !dbg !341
  br i1 %".6", label %"if.then", label %"if.end", !dbg !341
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !341
  %".9" = load i8*, i8** %".8", !dbg !341
  %".10" = call i32 @"free"(i8* %".9"), !dbg !341
  br label %"if.end", !dbg !341
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !342
  store i8* null, i8** %".12", !dbg !342
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !343
  store i64 0, i64* %".14", !dbg !343
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !344
  store i64 0, i64* %".16", !dbg !344
  ret i32 0, !dbg !344
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !50
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !347
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !345, metadata !7), !dbg !346
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !348, metadata !7), !dbg !349
  %".6" = load i64, i64* %"cap", !dbg !350
  %".7" = icmp sle i64 %".6", 0 , !dbg !350
  br i1 %".7", label %"if.then", label %"if.end", !dbg !350
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !351
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !351
  store i8* null, i8** %".10", !dbg !351
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !352
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !352
  store i64 0, i64* %".13", !dbg !352
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !353
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !353
  store i64 0, i64* %".16", !dbg !353
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !354
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !354
if.end:
  %".20" = load i64, i64* %"cap", !dbg !355
  %".21" = mul i64 %".20", 1, !dbg !355
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !356
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !356
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !356
  store i8* %".22", i8** %".24", !dbg !356
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !357
  %".27" = load i8*, i8** %".26", !dbg !357
  %".28" = icmp eq i8* %".27", null , !dbg !357
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !357
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !358
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !358
  store i64 0, i64* %".31", !dbg !358
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !359
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !359
  store i64 0, i64* %".34", !dbg !359
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !360
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !360
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !361
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !361
  store i64 0, i64* %".39", !dbg !361
  %".41" = load i64, i64* %"cap", !dbg !362
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !362
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !362
  store i64 %".41", i64* %".43", !dbg !362
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !363
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !363
}
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/iris/ritzunit/ritz/ritzlib", filename: "io.ritz")
...
!40 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!41 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 219, name: "vec_pop$u8", scopeLine: 219, type: !4, unit: !1)
!42 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
!43 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$LineBounds", scopeLine: 210, type: !4, unit: !1)
!44 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
!45 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 235, name: "vec_set$u8", scopeLine: 235, type: !4, unit: !1)
!46 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
...
!48 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 288, name: "vec_push_bytes$u8", scopeLine: 288, type: !4, unit: !1)
!49 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
!50 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
...
!276 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !40, type: !275)
!277 = !DILocation(column: 1, line: 210, scope: !40)
!278 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !40, type: !12)
!279 = !DILocation(column: 5, line: 211, scope: !40)
!280 = !DILocation(column: 9, line: 212, scope: !40)
!281 = !DILocation(column: 5, line: 213, scope: !40)
!282 = !DILocation(column: 5, line: 214, scope: !40)
!283 = !DILocation(column: 5, line: 215, scope: !40)
!284 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !41, type: !275)
!285 = !DILocation(column: 1, line: 219, scope: !41)
!286 = !DILocation(column: 5, line: 220, scope: !41)
!287 = !DILocation(column: 5, line: 221, scope: !41)
!288 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !42, type: !275)
!289 = !DILocation(column: 1, line: 244, scope: !42)
!290 = !DILocation(column: 5, line: 245, scope: !42)
!291 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!292 = !DIDerivedType(baseType: !291, size: 64, tag: DW_TAG_reference_type)
!293 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !43, type: !292)
!294 = !DILocation(column: 1, line: 210, scope: !43)
!295 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!296 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !43, type: !295)
!297 = !DILocation(column: 5, line: 211, scope: !43)
!298 = !DILocation(column: 9, line: 212, scope: !43)
!299 = !DILocation(column: 5, line: 213, scope: !43)
!300 = !DILocation(column: 5, line: 214, scope: !43)
!301 = !DILocation(column: 5, line: 215, scope: !43)
!302 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !44, type: !275)
!303 = !DILocation(column: 1, line: 225, scope: !44)
!304 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !44, type: !11)
!305 = !DILocation(column: 5, line: 226, scope: !44)
!306 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !45, type: !275)
!307 = !DILocation(column: 1, line: 235, scope: !45)
!308 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !45, type: !11)
!309 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !45, type: !12)
!310 = !DILocation(column: 5, line: 236, scope: !45)
!311 = !DILocation(column: 5, line: 237, scope: !45)
!312 = !DILocation(column: 5, line: 117, scope: !46)
!313 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !46, type: !274)
!314 = !DILocation(column: 1, line: 117, scope: !46)
!315 = !DILocation(column: 5, line: 118, scope: !46)
!316 = !DILocation(column: 5, line: 119, scope: !46)
!317 = !DILocation(column: 5, line: 120, scope: !46)
!318 = !DILocation(column: 5, line: 121, scope: !46)
!319 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !47, type: !275)
!320 = !DILocation(column: 1, line: 193, scope: !47)
!321 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !47, type: !11)
!322 = !DILocation(column: 5, line: 194, scope: !47)
!323 = !DILocation(column: 9, line: 195, scope: !47)
!324 = !DILocation(column: 5, line: 197, scope: !47)
!325 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !47, type: !11)
!326 = !DILocation(column: 1, line: 197, scope: !47)
!327 = !DILocation(column: 5, line: 198, scope: !47)
!328 = !DILocation(column: 9, line: 199, scope: !47)
!329 = !DILocation(column: 5, line: 200, scope: !47)
!330 = !DILocation(column: 9, line: 201, scope: !47)
!331 = !DILocation(column: 5, line: 203, scope: !47)
!332 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !48, type: !275)
!333 = !DILocation(column: 1, line: 288, scope: !48)
!334 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !48, type: !61)
!335 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !48, type: !11)
!336 = !DILocation(column: 5, line: 289, scope: !48)
!337 = !DILocation(column: 13, line: 291, scope: !48)
!338 = !DILocation(column: 5, line: 292, scope: !48)
!339 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !49, type: !275)
!340 = !DILocation(column: 1, line: 148, scope: !49)
!341 = !DILocation(column: 5, line: 149, scope: !49)
!342 = !DILocation(column: 5, line: 151, scope: !49)
!343 = !DILocation(column: 5, line: 152, scope: !49)
!344 = !DILocation(column: 5, line: 153, scope: !49)
!345 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !50, type: !11)
!346 = !DILocation(column: 1, line: 124, scope: !50)
!347 = !DILocation(column: 5, line: 125, scope: !50)
!348 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !50, type: !274)
!349 = !DILocation(column: 1, line: 125, scope: !50)
!350 = !DILocation(column: 5, line: 126, scope: !50)
!351 = !DILocation(column: 9, line: 127, scope: !50)
!352 = !DILocation(column: 9, line: 128, scope: !50)
!353 = !DILocation(column: 9, line: 129, scope: !50)
!354 = !DILocation(column: 9, line: 130, scope: !50)
!355 = !DILocation(column: 5, line: 132, scope: !50)
!356 = !DILocation(column: 5, line: 133, scope: !50)
!357 = !DILocation(column: 5, line: 134, scope: !50)
!358 = !DILocation(column: 9, line: 135, scope: !50)
!359 = !DILocation(column: 9, line: 136, scope: !50)
!360 = !DILocation(column: 9, line: 137, scope: !50)
!361 = !DILocation(column: 5, line: 139, scope: !50)
!362 = !DILocation(column: 5, line: 140, scope: !50)
!363 = !DILocation(column: 5, line: 141, scope: !50)
!364 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !51, type: !292)
...
!389 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !53, type: !292)
