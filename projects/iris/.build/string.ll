...
define linkonce_odr i32 @"vec_push$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", %"struct.ritz_module_1.LineBounds" %"item.arg") !dbg !52
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !513, metadata !7), !dbg !514
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !516, metadata !7), !dbg !514
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !517
  %".8" = load i64, i64* %".7", !dbg !517
  %".9" = add i64 %".8", 1, !dbg !517
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !517
  %".11" = sext i32 %".10" to i64 , !dbg !517
  %".12" = icmp ne i64 %".11", 0 , !dbg !517
  br i1 %".12", label %"if.then", label %"if.end", !dbg !517
if.then:
  %".14" = sub i64 0, 1, !dbg !518
  %".15" = trunc i64 %".14" to i32 , !dbg !518
  ret i32 %".15", !dbg !518
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !519
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !519
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !519
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !519
  %".21" = load i64, i64* %".20", !dbg !519
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !519
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !519
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !520
  %".25" = load i64, i64* %".24", !dbg !520
  %".26" = add i64 %".25", 1, !dbg !520
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !520
  store i64 %".26", i64* %".27", !dbg !520
  %".29" = trunc i64 0 to i32 , !dbg !521
  ret i32 %".29", !dbg !521
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !524, metadata !7), !dbg !525
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !526, metadata !7), !dbg !525
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !527
  %".8" = load i8*, i8** %".7", !dbg !527
  %".9" = load i64, i64* %"idx", !dbg !527
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !527
  %".11" = load i8, i8* %".10", !dbg !527
  ret i8 %".11", !dbg !527
}

define linkonce_odr i32 @"vec_drop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !54
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !528, metadata !7), !dbg !529
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !530
  %".5" = load i8*, i8** %".4", !dbg !530
  %".6" = icmp ne i8* %".5", null , !dbg !530
  br i1 %".6", label %"if.then", label %"if.end", !dbg !530
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !530
  %".9" = load i8*, i8** %".8", !dbg !530
  %".10" = call i32 @"free"(i8* %".9"), !dbg !530
  br label %"if.end", !dbg !530
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !531
  store i8* null, i8** %".12", !dbg !531
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !532
  store i64 0, i64* %".14", !dbg !532
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !533
  store i64 0, i64* %".16", !dbg !533
  ret i32 0, !dbg !533
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !534, metadata !7), !dbg !535
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !536, metadata !7), !dbg !535
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !537
  %".8" = load i64, i64* %".7", !dbg !537
  %".9" = add i64 %".8", 1, !dbg !537
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !537
  %".11" = sext i32 %".10" to i64 , !dbg !537
  %".12" = icmp ne i64 %".11", 0 , !dbg !537
  br i1 %".12", label %"if.then", label %"if.end", !dbg !537
if.then:
  %".14" = sub i64 0, 1, !dbg !538
  %".15" = trunc i64 %".14" to i32 , !dbg !538
  ret i32 %".15", !dbg !538
if.end:
  %".17" = load i8, i8* %"item", !dbg !539
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !539
  %".19" = load i8*, i8** %".18", !dbg !539
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !539
  %".21" = load i64, i64* %".20", !dbg !539
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !539
  store i8 %".17", i8* %".22", !dbg !539
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !540
  %".25" = load i64, i64* %".24", !dbg !540
  %".26" = add i64 %".25", 1, !dbg !540
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !540
  store i64 %".26", i64* %".27", !dbg !540
  %".29" = trunc i64 0 to i32 , !dbg !541
  ret i32 %".29", !dbg !541
}

define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !56
{
entry:
  %"i" = alloca i64, !dbg !546
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !542, metadata !7), !dbg !543
  %"data" = alloca i8*
  store i8* %"data.arg", i8** %"data"
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !544, metadata !7), !dbg !543
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !545, metadata !7), !dbg !543
  %".10" = load i64, i64* %"len", !dbg !546
  store i64 0, i64* %"i", !dbg !546
  br label %"for.cond", !dbg !546
for.cond:
  %".13" = load i64, i64* %"i", !dbg !546
  %".14" = icmp slt i64 %".13", %".10" , !dbg !546
  br i1 %".14", label %"for.body", label %"for.end", !dbg !546
for.body:
  %".16" = load i8*, i8** %"data", !dbg !546
  %".17" = load i64, i64* %"i", !dbg !546
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !546
  %".19" = load i8, i8* %".18", !dbg !546
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !546
  %".21" = sext i32 %".20" to i64 , !dbg !546
  %".22" = icmp ne i64 %".21", 0 , !dbg !546
  br i1 %".22", label %"if.then", label %"if.end", !dbg !546
for.incr:
  %".28" = load i64, i64* %"i", !dbg !547
  %".29" = add i64 %".28", 1, !dbg !547
  store i64 %".29", i64* %"i", !dbg !547
  br label %"for.cond", !dbg !547
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !548
  ret i32 %".32", !dbg !548
if.then:
  %".24" = sub i64 0, 1, !dbg !547
  %".25" = trunc i64 %".24" to i32 , !dbg !547
  ret i32 %".25", !dbg !547
if.end:
  br label %"for.incr", !dbg !547
}

define linkonce_odr i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"needed.arg") !dbg !57
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !554
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !549, metadata !7), !dbg !550
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !551, metadata !7), !dbg !550
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !552
  %".8" = load i64, i64* %".7", !dbg !552
  %".9" = load i64, i64* %"needed", !dbg !552
  %".10" = icmp sge i64 %".8", %".9" , !dbg !552
  br i1 %".10", label %"if.then", label %"if.end", !dbg !552
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !553
  ret i32 %".12", !dbg !553
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !554
  %".15" = load i64, i64* %".14", !dbg !554
  store i64 %".15", i64* %"new_cap.addr", !dbg !554
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !555, metadata !7), !dbg !556
  %".18" = load i64, i64* %"new_cap.addr", !dbg !557
  %".19" = icmp eq i64 %".18", 0 , !dbg !557
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !557
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !558
  br label %"if.end.1", !dbg !558
if.end.1:
  br label %"while.cond", !dbg !559
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !559
  %".25" = load i64, i64* %"needed", !dbg !559
  %".26" = icmp slt i64 %".24", %".25" , !dbg !559
  br i1 %".26", label %"while.body", label %"while.end", !dbg !559
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !560
  %".29" = mul i64 %".28", 2, !dbg !560
  store i64 %".29", i64* %"new_cap.addr", !dbg !560
  br label %"while.cond", !dbg !560
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !561
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !561
  ret i32 %".33", !dbg !561
}

define linkonce_odr i32 @"vec_set$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg", i8 %"item.arg") !dbg !58
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !562, metadata !7), !dbg !563
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !564, metadata !7), !dbg !563
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !565, metadata !7), !dbg !563
  %".10" = load i8, i8* %"item", !dbg !566
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !566
  %".12" = load i8*, i8** %".11", !dbg !566
  %".13" = load i64, i64* %"idx", !dbg !566
  %".14" = getelementptr i8, i8* %".12", i64 %".13" , !dbg !566
  store i8 %".10", i8* %".14", !dbg !566
  %".16" = trunc i64 0 to i32 , !dbg !567
  ret i32 %".16", !dbg !567
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_new$u8"() !dbg !59
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !568
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !569, metadata !7), !dbg !570
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !571
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !571
  store i8* null, i8** %".4", !dbg !571
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !572
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !572
  store i64 0, i64* %".7", !dbg !572
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !573
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !573
  store i64 0, i64* %".10", !dbg !573
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !574
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !574
}

define linkonce_odr i32 @"vec_clear$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !60
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !575, metadata !7), !dbg !576
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !577
  store i64 0, i64* %".4", !dbg !577
  ret i32 0, !dbg !577
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !61
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !580
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !578, metadata !7), !dbg !579
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !581, metadata !7), !dbg !582
  %".6" = load i64, i64* %"cap", !dbg !583
  %".7" = icmp sle i64 %".6", 0 , !dbg !583
  br i1 %".7", label %"if.then", label %"if.end", !dbg !583
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !584
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !584
  store i8* null, i8** %".10", !dbg !584
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !585
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !585
  store i64 0, i64* %".13", !dbg !585
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !586
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !586
  store i64 0, i64* %".16", !dbg !586
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !587
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !587
if.end:
  %".20" = load i64, i64* %"cap", !dbg !588
  %".21" = mul i64 %".20", 1, !dbg !588
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !589
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !589
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !589
  store i8* %".22", i8** %".24", !dbg !589
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !590
  %".27" = load i8*, i8** %".26", !dbg !590
  %".28" = icmp eq i8* %".27", null , !dbg !590
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !590
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !591
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !591
  store i64 0, i64* %".31", !dbg !591
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !592
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !592
  store i64 0, i64* %".34", !dbg !592
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !593
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !593
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !594
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !594
  store i64 0, i64* %".39", !dbg !594
  %".41" = load i64, i64* %"cap", !dbg !595
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !595
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !595
  store i64 %".41", i64* %".43", !dbg !595
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !596
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !596
}

define linkonce_odr i8 @"vec_pop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !62
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !597, metadata !7), !dbg !598
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !599
  %".5" = load i64, i64* %".4", !dbg !599
  %".6" = sub i64 %".5", 1, !dbg !599
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !599
  store i64 %".6", i64* %".7", !dbg !599
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !600
  %".10" = load i8*, i8** %".9", !dbg !600
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !600
  %".12" = load i64, i64* %".11", !dbg !600
  %".13" = getelementptr i8, i8* %".10", i64 %".12" , !dbg !600
  %".14" = load i8, i8* %".13", !dbg !600
  ret i8 %".14", !dbg !600
}
...
!0 = !DIFile(directory: "/home/aaron/dev/ritz-lang/ritz/ritzlib", filename: "string.ritz")
...
!52 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$LineBounds", scopeLine: 210, type: !4, unit: !1)
!53 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
!54 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
!55 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!56 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 288, name: "vec_push_bytes$u8", scopeLine: 288, type: !4, unit: !1)
!57 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$u8", scopeLine: 193, type: !4, unit: !1)
!58 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 235, name: "vec_set$u8", scopeLine: 235, type: !4, unit: !1)
!59 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
!60 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
!61 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
!62 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 219, name: "vec_pop$u8", scopeLine: 219, type: !4, unit: !1)
...
!511 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!512 = !DIDerivedType(baseType: !511, size: 64, tag: DW_TAG_reference_type)
!513 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !52, type: !512)
!514 = !DILocation(column: 1, line: 210, scope: !52)
!515 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!516 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !52, type: !515)
!517 = !DILocation(column: 5, line: 211, scope: !52)
!518 = !DILocation(column: 9, line: 212, scope: !52)
!519 = !DILocation(column: 5, line: 213, scope: !52)
!520 = !DILocation(column: 5, line: 214, scope: !52)
!521 = !DILocation(column: 5, line: 215, scope: !52)
!522 = !DICompositeType(align: 64, file: !0, name: "Vec$u8", size: 192, tag: DW_TAG_structure_type)
!523 = !DIDerivedType(baseType: !522, size: 64, tag: DW_TAG_reference_type)
!524 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !53, type: !523)
!525 = !DILocation(column: 1, line: 225, scope: !53)
!526 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !53, type: !11)
!527 = !DILocation(column: 5, line: 226, scope: !53)
!528 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !54, type: !523)
!529 = !DILocation(column: 1, line: 148, scope: !54)
!530 = !DILocation(column: 5, line: 149, scope: !54)
!531 = !DILocation(column: 5, line: 151, scope: !54)
!532 = !DILocation(column: 5, line: 152, scope: !54)
!533 = !DILocation(column: 5, line: 153, scope: !54)
!534 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !55, type: !523)
!535 = !DILocation(column: 1, line: 210, scope: !55)
!536 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !55, type: !12)
!537 = !DILocation(column: 5, line: 211, scope: !55)
!538 = !DILocation(column: 9, line: 212, scope: !55)
!539 = !DILocation(column: 5, line: 213, scope: !55)
!540 = !DILocation(column: 5, line: 214, scope: !55)
!541 = !DILocation(column: 5, line: 215, scope: !55)
!542 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !56, type: !523)
!543 = !DILocation(column: 1, line: 288, scope: !56)
!544 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !56, type: !89)
!545 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !56, type: !11)
!546 = !DILocation(column: 5, line: 289, scope: !56)
!547 = !DILocation(column: 13, line: 291, scope: !56)
!548 = !DILocation(column: 5, line: 292, scope: !56)
!549 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !57, type: !523)
!550 = !DILocation(column: 1, line: 193, scope: !57)
!551 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !57, type: !11)
!552 = !DILocation(column: 5, line: 194, scope: !57)
!553 = !DILocation(column: 9, line: 195, scope: !57)
!554 = !DILocation(column: 5, line: 197, scope: !57)
!555 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !57, type: !11)
!556 = !DILocation(column: 1, line: 197, scope: !57)
!557 = !DILocation(column: 5, line: 198, scope: !57)
!558 = !DILocation(column: 9, line: 199, scope: !57)
!559 = !DILocation(column: 5, line: 200, scope: !57)
!560 = !DILocation(column: 9, line: 201, scope: !57)
!561 = !DILocation(column: 5, line: 203, scope: !57)
!562 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !58, type: !523)
!563 = !DILocation(column: 1, line: 235, scope: !58)
!564 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !58, type: !11)
!565 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !58, type: !12)
!566 = !DILocation(column: 5, line: 236, scope: !58)
!567 = !DILocation(column: 5, line: 237, scope: !58)
!568 = !DILocation(column: 5, line: 117, scope: !59)
!569 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !59, type: !522)
!570 = !DILocation(column: 1, line: 117, scope: !59)
!571 = !DILocation(column: 5, line: 118, scope: !59)
!572 = !DILocation(column: 5, line: 119, scope: !59)
!573 = !DILocation(column: 5, line: 120, scope: !59)
!574 = !DILocation(column: 5, line: 121, scope: !59)
!575 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !60, type: !523)
!576 = !DILocation(column: 1, line: 244, scope: !60)
!577 = !DILocation(column: 5, line: 245, scope: !60)
!578 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !61, type: !11)
!579 = !DILocation(column: 1, line: 124, scope: !61)
!580 = !DILocation(column: 5, line: 125, scope: !61)
!581 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !61, type: !522)
!582 = !DILocation(column: 1, line: 125, scope: !61)
!583 = !DILocation(column: 5, line: 126, scope: !61)
!584 = !DILocation(column: 9, line: 127, scope: !61)
!585 = !DILocation(column: 9, line: 128, scope: !61)
!586 = !DILocation(column: 9, line: 129, scope: !61)
!587 = !DILocation(column: 9, line: 130, scope: !61)
!588 = !DILocation(column: 5, line: 132, scope: !61)
!589 = !DILocation(column: 5, line: 133, scope: !61)
!590 = !DILocation(column: 5, line: 134, scope: !61)
!591 = !DILocation(column: 9, line: 135, scope: !61)
!592 = !DILocation(column: 9, line: 136, scope: !61)
!593 = !DILocation(column: 9, line: 137, scope: !61)
!594 = !DILocation(column: 5, line: 139, scope: !61)
!595 = !DILocation(column: 5, line: 140, scope: !61)
!596 = !DILocation(column: 5, line: 141, scope: !61)
!597 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !62, type: !523)
!598 = !DILocation(column: 1, line: 219, scope: !62)
!599 = !DILocation(column: 5, line: 220, scope: !62)
!600 = !DILocation(column: 5, line: 221, scope: !62)
!601 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !63, type: !523)
...
!613 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !64, type: !512)
...
!626 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !65, type: !512)
