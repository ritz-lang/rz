...
define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !53
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !519, metadata !7), !dbg !520
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !521, metadata !7), !dbg !520
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !522
  %".8" = load i64, i64* %".7", !dbg !522
  %".9" = add i64 %".8", 1, !dbg !522
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !522
  %".11" = sext i32 %".10" to i64 , !dbg !522
  %".12" = icmp ne i64 %".11", 0 , !dbg !522
  br i1 %".12", label %"if.then", label %"if.end", !dbg !522
if.then:
  %".14" = sub i64 0, 1, !dbg !523
  %".15" = trunc i64 %".14" to i32 , !dbg !523
  ret i32 %".15", !dbg !523
if.end:
  %".17" = load i8, i8* %"item", !dbg !524
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !524
  %".19" = load i8*, i8** %".18", !dbg !524
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !524
  %".21" = load i64, i64* %".20", !dbg !524
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !524
  store i8 %".17", i8* %".22", !dbg !524
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !525
  %".25" = load i64, i64* %".24", !dbg !525
  %".26" = add i64 %".25", 1, !dbg !525
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !525
  store i64 %".26", i64* %".27", !dbg !525
  %".29" = trunc i64 0 to i32 , !dbg !526
  ret i32 %".29", !dbg !526
}
...
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !527
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !528, metadata !7), !dbg !529
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !530
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !530
  store i8* null, i8** %".4", !dbg !530
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !531
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !531
  store i64 0, i64* %".7", !dbg !531
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !532
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !532
  store i64 0, i64* %".10", !dbg !532
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !533
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !533
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !55
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !534, metadata !7), !dbg !535
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !536, metadata !7), !dbg !535
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !537
  %".8" = load i8*, i8** %".7", !dbg !537
  %".9" = load i64, i64* %"idx", !dbg !537
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !537
  %".11" = load i8, i8* %".10", !dbg !537
  ret i8 %".11", !dbg !537
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !540, metadata !7), !dbg !541
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !543, metadata !7), !dbg !541
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !544
  %".8" = load i64, i64* %".7", !dbg !544
  %".9" = add i64 %".8", 1, !dbg !544
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !544
  %".11" = sext i32 %".10" to i64 , !dbg !544
  %".12" = icmp ne i64 %".11", 0 , !dbg !544
  br i1 %".12", label %"if.then", label %"if.end", !dbg !544
if.then:
  %".14" = sub i64 0, 1, !dbg !545
  %".15" = trunc i64 %".14" to i32 , !dbg !545
  ret i32 %".15", !dbg !545
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !546
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !546
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !546
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !546
  %".21" = load i64, i64* %".20", !dbg !546
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !546
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !546
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !547
  %".25" = load i64, i64* %".24", !dbg !547
  %".26" = add i64 %".25", 1, !dbg !547
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !547
  store i64 %".26", i64* %".27", !dbg !547
  %".29" = trunc i64 0 to i32 , !dbg !548
  ret i32 %".29", !dbg !548
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !57
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !551
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !549, metadata !7), !dbg !550
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !552, metadata !7), !dbg !553
  %".6" = load i64, i64* %"cap", !dbg !554
  %".7" = icmp sle i64 %".6", 0 , !dbg !554
  br i1 %".7", label %"if.then", label %"if.end", !dbg !554
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !555
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !555
  store i8* null, i8** %".10", !dbg !555
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !556
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !556
  store i64 0, i64* %".13", !dbg !556
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !557
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !557
  store i64 0, i64* %".16", !dbg !557
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !558
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !558
if.end:
  %".20" = load i64, i64* %"cap", !dbg !559
  %".21" = mul i64 %".20", 1, !dbg !559
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !560
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !560
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !560
  store i8* %".22", i8** %".24", !dbg !560
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !561
  %".27" = load i8*, i8** %".26", !dbg !561
  %".28" = icmp eq i8* %".27", null , !dbg !561
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !561
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !562
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !562
  store i64 0, i64* %".31", !dbg !562
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !563
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !563
  store i64 0, i64* %".34", !dbg !563
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !564
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !564
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !565
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !565
  store i64 0, i64* %".39", !dbg !565
  %".41" = load i64, i64* %"cap", !dbg !566
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !566
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !566
  store i64 %".41", i64* %".43", !dbg !566
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !567
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !567
}

define linkonce_odr i32 @"vec_clear$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !58
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !568, metadata !7), !dbg !569
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !570
  store i64 0, i64* %".4", !dbg !570
  ret i32 0, !dbg !570
}

define linkonce_odr i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"needed.arg") !dbg !59
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !576
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !571, metadata !7), !dbg !572
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !573, metadata !7), !dbg !572
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !574
  %".8" = load i64, i64* %".7", !dbg !574
  %".9" = load i64, i64* %"needed", !dbg !574
  %".10" = icmp sge i64 %".8", %".9" , !dbg !574
  br i1 %".10", label %"if.then", label %"if.end", !dbg !574
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !575
  ret i32 %".12", !dbg !575
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !576
  %".15" = load i64, i64* %".14", !dbg !576
  store i64 %".15", i64* %"new_cap.addr", !dbg !576
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !577, metadata !7), !dbg !578
  %".18" = load i64, i64* %"new_cap.addr", !dbg !579
  %".19" = icmp eq i64 %".18", 0 , !dbg !579
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !579
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !580
  br label %"if.end.1", !dbg !580
if.end.1:
  br label %"while.cond", !dbg !581
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !581
  %".25" = load i64, i64* %"needed", !dbg !581
  %".26" = icmp slt i64 %".24", %".25" , !dbg !581
  br i1 %".26", label %"while.body", label %"while.end", !dbg !581
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !582
  %".29" = mul i64 %".28", 2, !dbg !582
  store i64 %".29", i64* %"new_cap.addr", !dbg !582
  br label %"while.cond", !dbg !582
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !583
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !583
  ret i32 %".33", !dbg !583
}

define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !60
{
entry:
  %"i" = alloca i64, !dbg !588
  ...
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !586, metadata !7), !dbg !585
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !587, metadata !7), !dbg !585
  %".10" = load i64, i64* %"len", !dbg !588
  store i64 0, i64* %"i", !dbg !588
  br label %"for.cond", !dbg !588
for.cond:
  %".13" = load i64, i64* %"i", !dbg !588
  %".14" = icmp slt i64 %".13", %".10" , !dbg !588
  br i1 %".14", label %"for.body", label %"for.end", !dbg !588
for.body:
  %".16" = load i8*, i8** %"data", !dbg !588
  %".17" = load i64, i64* %"i", !dbg !588
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !588
  %".19" = load i8, i8* %".18", !dbg !588
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !588
  %".21" = sext i32 %".20" to i64 , !dbg !588
  %".22" = icmp ne i64 %".21", 0 , !dbg !588
  br i1 %".22", label %"if.then", label %"if.end", !dbg !588
for.incr:
  %".28" = load i64, i64* %"i", !dbg !589
  %".29" = add i64 %".28", 1, !dbg !589
  store i64 %".29", i64* %"i", !dbg !589
  br label %"for.cond", !dbg !589
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !590
  ret i32 %".32", !dbg !590
if.then:
  %".24" = sub i64 0, 1, !dbg !589
  %".25" = trunc i64 %".24" to i32 , !dbg !589
  ret i32 %".25", !dbg !589
if.end:
  br label %"for.incr", !dbg !589
}

define linkonce_odr i32 @"vec_drop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !61
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !591, metadata !7), !dbg !592
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !593
  %".5" = load i8*, i8** %".4", !dbg !593
  %".6" = icmp ne i8* %".5", null , !dbg !593
  br i1 %".6", label %"if.then", label %"if.end", !dbg !593
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !593
  %".9" = load i8*, i8** %".8", !dbg !593
  %".10" = call i32 @"free"(i8* %".9"), !dbg !593
  br label %"if.end", !dbg !593
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !594
  store i8* null, i8** %".12", !dbg !594
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !595
  store i64 0, i64* %".14", !dbg !595
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !596
  store i64 0, i64* %".16", !dbg !596
  ret i32 0, !dbg !596
}
...
!53 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!54 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
!55 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
...
!57 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
!58 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
!59 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$u8", scopeLine: 193, type: !4, unit: !1)
!60 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 288, name: "vec_push_bytes$u8", scopeLine: 288, type: !4, unit: !1)
!61 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
...
!519 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !53, type: !512)
!520 = !DILocation(column: 1, line: 210, scope: !53)
!521 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !53, type: !12)
!522 = !DILocation(column: 5, line: 211, scope: !53)
!523 = !DILocation(column: 9, line: 212, scope: !53)
!524 = !DILocation(column: 5, line: 213, scope: !53)
!525 = !DILocation(column: 5, line: 214, scope: !53)
!526 = !DILocation(column: 5, line: 215, scope: !53)
!527 = !DILocation(column: 5, line: 117, scope: !54)
!528 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !54, type: !511)
!529 = !DILocation(column: 1, line: 117, scope: !54)
!530 = !DILocation(column: 5, line: 118, scope: !54)
!531 = !DILocation(column: 5, line: 119, scope: !54)
!532 = !DILocation(column: 5, line: 120, scope: !54)
!533 = !DILocation(column: 5, line: 121, scope: !54)
!534 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !55, type: !512)
!535 = !DILocation(column: 1, line: 225, scope: !55)
!536 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !55, type: !11)
!537 = !DILocation(column: 5, line: 226, scope: !55)
!538 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!539 = !DIDerivedType(baseType: !538, size: 64, tag: DW_TAG_reference_type)
!540 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !56, type: !539)
!541 = !DILocation(column: 1, line: 210, scope: !56)
!542 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!543 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !56, type: !542)
!544 = !DILocation(column: 5, line: 211, scope: !56)
!545 = !DILocation(column: 9, line: 212, scope: !56)
!546 = !DILocation(column: 5, line: 213, scope: !56)
!547 = !DILocation(column: 5, line: 214, scope: !56)
!548 = !DILocation(column: 5, line: 215, scope: !56)
!549 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !57, type: !11)
!550 = !DILocation(column: 1, line: 124, scope: !57)
!551 = !DILocation(column: 5, line: 125, scope: !57)
!552 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !57, type: !511)
!553 = !DILocation(column: 1, line: 125, scope: !57)
!554 = !DILocation(column: 5, line: 126, scope: !57)
!555 = !DILocation(column: 9, line: 127, scope: !57)
!556 = !DILocation(column: 9, line: 128, scope: !57)
!557 = !DILocation(column: 9, line: 129, scope: !57)
!558 = !DILocation(column: 9, line: 130, scope: !57)
!559 = !DILocation(column: 5, line: 132, scope: !57)
!560 = !DILocation(column: 5, line: 133, scope: !57)
!561 = !DILocation(column: 5, line: 134, scope: !57)
!562 = !DILocation(column: 9, line: 135, scope: !57)
!563 = !DILocation(column: 9, line: 136, scope: !57)
!564 = !DILocation(column: 9, line: 137, scope: !57)
!565 = !DILocation(column: 5, line: 139, scope: !57)
!566 = !DILocation(column: 5, line: 140, scope: !57)
!567 = !DILocation(column: 5, line: 141, scope: !57)
!568 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !58, type: !512)
!569 = !DILocation(column: 1, line: 244, scope: !58)
!570 = !DILocation(column: 5, line: 245, scope: !58)
!571 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !59, type: !512)
!572 = !DILocation(column: 1, line: 193, scope: !59)
!573 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !59, type: !11)
!574 = !DILocation(column: 5, line: 194, scope: !59)
!575 = !DILocation(column: 9, line: 195, scope: !59)
!576 = !DILocation(column: 5, line: 197, scope: !59)
!577 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !59, type: !11)
!578 = !DILocation(column: 1, line: 197, scope: !59)
!579 = !DILocation(column: 5, line: 198, scope: !59)
!580 = !DILocation(column: 9, line: 199, scope: !59)
!581 = !DILocation(column: 5, line: 200, scope: !59)
!582 = !DILocation(column: 9, line: 201, scope: !59)
!583 = !DILocation(column: 5, line: 203, scope: !59)
!584 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !60, type: !512)
!585 = !DILocation(column: 1, line: 288, scope: !60)
!586 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !60, type: !89)
!587 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !60, type: !11)
!588 = !DILocation(column: 5, line: 289, scope: !60)
!589 = !DILocation(column: 13, line: 291, scope: !60)
!590 = !DILocation(column: 5, line: 292, scope: !60)
!591 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !61, type: !512)
!592 = !DILocation(column: 1, line: 148, scope: !61)
!593 = !DILocation(column: 5, line: 149, scope: !61)
!594 = !DILocation(column: 5, line: 151, scope: !61)
!595 = !DILocation(column: 5, line: 152, scope: !61)
!596 = !DILocation(column: 5, line: 153, scope: !61)
!597 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !62, type: !512)
...
!613 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !64, type: !539)
...
!626 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !65, type: !539)
