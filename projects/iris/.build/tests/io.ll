...
entry:
  ...
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !278
  store i64 0, i64* %".4", !dbg !278
  ret i32 0, !dbg !278
}

define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %"item.arg") !dbg !41
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !279, metadata !7), !dbg !280
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !281, metadata !7), !dbg !280
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !282
  %".8" = load i64, i64* %".7", !dbg !282
  %".9" = add i64 %".8", 1, !dbg !282
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !282
  %".11" = sext i32 %".10" to i64 , !dbg !282
  %".12" = icmp ne i64 %".11", 0 , !dbg !282
  br i1 %".12", label %"if.then", label %"if.end", !dbg !282
if.then:
  %".14" = sub i64 0, 1, !dbg !283
  %".15" = trunc i64 %".14" to i32 , !dbg !283
  ret i32 %".15", !dbg !283
if.end:
  %".17" = load i8, i8* %"item", !dbg !284
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !284
  %".19" = load i8*, i8** %".18", !dbg !284
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !284
  %".21" = load i64, i64* %".20", !dbg !284
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !284
  store i8 %".17", i8* %".22", !dbg !284
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !285
  %".25" = load i64, i64* %".24", !dbg !285
  %".26" = add i64 %".25", 1, !dbg !285
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !285
  store i64 %".26", i64* %".27", !dbg !285
  %".29" = trunc i64 0 to i32 , !dbg !286
  ret i32 %".29", !dbg !286
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !42
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !289
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !287, metadata !7), !dbg !288
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !290, metadata !7), !dbg !291
  %".6" = load i64, i64* %"cap", !dbg !292
  %".7" = icmp sle i64 %".6", 0 , !dbg !292
  br i1 %".7", label %"if.then", label %"if.end", !dbg !292
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !293
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !293
  store i8* null, i8** %".10", !dbg !293
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !294
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !294
  store i64 0, i64* %".13", !dbg !294
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !295
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !295
  store i64 0, i64* %".16", !dbg !295
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !296
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !296
if.end:
  %".20" = load i64, i64* %"cap", !dbg !297
  %".21" = mul i64 %".20", 1, !dbg !297
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !298
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !298
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !298
  store i8* %".22", i8** %".24", !dbg !298
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !299
  %".27" = load i8*, i8** %".26", !dbg !299
  %".28" = icmp eq i8* %".27", null , !dbg !299
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !299
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !300
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !300
  store i64 0, i64* %".31", !dbg !300
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !301
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !301
  store i64 0, i64* %".34", !dbg !301
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !302
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !302
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !303
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !303
  store i64 0, i64* %".39", !dbg !303
  %".41" = load i64, i64* %"cap", !dbg !304
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !304
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !304
  store i64 %".41", i64* %".43", !dbg !304
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !305
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !305
}

define linkonce_odr i32 @"vec_drop$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg") !dbg !43
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !306, metadata !7), !dbg !307
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !308
  %".5" = load i8*, i8** %".4", !dbg !308
  %".6" = icmp ne i8* %".5", null , !dbg !308
  br i1 %".6", label %"if.then", label %"if.end", !dbg !308
if.then:
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !308
  %".9" = load i8*, i8** %".8", !dbg !308
  %".10" = call i32 @"free"(i8* %".9"), !dbg !308
  br label %"if.end", !dbg !308
if.end:
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !309
  store i8* null, i8** %".12", !dbg !309
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !310
  store i64 0, i64* %".14", !dbg !310
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !311
  store i64 0, i64* %".16", !dbg !311
  ret i32 0, !dbg !311
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !312, metadata !7), !dbg !313
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !314, metadata !7), !dbg !313
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !315, metadata !7), !dbg !313
  %".10" = load i8, i8* %"item", !dbg !316
  %".11" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !316
  %".12" = load i8*, i8** %".11", !dbg !316
  %".13" = load i64, i64* %"idx", !dbg !316
  %".14" = getelementptr i8, i8* %".12", i64 %".13" , !dbg !316
  store i8 %".10", i8* %".14", !dbg !316
  %".16" = trunc i64 0 to i32 , !dbg !317
  ret i32 %".16", !dbg !317
}

define linkonce_odr i32 @"vec_push$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", %"struct.ritz_module_1.LineBounds" %"item.arg") !dbg !45
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !320, metadata !7), !dbg !321
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !323, metadata !7), !dbg !321
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !324
  %".8" = load i64, i64* %".7", !dbg !324
  %".9" = add i64 %".8", 1, !dbg !324
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !324
  %".11" = sext i32 %".10" to i64 , !dbg !324
  %".12" = icmp ne i64 %".11", 0 , !dbg !324
  br i1 %".12", label %"if.then", label %"if.end", !dbg !324
if.then:
  %".14" = sub i64 0, 1, !dbg !325
  %".15" = trunc i64 %".14" to i32 , !dbg !325
  ret i32 %".15", !dbg !325
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !326
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !326
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !326
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !326
  %".21" = load i64, i64* %".20", !dbg !326
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !326
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !326
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !327
  %".25" = load i64, i64* %".24", !dbg !327
  %".26" = add i64 %".25", 1, !dbg !327
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !327
  store i64 %".26", i64* %".27", !dbg !327
  %".29" = trunc i64 0 to i32 , !dbg !328
  ret i32 %".29", !dbg !328
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !46
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !329, metadata !7), !dbg !330
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !331, metadata !7), !dbg !330
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !332
  %".8" = load i8*, i8** %".7", !dbg !332
  %".9" = load i64, i64* %"idx", !dbg !332
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !332
  %".11" = load i8, i8* %".10", !dbg !332
  ret i8 %".11", !dbg !332
}
...
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !338
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !333, metadata !7), !dbg !334
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !335, metadata !7), !dbg !334
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !336
  %".8" = load i64, i64* %".7", !dbg !336
  %".9" = load i64, i64* %"needed", !dbg !336
  %".10" = icmp sge i64 %".8", %".9" , !dbg !336
  br i1 %".10", label %"if.then", label %"if.end", !dbg !336
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !337
  ret i32 %".12", !dbg !337
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !338
  %".15" = load i64, i64* %".14", !dbg !338
  store i64 %".15", i64* %"new_cap.addr", !dbg !338
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !339, metadata !7), !dbg !340
  %".18" = load i64, i64* %"new_cap.addr", !dbg !341
  %".19" = icmp eq i64 %".18", 0 , !dbg !341
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !341
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !342
  br label %"if.end.1", !dbg !342
if.end.1:
  br label %"while.cond", !dbg !343
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !343
  %".25" = load i64, i64* %"needed", !dbg !343
  %".26" = icmp slt i64 %".24", %".25" , !dbg !343
  br i1 %".26", label %"while.body", label %"while.end", !dbg !343
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !344
  %".29" = mul i64 %".28", 2, !dbg !344
  store i64 %".29", i64* %"new_cap.addr", !dbg !344
  br label %"while.cond", !dbg !344
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !345
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !345
  ret i32 %".33", !dbg !345
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_new$u8"() !dbg !48
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !346
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !347, metadata !7), !dbg !348
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !349
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !349
  store i8* null, i8** %".4", !dbg !349
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !350
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !350
  store i64 0, i64* %".7", !dbg !350
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !351
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !351
  store i64 0, i64* %".10", !dbg !351
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !352
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !352
}

define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !49
{
entry:
  %"i" = alloca i64, !dbg !357
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !353, metadata !7), !dbg !354
  %"data" = alloca i8*
  store i8* %"data.arg", i8** %"data"
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !355, metadata !7), !dbg !354
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !356, metadata !7), !dbg !354
  %".10" = load i64, i64* %"len", !dbg !357
  store i64 0, i64* %"i", !dbg !357
  br label %"for.cond", !dbg !357
for.cond:
  %".13" = load i64, i64* %"i", !dbg !357
  %".14" = icmp slt i64 %".13", %".10" , !dbg !357
  br i1 %".14", label %"for.body", label %"for.end", !dbg !357
for.body:
  %".16" = load i8*, i8** %"data", !dbg !357
  %".17" = load i64, i64* %"i", !dbg !357
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !357
  %".19" = load i8, i8* %".18", !dbg !357
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !357
  %".21" = sext i32 %".20" to i64 , !dbg !357
  %".22" = icmp ne i64 %".21", 0 , !dbg !357
  br i1 %".22", label %"if.then", label %"if.end", !dbg !357
for.incr:
  %".28" = load i64, i64* %"i", !dbg !358
  %".29" = add i64 %".28", 1, !dbg !358
  store i64 %".29", i64* %"i", !dbg !358
  br label %"for.cond", !dbg !358
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !359
  ret i32 %".32", !dbg !359
if.then:
  %".24" = sub i64 0, 1, !dbg !358
  %".25" = trunc i64 %".24" to i32 , !dbg !358
  ret i32 %".25", !dbg !358
if.end:
  br label %"for.incr", !dbg !358
}
...
define linkonce_odr i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"new_cap.arg") !dbg !51
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !364, metadata !7), !dbg !365
  %"new_cap" = alloca i64
  store i64 %"new_cap.arg", i64* %"new_cap"
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap", metadata !366, metadata !7), !dbg !365
  %".7" = load i64, i64* %"new_cap", !dbg !367
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !367
  %".9" = load i64, i64* %".8", !dbg !367
  %".10" = icmp sle i64 %".7", %".9" , !dbg !367
  br i1 %".10", label %"if.then", label %"if.end", !dbg !367
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !368
  ret i32 %".12", !dbg !368
if.end:
  %".14" = load i64, i64* %"new_cap", !dbg !369
  %".15" = mul i64 %".14", 1, !dbg !369
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !370
  %".17" = load i8*, i8** %".16", !dbg !370
  %".18" = call i8* @"realloc"(i8* %".17", i64 %".15"), !dbg !370
  %".19" = icmp eq i8* %".18", null , !dbg !371
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !371
if.then.1:
  %".21" = sub i64 0, 1, !dbg !372
  %".22" = trunc i64 %".21" to i32 , !dbg !372
  ret i32 %".22", !dbg !372
if.end.1:
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !373
  store i8* %".18", i8** %".24", !dbg !373
  %".26" = load i64, i64* %"new_cap", !dbg !374
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !374
  store i64 %".26", i64* %".27", !dbg !374
  %".29" = trunc i64 0 to i32 , !dbg !375
  ret i32 %".29", !dbg !375
}

define linkonce_odr i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %"needed.arg") !dbg !52
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !381
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !376, metadata !7), !dbg !377
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !378, metadata !7), !dbg !377
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !379
  %".8" = load i64, i64* %".7", !dbg !379
  %".9" = load i64, i64* %"needed", !dbg !379
  %".10" = icmp sge i64 %".8", %".9" , !dbg !379
  br i1 %".10", label %"if.then", label %"if.end", !dbg !379
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !380
  ret i32 %".12", !dbg !380
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !381
  %".15" = load i64, i64* %".14", !dbg !381
  store i64 %".15", i64* %"new_cap.addr", !dbg !381
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !382, metadata !7), !dbg !383
  %".18" = load i64, i64* %"new_cap.addr", !dbg !384
  %".19" = icmp eq i64 %".18", 0 , !dbg !384
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !384
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !385
  br label %"if.end.1", !dbg !385
if.end.1:
  br label %"while.cond", !dbg !386
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !386
  %".25" = load i64, i64* %"needed", !dbg !386
  %".26" = icmp slt i64 %".24", %".25" , !dbg !386
  br i1 %".26", label %"while.body", label %"while.end", !dbg !386
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !387
  %".29" = mul i64 %".28", 2, !dbg !387
  store i64 %".29", i64* %"new_cap.addr", !dbg !387
  br label %"while.cond", !dbg !387
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !388
  %".33" = call i32 @"vec_grow$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".32"), !dbg !388
  ret i32 %".33", !dbg !388
}
...
!41 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!42 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
...
!45 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$LineBounds", scopeLine: 210, type: !4, unit: !1)
!46 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
...
!48 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
...
!51 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 179, name: "vec_grow$u8", scopeLine: 179, type: !4, unit: !1)
!52 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$LineBounds", scopeLine: 193, type: !4, unit: !1)
...
!276 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !40, type: !275)
!277 = !DILocation(column: 1, line: 244, scope: !40)
!278 = !DILocation(column: 5, line: 245, scope: !40)
!279 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !41, type: !275)
!280 = !DILocation(column: 1, line: 210, scope: !41)
!281 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !41, type: !12)
!282 = !DILocation(column: 5, line: 211, scope: !41)
!283 = !DILocation(column: 9, line: 212, scope: !41)
!284 = !DILocation(column: 5, line: 213, scope: !41)
!285 = !DILocation(column: 5, line: 214, scope: !41)
!286 = !DILocation(column: 5, line: 215, scope: !41)
!287 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !42, type: !11)
!288 = !DILocation(column: 1, line: 124, scope: !42)
!289 = !DILocation(column: 5, line: 125, scope: !42)
!290 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !42, type: !274)
!291 = !DILocation(column: 1, line: 125, scope: !42)
!292 = !DILocation(column: 5, line: 126, scope: !42)
!293 = !DILocation(column: 9, line: 127, scope: !42)
!294 = !DILocation(column: 9, line: 128, scope: !42)
!295 = !DILocation(column: 9, line: 129, scope: !42)
!296 = !DILocation(column: 9, line: 130, scope: !42)
!297 = !DILocation(column: 5, line: 132, scope: !42)
!298 = !DILocation(column: 5, line: 133, scope: !42)
!299 = !DILocation(column: 5, line: 134, scope: !42)
!300 = !DILocation(column: 9, line: 135, scope: !42)
!301 = !DILocation(column: 9, line: 136, scope: !42)
!302 = !DILocation(column: 9, line: 137, scope: !42)
!303 = !DILocation(column: 5, line: 139, scope: !42)
!304 = !DILocation(column: 5, line: 140, scope: !42)
!305 = !DILocation(column: 5, line: 141, scope: !42)
!306 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !43, type: !275)
!307 = !DILocation(column: 1, line: 148, scope: !43)
!308 = !DILocation(column: 5, line: 149, scope: !43)
!309 = !DILocation(column: 5, line: 151, scope: !43)
!310 = !DILocation(column: 5, line: 152, scope: !43)
!311 = !DILocation(column: 5, line: 153, scope: !43)
!312 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !44, type: !275)
!313 = !DILocation(column: 1, line: 235, scope: !44)
!314 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !44, type: !11)
!315 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !44, type: !12)
!316 = !DILocation(column: 5, line: 236, scope: !44)
!317 = !DILocation(column: 5, line: 237, scope: !44)
!318 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!319 = !DIDerivedType(baseType: !318, size: 64, tag: DW_TAG_reference_type)
!320 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !45, type: !319)
!321 = !DILocation(column: 1, line: 210, scope: !45)
!322 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!323 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !45, type: !322)
!324 = !DILocation(column: 5, line: 211, scope: !45)
!325 = !DILocation(column: 9, line: 212, scope: !45)
!326 = !DILocation(column: 5, line: 213, scope: !45)
!327 = !DILocation(column: 5, line: 214, scope: !45)
!328 = !DILocation(column: 5, line: 215, scope: !45)
!329 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !46, type: !275)
!330 = !DILocation(column: 1, line: 225, scope: !46)
!331 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !46, type: !11)
!332 = !DILocation(column: 5, line: 226, scope: !46)
!333 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !47, type: !275)
!334 = !DILocation(column: 1, line: 193, scope: !47)
!335 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !47, type: !11)
!336 = !DILocation(column: 5, line: 194, scope: !47)
!337 = !DILocation(column: 9, line: 195, scope: !47)
!338 = !DILocation(column: 5, line: 197, scope: !47)
!339 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !47, type: !11)
!340 = !DILocation(column: 1, line: 197, scope: !47)
!341 = !DILocation(column: 5, line: 198, scope: !47)
!342 = !DILocation(column: 9, line: 199, scope: !47)
!343 = !DILocation(column: 5, line: 200, scope: !47)
!344 = !DILocation(column: 9, line: 201, scope: !47)
!345 = !DILocation(column: 5, line: 203, scope: !47)
!346 = !DILocation(column: 5, line: 117, scope: !48)
!347 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !48, type: !274)
!348 = !DILocation(column: 1, line: 117, scope: !48)
!349 = !DILocation(column: 5, line: 118, scope: !48)
!350 = !DILocation(column: 5, line: 119, scope: !48)
!351 = !DILocation(column: 5, line: 120, scope: !48)
!352 = !DILocation(column: 5, line: 121, scope: !48)
!353 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !49, type: !275)
!354 = !DILocation(column: 1, line: 288, scope: !49)
!355 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !49, type: !61)
!356 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !49, type: !11)
!357 = !DILocation(column: 5, line: 289, scope: !49)
!358 = !DILocation(column: 13, line: 291, scope: !49)
!359 = !DILocation(column: 5, line: 292, scope: !49)
...
!364 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !51, type: !275)
!365 = !DILocation(column: 1, line: 179, scope: !51)
!366 = !DILocalVariable(file: !0, line: 179, name: "new_cap", scope: !51, type: !11)
!367 = !DILocation(column: 5, line: 180, scope: !51)
!368 = !DILocation(column: 9, line: 181, scope: !51)
!369 = !DILocation(column: 5, line: 183, scope: !51)
!370 = !DILocation(column: 5, line: 184, scope: !51)
!371 = !DILocation(column: 5, line: 185, scope: !51)
!372 = !DILocation(column: 9, line: 186, scope: !51)
!373 = !DILocation(column: 5, line: 188, scope: !51)
!374 = !DILocation(column: 5, line: 189, scope: !51)
!375 = !DILocation(column: 5, line: 190, scope: !51)
!376 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !52, type: !319)
!377 = !DILocation(column: 1, line: 193, scope: !52)
!378 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !52, type: !11)
!379 = !DILocation(column: 5, line: 194, scope: !52)
!380 = !DILocation(column: 9, line: 195, scope: !52)
!381 = !DILocation(column: 5, line: 197, scope: !52)
!382 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !52, type: !11)
!383 = !DILocation(column: 1, line: 197, scope: !52)
!384 = !DILocation(column: 5, line: 198, scope: !52)
!385 = !DILocation(column: 9, line: 199, scope: !52)
!386 = !DILocation(column: 5, line: 200, scope: !52)
!387 = !DILocation(column: 9, line: 201, scope: !52)
!388 = !DILocation(column: 5, line: 203, scope: !52)
!389 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !53, type: !319)
