...
define linkonce_odr i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"needed.arg") !dbg !21
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !107
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !102, metadata !7), !dbg !103
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !104, metadata !7), !dbg !103
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !105
  %".8" = load i64, i64* %".7", !dbg !105
  %".9" = load i64, i64* %"needed", !dbg !105
  %".10" = icmp sge i64 %".8", %".9" , !dbg !105
  br i1 %".10", label %"if.then", label %"if.end", !dbg !105
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !106
  ret i32 %".12", !dbg !106
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !107
  %".15" = load i64, i64* %".14", !dbg !107
  store i64 %".15", i64* %"new_cap.addr", !dbg !107
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !108, metadata !7), !dbg !109
  %".18" = load i64, i64* %"new_cap.addr", !dbg !110
  %".19" = icmp eq i64 %".18", 0 , !dbg !110
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !110
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !111
  br label %"if.end.1", !dbg !111
if.end.1:
  br label %"while.cond", !dbg !112
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !112
  %".25" = load i64, i64* %"needed", !dbg !112
  %".26" = icmp slt i64 %".24", %".25" , !dbg !112
  br i1 %".26", label %"while.body", label %"while.end", !dbg !112
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !113
  %".29" = mul i64 %".28", 2, !dbg !113
  store i64 %".29", i64* %"new_cap.addr", !dbg !113
  br label %"while.cond", !dbg !113
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !114
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !114
  ret i32 %".33", !dbg !114
}

define linkonce_odr i32 @"vec_push$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", %"struct.ritz_module_1.LineBounds" %"item.arg") !dbg !22
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !115, metadata !7), !dbg !116
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !117, metadata !7), !dbg !116
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !118
  %".8" = load i64, i64* %".7", !dbg !118
  %".9" = add i64 %".8", 1, !dbg !118
  %".10" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".9"), !dbg !118
  %".11" = sext i32 %".10" to i64 , !dbg !118
  %".12" = icmp ne i64 %".11", 0 , !dbg !118
  br i1 %".12", label %"if.then", label %"if.end", !dbg !118
if.then:
  %".14" = sub i64 0, 1, !dbg !119
  %".15" = trunc i64 %".14" to i32 , !dbg !119
  ret i32 %".15", !dbg !119
if.end:
  %".17" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !120
  %".18" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 0 , !dbg !120
  %".19" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".18", !dbg !120
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !120
  %".21" = load i64, i64* %".20", !dbg !120
  %".22" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".19", i64 %".21" , !dbg !120
  store %"struct.ritz_module_1.LineBounds" %".17", %"struct.ritz_module_1.LineBounds"* %".22", !dbg !120
  %".24" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !121
  %".25" = load i64, i64* %".24", !dbg !121
  %".26" = add i64 %".25", 1, !dbg !121
  %".27" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 1 , !dbg !121
  store i64 %".26", i64* %".27", !dbg !121
  %".29" = trunc i64 0 to i32 , !dbg !122
  ret i32 %".29", !dbg !122
}
...
define linkonce_odr i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %"needed.arg") !dbg !25
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !143
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !138, metadata !7), !dbg !139
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !140, metadata !7), !dbg !139
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !141
  %".8" = load i64, i64* %".7", !dbg !141
  %".9" = load i64, i64* %"needed", !dbg !141
  %".10" = icmp sge i64 %".8", %".9" , !dbg !141
  br i1 %".10", label %"if.then", label %"if.end", !dbg !141
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !142
  ret i32 %".12", !dbg !142
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !143
  %".15" = load i64, i64* %".14", !dbg !143
  store i64 %".15", i64* %"new_cap.addr", !dbg !143
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !144, metadata !7), !dbg !145
  %".18" = load i64, i64* %"new_cap.addr", !dbg !146
  %".19" = icmp eq i64 %".18", 0 , !dbg !146
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !146
if.then.1:
...
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !148
  %".25" = load i64, i64* %"needed", !dbg !148
  %".26" = icmp slt i64 %".24", %".25" , !dbg !148
  br i1 %".26", label %"while.body", label %"while.end", !dbg !148
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !149
  %".29" = mul i64 %".28", 2, !dbg !149
  store i64 %".29", i64* %"new_cap.addr", !dbg !149
  br label %"while.cond", !dbg !149
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !150
  %".33" = call i32 @"vec_grow$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".32"), !dbg !150
  ret i32 %".33", !dbg !150
}

define linkonce_odr i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"new_cap.arg") !dbg !26
{
entry:
  ...
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !154
  %".9" = load i64, i64* %".8", !dbg !154
  %".10" = icmp sle i64 %".7", %".9" , !dbg !154
  br i1 %".10", label %"if.then", label %"if.end", !dbg !154
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !155
  ret i32 %".12", !dbg !155
if.end:
  %".14" = load i64, i64* %"new_cap", !dbg !156
  %".15" = mul i64 %".14", 1, !dbg !156
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !157
  %".17" = load i8*, i8** %".16", !dbg !157
  %".18" = call i8* @"realloc"(i8* %".17", i64 %".15"), !dbg !157
  %".19" = icmp eq i8* %".18", null , !dbg !158
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !158
if.then.1:
  %".21" = sub i64 0, 1, !dbg !159
  %".22" = trunc i64 %".21" to i32 , !dbg !159
  ret i32 %".22", !dbg !159
if.end.1:
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !160
  store i8* %".18", i8** %".24", !dbg !160
  %".26" = load i64, i64* %"new_cap", !dbg !161
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !161
  store i64 %".26", i64* %".27", !dbg !161
  %".29" = trunc i64 0 to i32 , !dbg !162
  ret i32 %".29", !dbg !162
}
...
!21 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$u8", scopeLine: 193, type: !4, unit: !1)
!22 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$LineBounds", scopeLine: 210, type: !4, unit: !1)
...
!25 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$LineBounds", scopeLine: 193, type: !4, unit: !1)
!26 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 179, name: "vec_grow$u8", scopeLine: 179, type: !4, unit: !1)
...
!102 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !21, type: !29)
!103 = !DILocation(column: 1, line: 193, scope: !21)
!104 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !21, type: !11)
!105 = !DILocation(column: 5, line: 194, scope: !21)
!106 = !DILocation(column: 9, line: 195, scope: !21)
!107 = !DILocation(column: 5, line: 197, scope: !21)
!108 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !21, type: !11)
!109 = !DILocation(column: 1, line: 197, scope: !21)
!110 = !DILocation(column: 5, line: 198, scope: !21)
!111 = !DILocation(column: 9, line: 199, scope: !21)
!112 = !DILocation(column: 5, line: 200, scope: !21)
!113 = !DILocation(column: 9, line: 201, scope: !21)
!114 = !DILocation(column: 5, line: 203, scope: !21)
!115 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !22, type: !74)
!116 = !DILocation(column: 1, line: 210, scope: !22)
!117 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !22, type: !85)
!118 = !DILocation(column: 5, line: 211, scope: !22)
!119 = !DILocation(column: 9, line: 212, scope: !22)
!120 = !DILocation(column: 5, line: 213, scope: !22)
!121 = !DILocation(column: 5, line: 214, scope: !22)
!122 = !DILocation(column: 5, line: 215, scope: !22)
...
!138 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !25, type: !74)
!139 = !DILocation(column: 1, line: 193, scope: !25)
!140 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !25, type: !11)
!141 = !DILocation(column: 5, line: 194, scope: !25)
!142 = !DILocation(column: 9, line: 195, scope: !25)
!143 = !DILocation(column: 5, line: 197, scope: !25)
!144 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !25, type: !11)
!145 = !DILocation(column: 1, line: 197, scope: !25)
!146 = !DILocation(column: 5, line: 198, scope: !25)
!147 = !DILocation(column: 9, line: 199, scope: !25)
!148 = !DILocation(column: 5, line: 200, scope: !25)
!149 = !DILocation(column: 9, line: 201, scope: !25)
!150 = !DILocation(column: 5, line: 203, scope: !25)
!151 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !26, type: !29)
!152 = !DILocation(column: 1, line: 179, scope: !26)
!153 = !DILocalVariable(file: !0, line: 179, name: "new_cap", scope: !26, type: !11)
!154 = !DILocation(column: 5, line: 180, scope: !26)
!155 = !DILocation(column: 9, line: 181, scope: !26)
!156 = !DILocation(column: 5, line: 183, scope: !26)
!157 = !DILocation(column: 5, line: 184, scope: !26)
!158 = !DILocation(column: 5, line: 185, scope: !26)
!159 = !DILocation(column: 9, line: 186, scope: !26)
!160 = !DILocation(column: 5, line: 188, scope: !26)
!161 = !DILocation(column: 5, line: 189, scope: !26)
!162 = !DILocation(column: 5, line: 190, scope: !26)
