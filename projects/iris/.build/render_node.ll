...
define linkonce_odr %"struct.ritz_module_1.Vec$RenderNode" @"vec_new$RenderNode"() !dbg !43
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$RenderNode", !dbg !231
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", metadata !233, metadata !7), !dbg !234
  %".3" = load %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", !dbg !235
  %".4" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", i32 0, i32 0 , !dbg !235
  %".5" = bitcast i8* null to %"struct.ritz_module_1.RenderNode"* , !dbg !235
  store %"struct.ritz_module_1.RenderNode"* %".5", %"struct.ritz_module_1.RenderNode"** %".4", !dbg !235
  %".7" = load %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", !dbg !236
  %".8" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", i32 0, i32 1 , !dbg !236
  store i64 0, i64* %".8", !dbg !236
  %".10" = load %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", !dbg !237
  %".11" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", i32 0, i32 2 , !dbg !237
  store i64 0, i64* %".11", !dbg !237
  %".13" = load %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.addr", !dbg !238
  ret %"struct.ritz_module_1.Vec$RenderNode" %".13", !dbg !238
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !252, metadata !7), !dbg !253
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !254, metadata !7), !dbg !253
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !255
  %".8" = load i64, i64* %".7", !dbg !255
  %".9" = add i64 %".8", 1, !dbg !255
  %".10" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".9"), !dbg !255
  %".11" = sext i32 %".10" to i64 , !dbg !255
  %".12" = icmp ne i64 %".11", 0 , !dbg !255
  br i1 %".12", label %"if.then", label %"if.end", !dbg !255
if.then:
  %".14" = sub i64 0, 1, !dbg !256
  %".15" = trunc i64 %".14" to i32 , !dbg !256
  ret i32 %".15", !dbg !256
if.end:
  %".17" = load i8, i8* %"item", !dbg !257
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !257
  %".19" = load i8*, i8** %".18", !dbg !257
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !257
  %".21" = load i64, i64* %".20", !dbg !257
  %".22" = getelementptr i8, i8* %".19", i64 %".21" , !dbg !257
  store i8 %".17", i8* %".22", !dbg !257
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !258
  %".25" = load i64, i64* %".24", !dbg !258
  %".26" = add i64 %".25", 1, !dbg !258
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 1 , !dbg !258
  store i64 %".26", i64* %".27", !dbg !258
  %".29" = trunc i64 0 to i32 , !dbg !259
  ret i32 %".29", !dbg !259
}
...
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !265
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !260, metadata !7), !dbg !261
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !262, metadata !7), !dbg !261
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !263
  %".8" = load i64, i64* %".7", !dbg !263
  %".9" = load i64, i64* %"needed", !dbg !263
  %".10" = icmp sge i64 %".8", %".9" , !dbg !263
  br i1 %".10", label %"if.then", label %"if.end", !dbg !263
if.then:
  %".12" = trunc i64 0 to i32 , !dbg !264
  ret i32 %".12", !dbg !264
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 2 , !dbg !265
  %".15" = load i64, i64* %".14", !dbg !265
  store i64 %".15", i64* %"new_cap.addr", !dbg !265
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !266, metadata !7), !dbg !267
  %".18" = load i64, i64* %"new_cap.addr", !dbg !268
  %".19" = icmp eq i64 %".18", 0 , !dbg !268
  br i1 %".19", label %"if.then.1", label %"if.end.1", !dbg !268
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !269
  br label %"if.end.1", !dbg !269
if.end.1:
  br label %"while.cond", !dbg !270
while.cond:
  %".24" = load i64, i64* %"new_cap.addr", !dbg !270
  %".25" = load i64, i64* %"needed", !dbg !270
  %".26" = icmp slt i64 %".24", %".25" , !dbg !270
  br i1 %".26", label %"while.body", label %"while.end", !dbg !270
while.body:
  %".28" = load i64, i64* %"new_cap.addr", !dbg !271
  %".29" = mul i64 %".28", 2, !dbg !271
  store i64 %".29", i64* %"new_cap.addr", !dbg !271
  br label %"while.cond", !dbg !271
while.end:
  %".32" = load i64, i64* %"new_cap.addr", !dbg !272
  %".33" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %".32"), !dbg !272
  ret i32 %".33", !dbg !272
}

define linkonce_odr i32 @"vec_push$RenderNode"(%"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", %"struct.ritz_module_1.RenderNode" %"item.arg") !dbg !47
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", metadata !274, metadata !7), !dbg !275
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.RenderNode"* %"item", metadata !276, metadata !7), !dbg !275
  %".7" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i32 0, i32 1 , !dbg !277
  %".8" = load i64, i64* %".7", !dbg !277
  %".9" = add i64 %".8", 1, !dbg !277
  %".10" = call i32 @"vec_ensure_cap$RenderNode"(%"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i64 %".9"), !dbg !277
...
if.then:
  ...
  ret i32 %".15", !dbg !278
if.end:
  %".17" = load %"struct.ritz_module_1.RenderNode", %"struct.ritz_module_1.RenderNode"* %"item", !dbg !279
  %".18" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i32 0, i32 0 , !dbg !279
  %".19" = load %"struct.ritz_module_1.RenderNode"*, %"struct.ritz_module_1.RenderNode"** %".18", !dbg !279
  %".20" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i32 0, i32 1 , !dbg !279
  %".21" = load i64, i64* %".20", !dbg !279
  %".22" = getelementptr %"struct.ritz_module_1.RenderNode", %"struct.ritz_module_1.RenderNode"* %".19", i64 %".21" , !dbg !279
  store %"struct.ritz_module_1.RenderNode" %".17", %"struct.ritz_module_1.RenderNode"* %".22", !dbg !279
  %".24" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i32 0, i32 1 , !dbg !280
  %".25" = load i64, i64* %".24", !dbg !280
  %".26" = add i64 %".25", 1, !dbg !280
  %".27" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i32 0, i32 1 , !dbg !280
...
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !284, metadata !7), !dbg !283
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !285, metadata !7), !dbg !283
  %".10" = load i64, i64* %"len", !dbg !286
  store i64 0, i64* %"i", !dbg !286
  br label %"for.cond", !dbg !286
for.cond:
  %".13" = load i64, i64* %"i", !dbg !286
  %".14" = icmp slt i64 %".13", %".10" , !dbg !286
  br i1 %".14", label %"for.body", label %"for.end", !dbg !286
for.body:
  %".16" = load i8*, i8** %"data", !dbg !286
  %".17" = load i64, i64* %"i", !dbg !286
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !286
  %".19" = load i8, i8* %".18", !dbg !286
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i8 %".19"), !dbg !286
  %".21" = sext i32 %".20" to i64 , !dbg !286
  %".22" = icmp ne i64 %".21", 0 , !dbg !286
  br i1 %".22", label %"if.then", label %"if.end", !dbg !286
for.incr:
  %".28" = load i64, i64* %"i", !dbg !287
  %".29" = add i64 %".28", 1, !dbg !287
  store i64 %".29", i64* %"i", !dbg !287
  br label %"for.cond", !dbg !287
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !288
  ret i32 %".32", !dbg !288
if.then:
  %".24" = sub i64 0, 1, !dbg !287
  %".25" = trunc i64 %".24" to i32 , !dbg !287
  ret i32 %".25", !dbg !287
if.end:
  br label %"for.incr", !dbg !287
}

define linkonce_odr i32 @"vec_ensure_cap$RenderNode"(%"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i64 %"needed.arg") !dbg !49
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !294
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", metadata !289, metadata !7), !dbg !290
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !291, metadata !7), !dbg !290
  %".7" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i32 0, i32 2 , !dbg !292
...
if.then:
  ...
  ret i32 %".12", !dbg !293
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$RenderNode", %"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i32 0, i32 2 , !dbg !294
...
while.end:
  ...
  %".33" = call i32 @"vec_grow$RenderNode"(%"struct.ritz_module_1.Vec$RenderNode"* %"v.arg", i64 %".32"), !dbg !301
  ret i32 %".33", !dbg !301
}
...
entry:
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", metadata !314, metadata !7), !dbg !315
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !316, metadata !7), !dbg !315
  %".7" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !317
...
if.then:
  ...
  ret i32 %".12", !dbg !318
if.end:
  %".14" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i32 0, i32 2 , !dbg !319
...
while.end:
  ...
  %".33" = call i32 @"vec_grow$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"* %"v.arg", i64 %".32"), !dbg !326
  ret i32 %".33", !dbg !326
}
...
!43 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$RenderNode", scopeLine: 116, type: !4, unit: !1)
...
!47 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$RenderNode", scopeLine: 210, type: !4, unit: !1)
...
!49 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$RenderNode", scopeLine: 193, type: !4, unit: !1)
...
!231 = !DILocation(column: 5, line: 117, scope: !43)
!232 = !DICompositeType(align: 64, file: !0, name: "Vec$RenderNode", size: 192, tag: DW_TAG_structure_type)
!233 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !43, type: !232)
!234 = !DILocation(column: 1, line: 117, scope: !43)
!235 = !DILocation(column: 5, line: 118, scope: !43)
!236 = !DILocation(column: 5, line: 119, scope: !43)
!237 = !DILocation(column: 5, line: 120, scope: !43)
!238 = !DILocation(column: 5, line: 121, scope: !43)
...
!241 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !44, type: !240)
!242 = !DILocation(column: 1, line: 210, scope: !44)
!243 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!244 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !44, type: !243)
!245 = !DILocation(column: 5, line: 211, scope: !44)
!246 = !DILocation(column: 9, line: 212, scope: !44)
!247 = !DILocation(column: 5, line: 213, scope: !44)
!248 = !DILocation(column: 5, line: 214, scope: !44)
!249 = !DILocation(column: 5, line: 215, scope: !44)
!250 = !DICompositeType(align: 64, file: !0, name: "Vec$u8", size: 192, tag: DW_TAG_structure_type)
!251 = !DIDerivedType(baseType: !250, size: 64, tag: DW_TAG_reference_type)
!252 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !45, type: !251)
!253 = !DILocation(column: 1, line: 210, scope: !45)
!254 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !45, type: !12)
!255 = !DILocation(column: 5, line: 211, scope: !45)
!256 = !DILocation(column: 9, line: 212, scope: !45)
!257 = !DILocation(column: 5, line: 213, scope: !45)
!258 = !DILocation(column: 5, line: 214, scope: !45)
!259 = !DILocation(column: 5, line: 215, scope: !45)
!260 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !46, type: !251)
!261 = !DILocation(column: 1, line: 193, scope: !46)
!262 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !46, type: !11)
!263 = !DILocation(column: 5, line: 194, scope: !46)
!264 = !DILocation(column: 9, line: 195, scope: !46)
!265 = !DILocation(column: 5, line: 197, scope: !46)
!266 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !46, type: !11)
!267 = !DILocation(column: 1, line: 197, scope: !46)
!268 = !DILocation(column: 5, line: 198, scope: !46)
!269 = !DILocation(column: 9, line: 199, scope: !46)
!270 = !DILocation(column: 5, line: 200, scope: !46)
!271 = !DILocation(column: 9, line: 201, scope: !46)
!272 = !DILocation(column: 5, line: 203, scope: !46)
!273 = !DIDerivedType(baseType: !232, size: 64, tag: DW_TAG_reference_type)
!274 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !47, type: !273)
!275 = !DILocation(column: 1, line: 210, scope: !47)
!276 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !47, type: !116)
!277 = !DILocation(column: 5, line: 211, scope: !47)
!278 = !DILocation(column: 9, line: 212, scope: !47)
!279 = !DILocation(column: 5, line: 213, scope: !47)
!280 = !DILocation(column: 5, line: 214, scope: !47)
!281 = !DILocation(column: 5, line: 215, scope: !47)
!282 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !48, type: !251)
!283 = !DILocation(column: 1, line: 288, scope: !48)
!284 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !48, type: !107)
!285 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !48, type: !11)
!286 = !DILocation(column: 5, line: 289, scope: !48)
!287 = !DILocation(column: 13, line: 291, scope: !48)
!288 = !DILocation(column: 5, line: 292, scope: !48)
!289 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !49, type: !273)
...
!302 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !50, type: !251)
...
!314 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !51, type: !240)
...
!327 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !52, type: !273)
...
!339 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !53, type: !240)
