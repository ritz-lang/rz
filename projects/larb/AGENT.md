...
3. Implement the feature in ritz/ritzlib with proper tests
4. Submit the change upstream via PR (see Contributing Upstream below)
5. If the maintainers push back, **start a design session** to:
   - Reduce coupling between components
   - Respect responsibility boundaries between *behavior*, not data
   - Find a solution that works for the whole ecosystem
6. Only then use it in your project
