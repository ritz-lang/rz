...
%"struct.ritz_module_1.ReqParam" = type {[64 x i8], i64, [256 x i8], i64}
%"struct.ritz_module_1.Request" = type {i32, [1024 x i8], i64, [1024 x i8], i64, [64 x %"struct.ritz_module_1.ReqParam"], i64, [16 x %"struct.ritz_module_1.ReqParam"], i64, [65536 x i8], i64}
...
while.body:
  ...
  %".24" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".23", i32 0, i64 %".21" , !dbg !143
  %".25" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".24", i32 0, i32 0 , !dbg !143
  ...
  %".33" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".32", i32 0, i64 %".30" , !dbg !144
  %".34" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".33", !dbg !144
  %".35" = extractvalue %"struct.ritz_module_1.ReqParam" %".34", 1 , !dbg !144
...
if.then:
  ...
  %".47" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".46", i32 0, i64 %".44" , !dbg !146
  %".48" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".47", i32 0, i32 2 , !dbg !146
  ...
  %".56" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".55", i32 0, i64 %".53" , !dbg !147
  %".57" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".56", !dbg !147
  %".58" = extractvalue %"struct.ritz_module_1.ReqParam" %".57", 3 , !dbg !147
...
while.body:
  ...
  %".24" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".23", i32 0, i64 %".21" , !dbg !167
  %".25" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".24", i32 0, i32 0 , !dbg !167
  ...
  %".33" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".32", i32 0, i64 %".30" , !dbg !168
  %".34" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".33", !dbg !168
  %".35" = extractvalue %"struct.ritz_module_1.ReqParam" %".34", 1 , !dbg !168
...
if.then:
  ...
  %".47" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".46", i32 0, i64 %".44" , !dbg !170
  %".48" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".47", i32 0, i32 2 , !dbg !170
  ...
  %".56" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".55", i32 0, i64 %".53" , !dbg !171
  %".57" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".56", !dbg !171
  %".58" = extractvalue %"struct.ritz_module_1.ReqParam" %".57", 3 , !dbg !171
...
while.body:
  ...
  %".43" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".42", i32 0, i64 %".19" , !dbg !260
  %".44" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".43", i32 0, i32 0 , !dbg !260
...
while.end:
  ...
  %".54" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".53", i32 0, i64 %".19" , !dbg !262
  %".55" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".54", !dbg !262
  ...
  %".58" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".57", i32 0, i64 %".19" , !dbg !262
  %".59" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".58", i32 0, i32 1 , !dbg !262
...
while.body.1:
  ...
  %".83" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".82", i32 0, i64 %".19" , !dbg !265
  %".84" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".83", i32 0, i32 2 , !dbg !265
...
while.end.1:
  ...
  %".94" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".93", i32 0, i64 %".19" , !dbg !267
  %".95" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".94", !dbg !267
  ...
  %".98" = getelementptr [64 x %"struct.ritz_module_1.ReqParam"], [64 x %"struct.ritz_module_1.ReqParam"]* %".97", i32 0, i64 %".19" , !dbg !267
  %".99" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".98", i32 0, i32 3 , !dbg !267
...
while.body:
  ...
  %".43" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".42", i32 0, i64 %".19" , !dbg !280
  %".44" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".43", i32 0, i32 0 , !dbg !280
...
while.end:
  ...
  %".54" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".53", i32 0, i64 %".19" , !dbg !282
  %".55" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".54", !dbg !282
  ...
  %".58" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".57", i32 0, i64 %".19" , !dbg !282
  %".59" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".58", i32 0, i32 1 , !dbg !282
...
while.body.1:
  ...
  %".83" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".82", i32 0, i64 %".19" , !dbg !285
  %".84" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".83", i32 0, i32 2 , !dbg !285
...
while.end.1:
  ...
  %".94" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".93", i32 0, i64 %".19" , !dbg !287
  %".95" = load %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".94", !dbg !287
  ...
  %".98" = getelementptr [16 x %"struct.ritz_module_1.ReqParam"], [16 x %"struct.ritz_module_1.ReqParam"]* %".97", i32 0, i64 %".19" , !dbg !287
  %".99" = getelementptr %"struct.ritz_module_1.ReqParam", %"struct.ritz_module_1.ReqParam"* %".98", i32 0, i32 3 , !dbg !287
...
define linkonce_odr i32 @"vec_clear$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg") !dbg !45
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !322, metadata !7), !dbg !323
  %".4" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !324
  %".5" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".4", i32 0, i32 1 , !dbg !324
  store i64 0, i64* %".5", !dbg !324
  ret i32 0, !dbg !324
}
...
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !330
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !325, metadata !7), !dbg !326
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !327, metadata !7), !dbg !326
  %".7" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !328
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".7", i32 0, i32 2 , !dbg !328
  %".9" = load i64, i64* %".8", !dbg !328
  %".10" = load i64, i64* %"needed", !dbg !328
  %".11" = icmp sge i64 %".9", %".10" , !dbg !328
  br i1 %".11", label %"if.then", label %"if.end", !dbg !328
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !329
  ret i32 %".13", !dbg !329
if.end:
  %".15" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !330
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".15", i32 0, i32 2 , !dbg !330
  %".17" = load i64, i64* %".16", !dbg !330
  store i64 %".17", i64* %"new_cap.addr", !dbg !330
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !331, metadata !7), !dbg !332
  %".20" = load i64, i64* %"new_cap.addr", !dbg !333
  %".21" = icmp eq i64 %".20", 0 , !dbg !333
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !333
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !334
  br label %"if.end.1", !dbg !334
if.end.1:
  br label %"while.cond", !dbg !335
while.cond:
  %".26" = load i64, i64* %"new_cap.addr", !dbg !335
  %".27" = load i64, i64* %"needed", !dbg !335
  %".28" = icmp slt i64 %".26", %".27" , !dbg !335
  br i1 %".28", label %"while.body", label %"while.end", !dbg !335
while.body:
  %".30" = load i64, i64* %"new_cap.addr", !dbg !336
  %".31" = mul i64 %".30", 2, !dbg !336
  store i64 %".31", i64* %"new_cap.addr", !dbg !336
  br label %"while.cond", !dbg !336
while.end:
  %".34" = load i64, i64* %"new_cap.addr", !dbg !337
  %".35" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i64 %".34"), !dbg !337
  ret i32 %".35", !dbg !337
}

define linkonce_odr i8 @"vec_pop$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg") !dbg !47
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !338, metadata !7), !dbg !339
  %".4" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !340
  %".5" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".4", i32 0, i32 1 , !dbg !340
  %".6" = load i64, i64* %".5", !dbg !340
  %".7" = sub i64 %".6", 1, !dbg !340
  %".8" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !340
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".8", i32 0, i32 1 , !dbg !340
  store i64 %".7", i64* %".9", !dbg !340
  %".11" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !341
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".11", i32 0, i32 0 , !dbg !341
  %".13" = load i8*, i8** %".12", !dbg !341
  %".14" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !341
  %".15" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".14", i32 0, i32 1 , !dbg !341
  %".16" = load i64, i64* %".15", !dbg !341
  %".17" = getelementptr i8, i8* %".13", i64 %".16" , !dbg !341
  %".18" = load i8, i8* %".17", !dbg !341
  ret i8 %".18", !dbg !341
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", metadata !345, metadata !7), !dbg !346
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !348, metadata !7), !dbg !346
  %".7" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !349
  %".8" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".7", i32 0, i32 1 , !dbg !349
  %".9" = load i64, i64* %".8", !dbg !349
  %".10" = add i64 %".9", 1, !dbg !349
  %".11" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %".10"), !dbg !349
  %".12" = sext i32 %".11" to i64 , !dbg !349
  %".13" = icmp ne i64 %".12", 0 , !dbg !349
  br i1 %".13", label %"if.then", label %"if.end", !dbg !349
if.then:
  %".15" = sub i64 0, 1, !dbg !350
  %".16" = trunc i64 %".15" to i32 , !dbg !350
  ret i32 %".16", !dbg !350
if.end:
  %".18" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !351
  %".19" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !351
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".19", i32 0, i32 0 , !dbg !351
  %".21" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".20", !dbg !351
  %".22" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !351
  %".23" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".22", i32 0, i32 1 , !dbg !351
  %".24" = load i64, i64* %".23", !dbg !351
  %".25" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".21", i64 %".24" , !dbg !351
  store %"struct.ritz_module_1.LineBounds" %".18", %"struct.ritz_module_1.LineBounds"* %".25", !dbg !351
  %".27" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !352
  %".28" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".27", i32 0, i32 1 , !dbg !352
  %".29" = load i64, i64* %".28", !dbg !352
  %".30" = add i64 %".29", 1, !dbg !352
  %".31" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !352
  %".32" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".31", i32 0, i32 1 , !dbg !352
  store i64 %".30", i64* %".32", !dbg !352
  %".34" = trunc i64 0 to i32 , !dbg !353
  ret i32 %".34", !dbg !353
}

define linkonce_odr i32 @"vec_drop$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg") !dbg !49
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !354, metadata !7), !dbg !355
  %".4" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !356
  %".5" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".4", i32 0, i32 0 , !dbg !356
  %".6" = load i8*, i8** %".5", !dbg !356
  %".7" = icmp ne i8* %".6", null , !dbg !356
  br i1 %".7", label %"if.then", label %"if.end", !dbg !356
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !356
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".9", i32 0, i32 0 , !dbg !356
  %".11" = load i8*, i8** %".10", !dbg !356
  %".12" = call i32 @"free"(i8* %".11"), !dbg !356
  br label %"if.end", !dbg !356
if.end:
  %".14" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !357
  %".15" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".14", i32 0, i32 0 , !dbg !357
  store i8* null, i8** %".15", !dbg !357
  %".17" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !358
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".17", i32 0, i32 1 , !dbg !358
  store i64 0, i64* %".18", !dbg !358
  %".20" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !359
  %".21" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".20", i32 0, i32 2 , !dbg !359
  store i64 0, i64* %".21", !dbg !359
  ret i32 0, !dbg !359
}

define linkonce_odr i32 @"vec_push_bytes$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i8* %"data.arg", i64 %"len.arg") !dbg !50
{
entry:
  %"i" = alloca i64, !dbg !365
  ...
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !363, metadata !7), !dbg !361
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !364, metadata !7), !dbg !361
  %".10" = load i64, i64* %"len", !dbg !365
  store i64 0, i64* %"i", !dbg !365
  br label %"for.cond", !dbg !365
for.cond:
  %".13" = load i64, i64* %"i", !dbg !365
  %".14" = icmp slt i64 %".13", %".10" , !dbg !365
  br i1 %".14", label %"for.body", label %"for.end", !dbg !365
for.body:
  %".16" = load i8*, i8** %"data", !dbg !365
  %".17" = load i64, i64* %"i", !dbg !365
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !365
  %".19" = load i8, i8* %".18", !dbg !365
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i8 %".19"), !dbg !365
  %".21" = sext i32 %".20" to i64 , !dbg !365
  %".22" = icmp ne i64 %".21", 0 , !dbg !365
  br i1 %".22", label %"if.then", label %"if.end", !dbg !365
for.incr:
  %".28" = load i64, i64* %"i", !dbg !366
  %".29" = add i64 %".28", 1, !dbg !366
  store i64 %".29", i64* %"i", !dbg !366
  br label %"for.cond", !dbg !366
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !367
  ret i32 %".32", !dbg !367
if.then:
  %".24" = sub i64 0, 1, !dbg !366
  %".25" = trunc i64 %".24" to i32 , !dbg !366
  ret i32 %".25", !dbg !366
if.end:
  br label %"for.incr", !dbg !366
}

define linkonce_odr i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i8 %"item.arg") !dbg !51
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !368, metadata !7), !dbg !369
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !370, metadata !7), !dbg !369
  %".7" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !371
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".7", i32 0, i32 1 , !dbg !371
  %".9" = load i64, i64* %".8", !dbg !371
  %".10" = add i64 %".9", 1, !dbg !371
  %".11" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i64 %".10"), !dbg !371
  %".12" = sext i32 %".11" to i64 , !dbg !371
  %".13" = icmp ne i64 %".12", 0 , !dbg !371
  br i1 %".13", label %"if.then", label %"if.end", !dbg !371
if.then:
  %".15" = sub i64 0, 1, !dbg !372
  %".16" = trunc i64 %".15" to i32 , !dbg !372
  ret i32 %".16", !dbg !372
if.end:
  %".18" = load i8, i8* %"item", !dbg !373
  %".19" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !373
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".19", i32 0, i32 0 , !dbg !373
  %".21" = load i8*, i8** %".20", !dbg !373
  %".22" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !373
  %".23" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".22", i32 0, i32 1 , !dbg !373
  %".24" = load i64, i64* %".23", !dbg !373
  %".25" = getelementptr i8, i8* %".21", i64 %".24" , !dbg !373
  store i8 %".18", i8* %".25", !dbg !373
  %".27" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !374
  %".28" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".27", i32 0, i32 1 , !dbg !374
  %".29" = load i64, i64* %".28", !dbg !374
  %".30" = add i64 %".29", 1, !dbg !374
  %".31" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !374
  %".32" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".31", i32 0, i32 1 , !dbg !374
  store i64 %".30", i64* %".32", !dbg !374
  %".34" = trunc i64 0 to i32 , !dbg !375
  ret i32 %".34", !dbg !375
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_with_cap$u8"(i64 %"cap.arg") !dbg !52
{
entry:
  %"cap" = alloca i64
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !378
  store i64 %"cap.arg", i64* %"cap"
  call void @"llvm.dbg.declare"(metadata i64* %"cap", metadata !376, metadata !7), !dbg !377
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !379, metadata !7), !dbg !380
  %".6" = load i64, i64* %"cap", !dbg !381
  %".7" = icmp sle i64 %".6", 0 , !dbg !381
  br i1 %".7", label %"if.then", label %"if.end", !dbg !381
if.then:
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !382
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !382
  store i8* null, i8** %".10", !dbg !382
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !383
  %".13" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !383
  store i64 0, i64* %".13", !dbg !383
  %".15" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !384
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !384
  store i64 0, i64* %".16", !dbg !384
  %".18" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !385
  ret %"struct.ritz_module_1.Vec$u8" %".18", !dbg !385
if.end:
  %".20" = load i64, i64* %"cap", !dbg !386
  %".21" = mul i64 %".20", 1, !dbg !386
  %".22" = call i8* @"malloc"(i64 %".21"), !dbg !387
  %".23" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !387
  %".24" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !387
  store i8* %".22", i8** %".24", !dbg !387
  %".26" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !388
  %".27" = load i8*, i8** %".26", !dbg !388
  %".28" = icmp eq i8* %".27", null , !dbg !388
  br i1 %".28", label %"if.then.1", label %"if.end.1", !dbg !388
if.then.1:
  %".30" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !389
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !389
  store i64 0, i64* %".31", !dbg !389
  %".33" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !390
  %".34" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !390
  store i64 0, i64* %".34", !dbg !390
  %".36" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !391
  ret %"struct.ritz_module_1.Vec$u8" %".36", !dbg !391
if.end.1:
  %".38" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !392
  %".39" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !392
  store i64 0, i64* %".39", !dbg !392
  %".41" = load i64, i64* %"cap", !dbg !393
  %".42" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !393
  %".43" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !393
  store i64 %".41", i64* %".43", !dbg !393
  %".45" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !394
  ret %"struct.ritz_module_1.Vec$u8" %".45", !dbg !394
}

define linkonce_odr i8 @"vec_get$u8"(%"struct.ritz_module_1.Vec$u8"* %"v.arg", i64 %"idx.arg") !dbg !53
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.arg", metadata !395, metadata !7), !dbg !396
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !397, metadata !7), !dbg !396
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.arg", i32 0, i32 0 , !dbg !398
  %".8" = load i8*, i8** %".7", !dbg !398
  %".9" = load i64, i64* %"idx", !dbg !398
  %".10" = getelementptr i8, i8* %".8", i64 %".9" , !dbg !398
  %".11" = load i8, i8* %".10", !dbg !398
  ret i8 %".11", !dbg !398
}

define linkonce_odr %"struct.ritz_module_1.Vec$u8" @"vec_new$u8"() !dbg !54
{
entry:
  %"v.addr" = alloca %"struct.ritz_module_1.Vec$u8", !dbg !399
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"* %"v.addr", metadata !400, metadata !7), !dbg !401
  %".3" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !402
  %".4" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 0 , !dbg !402
  store i8* null, i8** %".4", !dbg !402
  %".6" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !403
  %".7" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 1 , !dbg !403
  store i64 0, i64* %".7", !dbg !403
  %".9" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !404
  %".10" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", i32 0, i32 2 , !dbg !404
  store i64 0, i64* %".10", !dbg !404
  %".12" = load %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %"v.addr", !dbg !405
  ret %"struct.ritz_module_1.Vec$u8" %".12", !dbg !405
}

define linkonce_odr i32 @"vec_set$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i64 %"idx.arg", i8 %"item.arg") !dbg !55
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !406, metadata !7), !dbg !407
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !408, metadata !7), !dbg !407
  %"item" = alloca i8
  store i8 %"item.arg", i8* %"item"
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !409, metadata !7), !dbg !407
  %".10" = load i8, i8* %"item", !dbg !410
  %".11" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !410
  %".12" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".11", i32 0, i32 0 , !dbg !410
  %".13" = load i8*, i8** %".12", !dbg !410
  %".14" = load i64, i64* %"idx", !dbg !410
  %".15" = getelementptr i8, i8* %".13", i64 %".14" , !dbg !410
  store i8 %".10", i8* %".15", !dbg !410
  %".17" = trunc i64 0 to i32 , !dbg !411
  ret i32 %".17", !dbg !411
}

define linkonce_odr i8* @"span_get_ptr$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"idx.arg") !dbg !56
{
entry:
  ...
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !414, metadata !7), !dbg !413
  %".8" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !415
  %".9" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".8", i32 0, i32 0 , !dbg !415
  %".10" = load i8*, i8** %".9", !dbg !415
  %".11" = load i64, i64* %"idx", !dbg !415
  %".12" = getelementptr i8, i8* %".10", i64 %".11" , !dbg !415
  ret i8* %".12", !dbg !415
}

define linkonce_odr i64 @"span_len$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg") !dbg !57
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !416, metadata !7), !dbg !417
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !418
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 1 , !dbg !418
  %".7" = load i64, i64* %".6", !dbg !418
  ret i64 %".7", !dbg !418
}

define linkonce_odr i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i64 %"new_cap.arg") !dbg !58
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !419, metadata !7), !dbg !420
  %"new_cap" = alloca i64
  store i64 %"new_cap.arg", i64* %"new_cap"
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap", metadata !421, metadata !7), !dbg !420
  %".7" = load i64, i64* %"new_cap", !dbg !422
  %".8" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !422
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".8", i32 0, i32 2 , !dbg !422
  %".10" = load i64, i64* %".9", !dbg !422
  %".11" = icmp sle i64 %".7", %".10" , !dbg !422
  br i1 %".11", label %"if.then", label %"if.end", !dbg !422
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !423
  ret i32 %".13", !dbg !423
if.end:
  %".15" = load i64, i64* %"new_cap", !dbg !424
  %".16" = mul i64 %".15", 1, !dbg !424
  %".17" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !425
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".17", i32 0, i32 0 , !dbg !425
  %".19" = load i8*, i8** %".18", !dbg !425
  %".20" = call i8* @"realloc"(i8* %".19", i64 %".16"), !dbg !425
  %".21" = icmp eq i8* %".20", null , !dbg !426
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !426
if.then.1:
  %".23" = sub i64 0, 1, !dbg !427
  %".24" = trunc i64 %".23" to i32 , !dbg !427
  ret i32 %".24", !dbg !427
if.end.1:
  %".26" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !428
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".26", i32 0, i32 0 , !dbg !428
  store i8* %".20", i8** %".27", !dbg !428
  %".29" = load i64, i64* %"new_cap", !dbg !429
  %".30" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !429
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".30", i32 0, i32 2 , !dbg !429
  store i64 %".29", i64* %".31", !dbg !429
  %".33" = trunc i64 0 to i32 , !dbg !430
  ret i32 %".33", !dbg !430
}

define linkonce_odr %"struct.ritz_module_1.Span$u8" @"span_slice$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"start.arg", i64 %"end.arg") !dbg !59
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  %"result.addr" = alloca %"struct.ritz_module_1.Span$u8", !dbg !435
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !431, metadata !7), !dbg !432
  %"start" = alloca i64
  store i64 %"start.arg", i64* %"start"
  call void @"llvm.dbg.declare"(metadata i64* %"start", metadata !433, metadata !7), !dbg !432
  %"end" = alloca i64
  store i64 %"end.arg", i64* %"end"
  call void @"llvm.dbg.declare"(metadata i64* %"end", metadata !434, metadata !7), !dbg !432
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"* %"result.addr", metadata !436, metadata !7), !dbg !437
  %".12" = load i64, i64* %"start", !dbg !438
  %".13" = icmp slt i64 %".12", 0 , !dbg !438
  br i1 %".13", label %"if.then", label %"if.end", !dbg !438
if.then:
  store i64 0, i64* %"start", !dbg !439
  br label %"if.end", !dbg !439
if.end:
  %".17" = load i64, i64* %"end", !dbg !440
  %".18" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !440
  %".19" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".18", i32 0, i32 1 , !dbg !440
  %".20" = load i64, i64* %".19", !dbg !440
  %".21" = icmp sgt i64 %".17", %".20" , !dbg !440
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !440
if.then.1:
  %".23" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !441
  %".24" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".23", i32 0, i32 1 , !dbg !441
  %".25" = load i64, i64* %".24", !dbg !441
  store i64 %".25", i64* %"end", !dbg !441
  br label %"if.end.1", !dbg !441
if.end.1:
  %".28" = load i64, i64* %"start", !dbg !442
  %".29" = load i64, i64* %"end", !dbg !442
  %".30" = icmp sge i64 %".28", %".29" , !dbg !442
  br i1 %".30", label %"if.then.2", label %"if.end.2", !dbg !442
if.then.2:
  %".32" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !443
  %".33" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 0 , !dbg !443
  store i8* null, i8** %".33", !dbg !443
  %".35" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !444
  %".36" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 1 , !dbg !444
  store i64 0, i64* %".36", !dbg !444
  %".38" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !445
  ret %"struct.ritz_module_1.Span$u8" %".38", !dbg !445
if.end.2:
  %".40" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !446
  %".41" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".40", i32 0, i32 0 , !dbg !446
  %".42" = load i8*, i8** %".41", !dbg !446
  %".43" = load i64, i64* %"start", !dbg !446
  %".44" = getelementptr i8, i8* %".42", i64 %".43" , !dbg !446
  %".45" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !446
  %".46" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 0 , !dbg !446
  store i8* %".44", i8** %".46", !dbg !446
  %".48" = load i64, i64* %"end", !dbg !447
  %".49" = load i64, i64* %"start", !dbg !447
  %".50" = sub i64 %".48", %".49", !dbg !447
  %".51" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !447
  %".52" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 1 , !dbg !447
  store i64 %".50", i64* %".52", !dbg !447
  %".54" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !448
  ret %"struct.ritz_module_1.Span$u8" %".54", !dbg !448
}
...
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !449, metadata !7), !dbg !450
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !451
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 1 , !dbg !451
  %".7" = load i64, i64* %".6", !dbg !451
  %".8" = icmp eq i64 %".7", 0 , !dbg !451
  br i1 %".8", label %"if.then", label %"if.end", !dbg !451
if.then:
  %".10" = trunc i64 1 to i32 , !dbg !452
  ret i32 %".10", !dbg !452
if.end:
  %".12" = trunc i64 0 to i32 , !dbg !453
  ret i32 %".12", !dbg !453
}

define linkonce_odr i8 @"span_get$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"idx.arg") !dbg !61
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !454, metadata !7), !dbg !455
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !456, metadata !7), !dbg !455
  %".8" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !457
  %".9" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".8", i32 0, i32 0 , !dbg !457
  %".10" = load i8*, i8** %".9", !dbg !457
  %".11" = load i64, i64* %"idx", !dbg !457
  %".12" = getelementptr i8, i8* %".10", i64 %".11" , !dbg !457
  %".13" = load i8, i8* %".12", !dbg !457
  ret i8 %".13", !dbg !457
}

define linkonce_odr i8* @"span_as_ptr$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg") !dbg !62
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !458, metadata !7), !dbg !459
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !460
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 0 , !dbg !460
  %".7" = load i8*, i8** %".6", !dbg !460
  ret i8* %".7", !dbg !460
}

define linkonce_odr i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %"needed.arg") !dbg !63
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !466
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", metadata !461, metadata !7), !dbg !462
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !463, metadata !7), !dbg !462
  %".7" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !464
  %".8" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".7", i32 0, i32 2 , !dbg !464
  %".9" = load i64, i64* %".8", !dbg !464
  %".10" = load i64, i64* %"needed", !dbg !464
  %".11" = icmp sge i64 %".9", %".10" , !dbg !464
  br i1 %".11", label %"if.then", label %"if.end", !dbg !464
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !465
  ret i32 %".13", !dbg !465
if.end:
  %".15" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !466
  %".16" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".15", i32 0, i32 2 , !dbg !466
  %".17" = load i64, i64* %".16", !dbg !466
  store i64 %".17", i64* %"new_cap.addr", !dbg !466
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !467, metadata !7), !dbg !468
  %".20" = load i64, i64* %"new_cap.addr", !dbg !469
  %".21" = icmp eq i64 %".20", 0 , !dbg !469
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !469
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !470
  br label %"if.end.1", !dbg !470
if.end.1:
  br label %"while.cond", !dbg !471
while.cond:
  %".26" = load i64, i64* %"new_cap.addr", !dbg !471
  %".27" = load i64, i64* %"needed", !dbg !471
  %".28" = icmp slt i64 %".26", %".27" , !dbg !471
  br i1 %".28", label %"while.body", label %"while.end", !dbg !471
while.body:
  %".30" = load i64, i64* %"new_cap.addr", !dbg !472
  %".31" = mul i64 %".30", 2, !dbg !472
  store i64 %".31", i64* %"new_cap.addr", !dbg !472
  br label %"while.cond", !dbg !472
while.end:
  %".34" = load i64, i64* %"new_cap.addr", !dbg !473
  %".35" = call i32 @"vec_grow$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %".34"), !dbg !473
  ret i32 %".35", !dbg !473
}
...
!45 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 244, name: "vec_clear$u8", scopeLine: 244, type: !4, unit: !1)
...
!47 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 219, name: "vec_pop$u8", scopeLine: 219, type: !4, unit: !1)
...
!49 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 148, name: "vec_drop$u8", scopeLine: 148, type: !4, unit: !1)
!50 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 288, name: "vec_push_bytes$u8", scopeLine: 288, type: !4, unit: !1)
!51 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$u8", scopeLine: 210, type: !4, unit: !1)
!52 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 124, name: "vec_with_cap$u8", scopeLine: 124, type: !4, unit: !1)
!53 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 225, name: "vec_get$u8", scopeLine: 225, type: !4, unit: !1)
!54 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 116, name: "vec_new$u8", scopeLine: 116, type: !4, unit: !1)
!55 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 235, name: "vec_set$u8", scopeLine: 235, type: !4, unit: !1)
!56 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 93, name: "span_get_ptr$u8", scopeLine: 93, type: !4, unit: !1)
!57 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 79, name: "span_len$u8", scopeLine: 79, type: !4, unit: !1)
!58 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 179, name: "vec_grow$u8", scopeLine: 179, type: !4, unit: !1)
!59 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 105, name: "span_slice$u8", scopeLine: 105, type: !4, unit: !1)
!60 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 83, name: "span_is_empty$u8", scopeLine: 83, type: !4, unit: !1)
!61 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 89, name: "span_get$u8", scopeLine: 89, type: !4, unit: !1)
!62 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 97, name: "span_as_ptr$u8", scopeLine: 97, type: !4, unit: !1)
!63 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$LineBounds", scopeLine: 193, type: !4, unit: !1)
...
!322 = !DILocalVariable(file: !0, line: 244, name: "v", scope: !45, type: !321)
!323 = !DILocation(column: 1, line: 244, scope: !45)
!324 = !DILocation(column: 5, line: 245, scope: !45)
!325 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !46, type: !321)
!326 = !DILocation(column: 1, line: 193, scope: !46)
!327 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !46, type: !11)
!328 = !DILocation(column: 5, line: 194, scope: !46)
!329 = !DILocation(column: 9, line: 195, scope: !46)
!330 = !DILocation(column: 5, line: 197, scope: !46)
!331 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !46, type: !11)
!332 = !DILocation(column: 1, line: 197, scope: !46)
!333 = !DILocation(column: 5, line: 198, scope: !46)
!334 = !DILocation(column: 9, line: 199, scope: !46)
!335 = !DILocation(column: 5, line: 200, scope: !46)
!336 = !DILocation(column: 9, line: 201, scope: !46)
!337 = !DILocation(column: 5, line: 203, scope: !46)
!338 = !DILocalVariable(file: !0, line: 219, name: "v", scope: !47, type: !321)
!339 = !DILocation(column: 1, line: 219, scope: !47)
!340 = !DILocation(column: 5, line: 220, scope: !47)
!341 = !DILocation(column: 5, line: 221, scope: !47)
!342 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!343 = !DIDerivedType(baseType: !342, size: 64, tag: DW_TAG_reference_type)
!344 = !DIDerivedType(baseType: !343, size: 64, tag: DW_TAG_reference_type)
!345 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !48, type: !344)
!346 = !DILocation(column: 1, line: 210, scope: !48)
!347 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!348 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !48, type: !347)
!349 = !DILocation(column: 5, line: 211, scope: !48)
!350 = !DILocation(column: 9, line: 212, scope: !48)
!351 = !DILocation(column: 5, line: 213, scope: !48)
!352 = !DILocation(column: 5, line: 214, scope: !48)
!353 = !DILocation(column: 5, line: 215, scope: !48)
!354 = !DILocalVariable(file: !0, line: 148, name: "v", scope: !49, type: !321)
!355 = !DILocation(column: 1, line: 148, scope: !49)
!356 = !DILocation(column: 5, line: 149, scope: !49)
!357 = !DILocation(column: 5, line: 151, scope: !49)
!358 = !DILocation(column: 5, line: 152, scope: !49)
!359 = !DILocation(column: 5, line: 153, scope: !49)
!360 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !50, type: !321)
!361 = !DILocation(column: 1, line: 288, scope: !50)
!362 = !DIDerivedType(baseType: !12, size: 64, tag: DW_TAG_pointer_type)
!363 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !50, type: !362)
!364 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !50, type: !11)
!365 = !DILocation(column: 5, line: 289, scope: !50)
!366 = !DILocation(column: 13, line: 291, scope: !50)
!367 = !DILocation(column: 5, line: 292, scope: !50)
!368 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !51, type: !321)
!369 = !DILocation(column: 1, line: 210, scope: !51)
!370 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !51, type: !12)
!371 = !DILocation(column: 5, line: 211, scope: !51)
!372 = !DILocation(column: 9, line: 212, scope: !51)
!373 = !DILocation(column: 5, line: 213, scope: !51)
!374 = !DILocation(column: 5, line: 214, scope: !51)
!375 = !DILocation(column: 5, line: 215, scope: !51)
!376 = !DILocalVariable(file: !0, line: 124, name: "cap", scope: !52, type: !11)
!377 = !DILocation(column: 1, line: 124, scope: !52)
!378 = !DILocation(column: 5, line: 125, scope: !52)
!379 = !DILocalVariable(file: !0, line: 125, name: "v", scope: !52, type: !319)
!380 = !DILocation(column: 1, line: 125, scope: !52)
!381 = !DILocation(column: 5, line: 126, scope: !52)
!382 = !DILocation(column: 9, line: 127, scope: !52)
!383 = !DILocation(column: 9, line: 128, scope: !52)
!384 = !DILocation(column: 9, line: 129, scope: !52)
!385 = !DILocation(column: 9, line: 130, scope: !52)
!386 = !DILocation(column: 5, line: 132, scope: !52)
!387 = !DILocation(column: 5, line: 133, scope: !52)
!388 = !DILocation(column: 5, line: 134, scope: !52)
!389 = !DILocation(column: 9, line: 135, scope: !52)
!390 = !DILocation(column: 9, line: 136, scope: !52)
!391 = !DILocation(column: 9, line: 137, scope: !52)
!392 = !DILocation(column: 5, line: 139, scope: !52)
!393 = !DILocation(column: 5, line: 140, scope: !52)
!394 = !DILocation(column: 5, line: 141, scope: !52)
!395 = !DILocalVariable(file: !0, line: 225, name: "v", scope: !53, type: !320)
!396 = !DILocation(column: 1, line: 225, scope: !53)
!397 = !DILocalVariable(file: !0, line: 225, name: "idx", scope: !53, type: !11)
!398 = !DILocation(column: 5, line: 226, scope: !53)
!399 = !DILocation(column: 5, line: 117, scope: !54)
!400 = !DILocalVariable(file: !0, line: 117, name: "v", scope: !54, type: !319)
!401 = !DILocation(column: 1, line: 117, scope: !54)
!402 = !DILocation(column: 5, line: 118, scope: !54)
!403 = !DILocation(column: 5, line: 119, scope: !54)
!404 = !DILocation(column: 5, line: 120, scope: !54)
!405 = !DILocation(column: 5, line: 121, scope: !54)
!406 = !DILocalVariable(file: !0, line: 235, name: "v", scope: !55, type: !321)
!407 = !DILocation(column: 1, line: 235, scope: !55)
!408 = !DILocalVariable(file: !0, line: 235, name: "idx", scope: !55, type: !11)
!409 = !DILocalVariable(file: !0, line: 235, name: "item", scope: !55, type: !12)
!410 = !DILocation(column: 5, line: 236, scope: !55)
!411 = !DILocation(column: 5, line: 237, scope: !55)
!412 = !DILocalVariable(file: !0, line: 93, name: "s", scope: !56, type: !66)
!413 = !DILocation(column: 1, line: 93, scope: !56)
!414 = !DILocalVariable(file: !0, line: 93, name: "idx", scope: !56, type: !11)
!415 = !DILocation(column: 5, line: 94, scope: !56)
!416 = !DILocalVariable(file: !0, line: 79, name: "s", scope: !57, type: !66)
!417 = !DILocation(column: 1, line: 79, scope: !57)
!418 = !DILocation(column: 5, line: 80, scope: !57)
!419 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !58, type: !321)
!420 = !DILocation(column: 1, line: 179, scope: !58)
!421 = !DILocalVariable(file: !0, line: 179, name: "new_cap", scope: !58, type: !11)
!422 = !DILocation(column: 5, line: 180, scope: !58)
!423 = !DILocation(column: 9, line: 181, scope: !58)
!424 = !DILocation(column: 5, line: 183, scope: !58)
!425 = !DILocation(column: 5, line: 184, scope: !58)
!426 = !DILocation(column: 5, line: 185, scope: !58)
!427 = !DILocation(column: 9, line: 186, scope: !58)
!428 = !DILocation(column: 5, line: 188, scope: !58)
!429 = !DILocation(column: 5, line: 189, scope: !58)
!430 = !DILocation(column: 5, line: 190, scope: !58)
!431 = !DILocalVariable(file: !0, line: 105, name: "s", scope: !59, type: !66)
!432 = !DILocation(column: 1, line: 105, scope: !59)
!433 = !DILocalVariable(file: !0, line: 105, name: "start", scope: !59, type: !11)
!434 = !DILocalVariable(file: !0, line: 105, name: "end", scope: !59, type: !11)
!435 = !DILocation(column: 5, line: 106, scope: !59)
!436 = !DILocalVariable(file: !0, line: 106, name: "result", scope: !59, type: !65)
!437 = !DILocation(column: 1, line: 106, scope: !59)
!438 = !DILocation(column: 5, line: 107, scope: !59)
!439 = !DILocation(column: 9, line: 108, scope: !59)
!440 = !DILocation(column: 5, line: 109, scope: !59)
!441 = !DILocation(column: 9, line: 110, scope: !59)
!442 = !DILocation(column: 5, line: 111, scope: !59)
!443 = !DILocation(column: 9, line: 112, scope: !59)
!444 = !DILocation(column: 9, line: 113, scope: !59)
!445 = !DILocation(column: 9, line: 114, scope: !59)
!446 = !DILocation(column: 5, line: 115, scope: !59)
!447 = !DILocation(column: 5, line: 116, scope: !59)
!448 = !DILocation(column: 5, line: 117, scope: !59)
!449 = !DILocalVariable(file: !0, line: 83, name: "s", scope: !60, type: !66)
!450 = !DILocation(column: 1, line: 83, scope: !60)
!451 = !DILocation(column: 5, line: 84, scope: !60)
!452 = !DILocation(column: 9, line: 85, scope: !60)
!453 = !DILocation(column: 5, line: 86, scope: !60)
!454 = !DILocalVariable(file: !0, line: 89, name: "s", scope: !61, type: !66)
!455 = !DILocation(column: 1, line: 89, scope: !61)
!456 = !DILocalVariable(file: !0, line: 89, name: "idx", scope: !61, type: !11)
!457 = !DILocation(column: 5, line: 90, scope: !61)
!458 = !DILocalVariable(file: !0, line: 97, name: "s", scope: !62, type: !66)
!459 = !DILocation(column: 1, line: 97, scope: !62)
!460 = !DILocation(column: 5, line: 98, scope: !62)
!461 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !63, type: !344)
!462 = !DILocation(column: 1, line: 193, scope: !63)
!463 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !63, type: !11)
!464 = !DILocation(column: 5, line: 194, scope: !63)
!465 = !DILocation(column: 9, line: 195, scope: !63)
!466 = !DILocation(column: 5, line: 197, scope: !63)
!467 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !63, type: !11)
!468 = !DILocation(column: 1, line: 197, scope: !63)
!469 = !DILocation(column: 5, line: 198, scope: !63)
!470 = !DILocation(column: 9, line: 199, scope: !63)
!471 = !DILocation(column: 5, line: 200, scope: !63)
!472 = !DILocation(column: 9, line: 201, scope: !63)
!473 = !DILocation(column: 5, line: 203, scope: !63)
!474 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !64, type: !344)
