...
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i8* %"item", metadata !199, metadata !7), !dbg !198
  %".7" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !200
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".7", i32 0, i32 1 , !dbg !200
  %".9" = load i64, i64* %".8", !dbg !200
  %".10" = add i64 %".9", 1, !dbg !200
  %".11" = call i32 @"vec_ensure_cap$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i64 %".10"), !dbg !200
  %".12" = sext i32 %".11" to i64 , !dbg !200
  %".13" = icmp ne i64 %".12", 0 , !dbg !200
  br i1 %".13", label %"if.then", label %"if.end", !dbg !200
if.then:
  %".15" = sub i64 0, 1, !dbg !201
  %".16" = trunc i64 %".15" to i32 , !dbg !201
  ret i32 %".16", !dbg !201
if.end:
  %".18" = load i8, i8* %"item", !dbg !202
  %".19" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !202
  %".20" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".19", i32 0, i32 0 , !dbg !202
  %".21" = load i8*, i8** %".20", !dbg !202
  %".22" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !202
  %".23" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".22", i32 0, i32 1 , !dbg !202
  %".24" = load i64, i64* %".23", !dbg !202
  %".25" = getelementptr i8, i8* %".21", i64 %".24" , !dbg !202
  store i8 %".18", i8* %".25", !dbg !202
  %".27" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !203
  %".28" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".27", i32 0, i32 1 , !dbg !203
  %".29" = load i64, i64* %".28", !dbg !203
  %".30" = add i64 %".29", 1, !dbg !203
  %".31" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !203
  %".32" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".31", i32 0, i32 1 , !dbg !203
  store i64 %".30", i64* %".32", !dbg !203
  %".34" = trunc i64 0 to i32 , !dbg !204
  ret i32 %".34", !dbg !204
}
...
entry:
  ...
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !208, metadata !7), !dbg !206
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !209, metadata !7), !dbg !206
  %".10" = load i64, i64* %"len", !dbg !210
  store i64 0, i64* %"i", !dbg !210
  br label %"for.cond", !dbg !210
for.cond:
  %".13" = load i64, i64* %"i", !dbg !210
  %".14" = icmp slt i64 %".13", %".10" , !dbg !210
  br i1 %".14", label %"for.body", label %"for.end", !dbg !210
for.body:
  %".16" = load i8*, i8** %"data", !dbg !210
  %".17" = load i64, i64* %"i", !dbg !210
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !210
  %".19" = load i8, i8* %".18", !dbg !210
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i8 %".19"), !dbg !210
  %".21" = sext i32 %".20" to i64 , !dbg !210
  %".22" = icmp ne i64 %".21", 0 , !dbg !210
  br i1 %".22", label %"if.then", label %"if.end", !dbg !210
for.incr:
  %".28" = load i64, i64* %"i", !dbg !211
  %".29" = add i64 %".28", 1, !dbg !211
  store i64 %".29", i64* %"i", !dbg !211
  br label %"for.cond", !dbg !211
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !212
  ret i32 %".32", !dbg !212
if.then:
  %".24" = sub i64 0, 1, !dbg !211
  %".25" = trunc i64 %".24" to i32 , !dbg !211
  ret i32 %".25", !dbg !211
if.end:
...
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !218
  ...
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !215, metadata !7), !dbg !214
  %".7" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !216
  %".8" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".7", i32 0, i32 2 , !dbg !216
  %".9" = load i64, i64* %".8", !dbg !216
  %".10" = load i64, i64* %"needed", !dbg !216
  %".11" = icmp sge i64 %".9", %".10" , !dbg !216
  br i1 %".11", label %"if.then", label %"if.end", !dbg !216
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !217
  ret i32 %".13", !dbg !217
if.end:
  %".15" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !218
  %".16" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".15", i32 0, i32 2 , !dbg !218
  %".17" = load i64, i64* %".16", !dbg !218
  store i64 %".17", i64* %"new_cap.addr", !dbg !218
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !219, metadata !7), !dbg !220
  %".20" = load i64, i64* %"new_cap.addr", !dbg !221
  %".21" = icmp eq i64 %".20", 0 , !dbg !221
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !221
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !222
  br label %"if.end.1", !dbg !222
if.end.1:
  br label %"while.cond", !dbg !223
while.cond:
  %".26" = load i64, i64* %"new_cap.addr", !dbg !223
  %".27" = load i64, i64* %"needed", !dbg !223
  %".28" = icmp slt i64 %".26", %".27" , !dbg !223
  br i1 %".28", label %"while.body", label %"while.end", !dbg !223
while.body:
  %".30" = load i64, i64* %"new_cap.addr", !dbg !224
  %".31" = mul i64 %".30", 2, !dbg !224
  store i64 %".31", i64* %"new_cap.addr", !dbg !224
  br label %"while.cond", !dbg !224
while.end:
  %".34" = load i64, i64* %"new_cap.addr", !dbg !225
  %".35" = call i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i64 %".34"), !dbg !225
  ret i32 %".35", !dbg !225
}
...
define linkonce_odr i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %"needed.arg") !dbg !48
{
entry:
  ...
  %".7" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !241
  %".8" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".7", i32 0, i32 2 , !dbg !241
  %".9" = load i64, i64* %".8", !dbg !241
  %".10" = load i64, i64* %"needed", !dbg !241
  %".11" = icmp sge i64 %".9", %".10" , !dbg !241
  br i1 %".11", label %"if.then", label %"if.end", !dbg !241
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !242
  ret i32 %".13", !dbg !242
if.end:
  %".15" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !243
  %".16" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".15", i32 0, i32 2 , !dbg !243
  %".17" = load i64, i64* %".16", !dbg !243
  store i64 %".17", i64* %"new_cap.addr", !dbg !243
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !244, metadata !7), !dbg !245
  %".20" = load i64, i64* %"new_cap.addr", !dbg !246
  %".21" = icmp eq i64 %".20", 0 , !dbg !246
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !246
if.then.1:
...
while.cond:
  %".26" = load i64, i64* %"new_cap.addr", !dbg !248
  %".27" = load i64, i64* %"needed", !dbg !248
  %".28" = icmp slt i64 %".26", %".27" , !dbg !248
  br i1 %".28", label %"while.body", label %"while.end", !dbg !248
while.body:
  %".30" = load i64, i64* %"new_cap.addr", !dbg !249
  %".31" = mul i64 %".30", 2, !dbg !249
  store i64 %".31", i64* %"new_cap.addr", !dbg !249
  br label %"while.cond", !dbg !249
while.end:
  %".34" = load i64, i64* %"new_cap.addr", !dbg !250
  %".35" = call i32 @"vec_grow$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %".34"), !dbg !250
  ret i32 %".35", !dbg !250
}

define linkonce_odr i8* @"span_as_ptr$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg") !dbg !49
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !251, metadata !7), !dbg !252
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !253
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 0 , !dbg !253
  %".7" = load i8*, i8** %".6", !dbg !253
  ret i8* %".7", !dbg !253
}

define linkonce_odr i8 @"span_get$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"idx.arg") !dbg !50
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !254, metadata !7), !dbg !255
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !256, metadata !7), !dbg !255
  %".8" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !257
  %".9" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".8", i32 0, i32 0 , !dbg !257
  %".10" = load i8*, i8** %".9", !dbg !257
  %".11" = load i64, i64* %"idx", !dbg !257
  %".12" = getelementptr i8, i8* %".10", i64 %".11" , !dbg !257
  %".13" = load i8, i8* %".12", !dbg !257
  ret i8 %".13", !dbg !257
}

define linkonce_odr i32 @"span_is_empty$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg") !dbg !51
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !258, metadata !7), !dbg !259
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !260
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 1 , !dbg !260
  %".7" = load i64, i64* %".6", !dbg !260
  %".8" = icmp eq i64 %".7", 0 , !dbg !260
  br i1 %".8", label %"if.then", label %"if.end", !dbg !260
if.then:
  %".10" = trunc i64 1 to i32 , !dbg !261
  ret i32 %".10", !dbg !261
if.end:
  %".12" = trunc i64 0 to i32 , !dbg !262
  ret i32 %".12", !dbg !262
}
...
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !263, metadata !7), !dbg !264
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !265
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 1 , !dbg !265
  %".7" = load i64, i64* %".6", !dbg !265
  ret i64 %".7", !dbg !265
}

define linkonce_odr i32 @"vec_grow$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i64 %"new_cap.arg") !dbg !53
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !266, metadata !7), !dbg !267
  %"new_cap" = alloca i64
  store i64 %"new_cap.arg", i64* %"new_cap"
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap", metadata !268, metadata !7), !dbg !267
  %".7" = load i64, i64* %"new_cap", !dbg !269
  %".8" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !269
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".8", i32 0, i32 2 , !dbg !269
  %".10" = load i64, i64* %".9", !dbg !269
  %".11" = icmp sle i64 %".7", %".10" , !dbg !269
  br i1 %".11", label %"if.then", label %"if.end", !dbg !269
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !270
  ret i32 %".13", !dbg !270
if.end:
  %".15" = load i64, i64* %"new_cap", !dbg !271
  %".16" = mul i64 %".15", 1, !dbg !271
  %".17" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !272
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".17", i32 0, i32 0 , !dbg !272
  %".19" = load i8*, i8** %".18", !dbg !272
  %".20" = call i8* @"realloc"(i8* %".19", i64 %".16"), !dbg !272
  %".21" = icmp eq i8* %".20", null , !dbg !273
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !273
if.then.1:
  %".23" = sub i64 0, 1, !dbg !274
  %".24" = trunc i64 %".23" to i32 , !dbg !274
  ret i32 %".24", !dbg !274
if.end.1:
  %".26" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !275
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".26", i32 0, i32 0 , !dbg !275
  store i8* %".20", i8** %".27", !dbg !275
  %".29" = load i64, i64* %"new_cap", !dbg !276
  %".30" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !276
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".30", i32 0, i32 2 , !dbg !276
  store i64 %".29", i64* %".31", !dbg !276
  %".33" = trunc i64 0 to i32 , !dbg !277
  ret i32 %".33", !dbg !277
}

define linkonce_odr i8* @"span_get_ptr$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"idx.arg") !dbg !54
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
...
!48 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 193, name: "vec_ensure_cap$LineBounds", scopeLine: 193, type: !4, unit: !1)
!49 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 97, name: "span_as_ptr$u8", scopeLine: 97, type: !4, unit: !1)
!50 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 89, name: "span_get$u8", scopeLine: 89, type: !4, unit: !1)
!51 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 83, name: "span_is_empty$u8", scopeLine: 83, type: !4, unit: !1)
!52 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 79, name: "span_len$u8", scopeLine: 79, type: !4, unit: !1)
!53 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 179, name: "vec_grow$u8", scopeLine: 179, type: !4, unit: !1)
!54 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 93, name: "span_get_ptr$u8", scopeLine: 93, type: !4, unit: !1)
...
!197 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !44, type: !196)
!198 = !DILocation(column: 1, line: 210, scope: !44)
!199 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !44, type: !12)
!200 = !DILocation(column: 5, line: 211, scope: !44)
!201 = !DILocation(column: 9, line: 212, scope: !44)
!202 = !DILocation(column: 5, line: 213, scope: !44)
!203 = !DILocation(column: 5, line: 214, scope: !44)
!204 = !DILocation(column: 5, line: 215, scope: !44)
!205 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !45, type: !196)
!206 = !DILocation(column: 1, line: 288, scope: !45)
!207 = !DIDerivedType(baseType: !12, size: 64, tag: DW_TAG_pointer_type)
!208 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !45, type: !207)
!209 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !45, type: !11)
!210 = !DILocation(column: 5, line: 289, scope: !45)
!211 = !DILocation(column: 13, line: 291, scope: !45)
!212 = !DILocation(column: 5, line: 292, scope: !45)
!213 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !46, type: !196)
!214 = !DILocation(column: 1, line: 193, scope: !46)
!215 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !46, type: !11)
!216 = !DILocation(column: 5, line: 194, scope: !46)
!217 = !DILocation(column: 9, line: 195, scope: !46)
!218 = !DILocation(column: 5, line: 197, scope: !46)
!219 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !46, type: !11)
!220 = !DILocation(column: 1, line: 197, scope: !46)
!221 = !DILocation(column: 5, line: 198, scope: !46)
!222 = !DILocation(column: 9, line: 199, scope: !46)
!223 = !DILocation(column: 5, line: 200, scope: !46)
!224 = !DILocation(column: 9, line: 201, scope: !46)
!225 = !DILocation(column: 5, line: 203, scope: !46)
...
!238 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !48, type: !228)
!239 = !DILocation(column: 1, line: 193, scope: !48)
!240 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !48, type: !11)
!241 = !DILocation(column: 5, line: 194, scope: !48)
!242 = !DILocation(column: 9, line: 195, scope: !48)
!243 = !DILocation(column: 5, line: 197, scope: !48)
!244 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !48, type: !11)
!245 = !DILocation(column: 1, line: 197, scope: !48)
!246 = !DILocation(column: 5, line: 198, scope: !48)
!247 = !DILocation(column: 9, line: 199, scope: !48)
!248 = !DILocation(column: 5, line: 200, scope: !48)
!249 = !DILocation(column: 9, line: 201, scope: !48)
!250 = !DILocation(column: 5, line: 203, scope: !48)
!251 = !DILocalVariable(file: !0, line: 97, name: "s", scope: !49, type: !67)
!252 = !DILocation(column: 1, line: 97, scope: !49)
!253 = !DILocation(column: 5, line: 98, scope: !49)
!254 = !DILocalVariable(file: !0, line: 89, name: "s", scope: !50, type: !67)
!255 = !DILocation(column: 1, line: 89, scope: !50)
!256 = !DILocalVariable(file: !0, line: 89, name: "idx", scope: !50, type: !11)
!257 = !DILocation(column: 5, line: 90, scope: !50)
!258 = !DILocalVariable(file: !0, line: 83, name: "s", scope: !51, type: !67)
!259 = !DILocation(column: 1, line: 83, scope: !51)
!260 = !DILocation(column: 5, line: 84, scope: !51)
!261 = !DILocation(column: 9, line: 85, scope: !51)
!262 = !DILocation(column: 5, line: 86, scope: !51)
!263 = !DILocalVariable(file: !0, line: 79, name: "s", scope: !52, type: !67)
!264 = !DILocation(column: 1, line: 79, scope: !52)
!265 = !DILocation(column: 5, line: 80, scope: !52)
!266 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !53, type: !196)
!267 = !DILocation(column: 1, line: 179, scope: !53)
!268 = !DILocalVariable(file: !0, line: 179, name: "new_cap", scope: !53, type: !11)
!269 = !DILocation(column: 5, line: 180, scope: !53)
!270 = !DILocation(column: 9, line: 181, scope: !53)
!271 = !DILocation(column: 5, line: 183, scope: !53)
!272 = !DILocation(column: 5, line: 184, scope: !53)
!273 = !DILocation(column: 5, line: 185, scope: !53)
!274 = !DILocation(column: 9, line: 186, scope: !53)
!275 = !DILocation(column: 5, line: 188, scope: !53)
!276 = !DILocation(column: 5, line: 189, scope: !53)
!277 = !DILocation(column: 5, line: 190, scope: !53)
!278 = !DILocalVariable(file: !0, line: 93, name: "s", scope: !54, type: !67)
!279 = !DILocation(column: 1, line: 93, scope: !54)
!280 = !DILocalVariable(file: !0, line: 93, name: "idx", scope: !54, type: !11)
!281 = !DILocation(column: 5, line: 94, scope: !54)
