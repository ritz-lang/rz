...
{
entry:
  %"i" = alloca i64, !dbg !217
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !212, metadata !7), !dbg !213
  %"data" = alloca i8*
  store i8* %"data.arg", i8** %"data"
  call void @"llvm.dbg.declare"(metadata i8** %"data", metadata !215, metadata !7), !dbg !213
  %"len" = alloca i64
  store i64 %"len.arg", i64* %"len"
  call void @"llvm.dbg.declare"(metadata i64* %"len", metadata !216, metadata !7), !dbg !213
  %".10" = load i64, i64* %"len", !dbg !217
  store i64 0, i64* %"i", !dbg !217
  br label %"for.cond", !dbg !217
for.cond:
  %".13" = load i64, i64* %"i", !dbg !217
  %".14" = icmp slt i64 %".13", %".10" , !dbg !217
  br i1 %".14", label %"for.body", label %"for.end", !dbg !217
for.body:
  %".16" = load i8*, i8** %"data", !dbg !217
  %".17" = load i64, i64* %"i", !dbg !217
  %".18" = getelementptr i8, i8* %".16", i64 %".17" , !dbg !217
  %".19" = load i8, i8* %".18", !dbg !217
  %".20" = call i32 @"vec_push$u8"(%"struct.ritz_module_1.Vec$u8"** %"v.arg", i8 %".19"), !dbg !217
  %".21" = sext i32 %".20" to i64 , !dbg !217
  %".22" = icmp ne i64 %".21", 0 , !dbg !217
  br i1 %".22", label %"if.then", label %"if.end", !dbg !217
for.incr:
  %".28" = load i64, i64* %"i", !dbg !218
  %".29" = add i64 %".28", 1, !dbg !218
  store i64 %".29", i64* %"i", !dbg !218
  br label %"for.cond", !dbg !218
for.end:
  %".32" = trunc i64 0 to i32 , !dbg !219
  ret i32 %".32", !dbg !219
if.then:
  %".24" = sub i64 0, 1, !dbg !218
  %".25" = trunc i64 %".24" to i32 , !dbg !218
  ret i32 %".25", !dbg !218
if.end:
  br label %"for.incr", !dbg !218
}

define linkonce_odr i32 @"vec_push$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", %"struct.ritz_module_1.LineBounds" %"item.arg") !dbg !49
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", metadata !223, metadata !7), !dbg !224
  ...
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.LineBounds"* %"item", metadata !226, metadata !7), !dbg !224
  %".7" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !227
  %".8" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".7", i32 0, i32 1 , !dbg !227
  %".9" = load i64, i64* %".8", !dbg !227
  %".10" = add i64 %".9", 1, !dbg !227
  %".11" = call i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %".10"), !dbg !227
  %".12" = sext i32 %".11" to i64 , !dbg !227
  %".13" = icmp ne i64 %".12", 0 , !dbg !227
  br i1 %".13", label %"if.then", label %"if.end", !dbg !227
if.then:
  %".15" = sub i64 0, 1, !dbg !228
  %".16" = trunc i64 %".15" to i32 , !dbg !228
  ret i32 %".16", !dbg !228
if.end:
  %".18" = load %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %"item", !dbg !229
  %".19" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !229
  %".20" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".19", i32 0, i32 0 , !dbg !229
  %".21" = load %"struct.ritz_module_1.LineBounds"*, %"struct.ritz_module_1.LineBounds"** %".20", !dbg !229
  %".22" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !229
  %".23" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".22", i32 0, i32 1 , !dbg !229
  %".24" = load i64, i64* %".23", !dbg !229
  %".25" = getelementptr %"struct.ritz_module_1.LineBounds", %"struct.ritz_module_1.LineBounds"* %".21", i64 %".24" , !dbg !229
  store %"struct.ritz_module_1.LineBounds" %".18", %"struct.ritz_module_1.LineBounds"* %".25", !dbg !229
  %".27" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !230
  %".28" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".27", i32 0, i32 1 , !dbg !230
  %".29" = load i64, i64* %".28", !dbg !230
  %".30" = add i64 %".29", 1, !dbg !230
  %".31" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !230
  %".32" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".31", i32 0, i32 1 , !dbg !230
  store i64 %".30", i64* %".32", !dbg !230
  %".34" = trunc i64 0 to i32 , !dbg !231
  ret i32 %".34", !dbg !231
}
...
{
entry:
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$u8"** %"v.arg", metadata !245, metadata !7), !dbg !246
  %"new_cap" = alloca i64
  store i64 %"new_cap.arg", i64* %"new_cap"
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap", metadata !247, metadata !7), !dbg !246
  %".7" = load i64, i64* %"new_cap", !dbg !248
  %".8" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !248
  %".9" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".8", i32 0, i32 2 , !dbg !248
  %".10" = load i64, i64* %".9", !dbg !248
  %".11" = icmp sle i64 %".7", %".10" , !dbg !248
  br i1 %".11", label %"if.then", label %"if.end", !dbg !248
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !249
  ret i32 %".13", !dbg !249
if.end:
  %".15" = load i64, i64* %"new_cap", !dbg !250
  %".16" = mul i64 %".15", 1, !dbg !250
  %".17" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !251
  %".18" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".17", i32 0, i32 0 , !dbg !251
  %".19" = load i8*, i8** %".18", !dbg !251
  %".20" = call i8* @"realloc"(i8* %".19", i64 %".16"), !dbg !251
  %".21" = icmp eq i8* %".20", null , !dbg !252
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !252
if.then.1:
  %".23" = sub i64 0, 1, !dbg !253
  %".24" = trunc i64 %".23" to i32 , !dbg !253
  ret i32 %".24", !dbg !253
if.end.1:
  %".26" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !254
  %".27" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".26", i32 0, i32 0 , !dbg !254
  store i8* %".20", i8** %".27", !dbg !254
  %".29" = load i64, i64* %"new_cap", !dbg !255
  %".30" = load %"struct.ritz_module_1.Vec$u8"*, %"struct.ritz_module_1.Vec$u8"** %"v.arg", !dbg !255
  %".31" = getelementptr %"struct.ritz_module_1.Vec$u8", %"struct.ritz_module_1.Vec$u8"* %".30", i32 0, i32 2 , !dbg !255
  store i64 %".29", i64* %".31", !dbg !255
  %".33" = trunc i64 0 to i32 , !dbg !256
  ret i32 %".33", !dbg !256
}

define linkonce_odr i64 @"span_len$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg") !dbg !52
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !257, metadata !7), !dbg !258
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !259
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 1 , !dbg !259
  %".7" = load i64, i64* %".6", !dbg !259
  ret i64 %".7", !dbg !259
}

define linkonce_odr i8 @"span_get$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"idx.arg") !dbg !53
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !260, metadata !7), !dbg !261
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !262, metadata !7), !dbg !261
  %".8" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !263
  %".9" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".8", i32 0, i32 0 , !dbg !263
  %".10" = load i8*, i8** %".9", !dbg !263
  %".11" = load i64, i64* %"idx", !dbg !263
  %".12" = getelementptr i8, i8* %".10", i64 %".11" , !dbg !263
  %".13" = load i8, i8* %".12", !dbg !263
  ret i8 %".13", !dbg !263
}

define linkonce_odr %"struct.ritz_module_1.Span$u8" @"span_slice$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"start.arg", i64 %"end.arg") !dbg !54
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  %"result.addr" = alloca %"struct.ritz_module_1.Span$u8", !dbg !268
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !264, metadata !7), !dbg !265
  %"start" = alloca i64
  store i64 %"start.arg", i64* %"start"
  call void @"llvm.dbg.declare"(metadata i64* %"start", metadata !266, metadata !7), !dbg !265
  %"end" = alloca i64
  store i64 %"end.arg", i64* %"end"
  call void @"llvm.dbg.declare"(metadata i64* %"end", metadata !267, metadata !7), !dbg !265
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"* %"result.addr", metadata !269, metadata !7), !dbg !270
  %".12" = load i64, i64* %"start", !dbg !271
  %".13" = icmp slt i64 %".12", 0 , !dbg !271
  br i1 %".13", label %"if.then", label %"if.end", !dbg !271
if.then:
  store i64 0, i64* %"start", !dbg !272
  br label %"if.end", !dbg !272
if.end:
  %".17" = load i64, i64* %"end", !dbg !273
  %".18" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !273
  %".19" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".18", i32 0, i32 1 , !dbg !273
  %".20" = load i64, i64* %".19", !dbg !273
  %".21" = icmp sgt i64 %".17", %".20" , !dbg !273
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !273
if.then.1:
  %".23" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !274
  %".24" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".23", i32 0, i32 1 , !dbg !274
  %".25" = load i64, i64* %".24", !dbg !274
  store i64 %".25", i64* %"end", !dbg !274
  br label %"if.end.1", !dbg !274
if.end.1:
  %".28" = load i64, i64* %"start", !dbg !275
  %".29" = load i64, i64* %"end", !dbg !275
  %".30" = icmp sge i64 %".28", %".29" , !dbg !275
  br i1 %".30", label %"if.then.2", label %"if.end.2", !dbg !275
if.then.2:
  %".32" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !276
  %".33" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 0 , !dbg !276
  store i8* null, i8** %".33", !dbg !276
  %".35" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !277
  %".36" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 1 , !dbg !277
  store i64 0, i64* %".36", !dbg !277
  %".38" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !278
  ret %"struct.ritz_module_1.Span$u8" %".38", !dbg !278
if.end.2:
  %".40" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !279
  %".41" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".40", i32 0, i32 0 , !dbg !279
  %".42" = load i8*, i8** %".41", !dbg !279
  %".43" = load i64, i64* %"start", !dbg !279
  %".44" = getelementptr i8, i8* %".42", i64 %".43" , !dbg !279
  %".45" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !279
  %".46" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 0 , !dbg !279
  store i8* %".44", i8** %".46", !dbg !279
  %".48" = load i64, i64* %"end", !dbg !280
  %".49" = load i64, i64* %"start", !dbg !280
  %".50" = sub i64 %".48", %".49", !dbg !280
  %".51" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !280
  %".52" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", i32 0, i32 1 , !dbg !280
  store i64 %".50", i64* %".52", !dbg !280
  %".54" = load %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %"result.addr", !dbg !281
  ret %"struct.ritz_module_1.Span$u8" %".54", !dbg !281
}

define linkonce_odr i32 @"vec_ensure_cap$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %"needed.arg") !dbg !55
{
entry:
  %"new_cap.addr" = alloca i64, !dbg !287
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", metadata !282, metadata !7), !dbg !283
  %"needed" = alloca i64
  store i64 %"needed.arg", i64* %"needed"
  call void @"llvm.dbg.declare"(metadata i64* %"needed", metadata !284, metadata !7), !dbg !283
  %".7" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !285
  %".8" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".7", i32 0, i32 2 , !dbg !285
  %".9" = load i64, i64* %".8", !dbg !285
  %".10" = load i64, i64* %"needed", !dbg !285
  %".11" = icmp sge i64 %".9", %".10" , !dbg !285
  br i1 %".11", label %"if.then", label %"if.end", !dbg !285
if.then:
  %".13" = trunc i64 0 to i32 , !dbg !286
  ret i32 %".13", !dbg !286
if.end:
  %".15" = load %"struct.ritz_module_1.Vec$LineBounds"*, %"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", !dbg !287
  %".16" = getelementptr %"struct.ritz_module_1.Vec$LineBounds", %"struct.ritz_module_1.Vec$LineBounds"* %".15", i32 0, i32 2 , !dbg !287
  %".17" = load i64, i64* %".16", !dbg !287
  store i64 %".17", i64* %"new_cap.addr", !dbg !287
  call void @"llvm.dbg.declare"(metadata i64* %"new_cap.addr", metadata !288, metadata !7), !dbg !289
  %".20" = load i64, i64* %"new_cap.addr", !dbg !290
  %".21" = icmp eq i64 %".20", 0 , !dbg !290
  br i1 %".21", label %"if.then.1", label %"if.end.1", !dbg !290
if.then.1:
  store i64 8, i64* %"new_cap.addr", !dbg !291
  br label %"if.end.1", !dbg !291
if.end.1:
  br label %"while.cond", !dbg !292
while.cond:
  %".26" = load i64, i64* %"new_cap.addr", !dbg !292
  %".27" = load i64, i64* %"needed", !dbg !292
  %".28" = icmp slt i64 %".26", %".27" , !dbg !292
  br i1 %".28", label %"while.body", label %"while.end", !dbg !292
while.body:
  %".30" = load i64, i64* %"new_cap.addr", !dbg !293
  %".31" = mul i64 %".30", 2, !dbg !293
  store i64 %".31", i64* %"new_cap.addr", !dbg !293
  br label %"while.cond", !dbg !293
while.end:
  %".34" = load i64, i64* %"new_cap.addr", !dbg !294
  %".35" = call i32 @"vec_grow$LineBounds"(%"struct.ritz_module_1.Vec$LineBounds"** %"v.arg", i64 %".34"), !dbg !294
  ret i32 %".35", !dbg !294
}

define linkonce_odr i8* @"span_as_ptr$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg") !dbg !56
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !295, metadata !7), !dbg !296
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !297
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 0 , !dbg !297
  %".7" = load i8*, i8** %".6", !dbg !297
  ret i8* %".7", !dbg !297
}

define linkonce_odr i8* @"span_get_ptr$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg", i64 %"idx.arg") !dbg !57
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !298, metadata !7), !dbg !299
  %"idx" = alloca i64
  store i64 %"idx.arg", i64* %"idx"
  call void @"llvm.dbg.declare"(metadata i64* %"idx", metadata !300, metadata !7), !dbg !299
  %".8" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !301
  %".9" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".8", i32 0, i32 0 , !dbg !301
  %".10" = load i8*, i8** %".9", !dbg !301
  %".11" = load i64, i64* %"idx", !dbg !301
  %".12" = getelementptr i8, i8* %".10", i64 %".11" , !dbg !301
  ret i8* %".12", !dbg !301
}

define linkonce_odr i32 @"span_is_empty$u8"(%"struct.ritz_module_1.Span$u8"* %"s.arg") !dbg !58
{
entry:
  %"s" = alloca %"struct.ritz_module_1.Span$u8"*
  store %"struct.ritz_module_1.Span$u8"* %"s.arg", %"struct.ritz_module_1.Span$u8"** %"s"
  call void @"llvm.dbg.declare"(metadata %"struct.ritz_module_1.Span$u8"** %"s", metadata !302, metadata !7), !dbg !303
  %".5" = load %"struct.ritz_module_1.Span$u8"*, %"struct.ritz_module_1.Span$u8"** %"s", !dbg !304
  %".6" = getelementptr %"struct.ritz_module_1.Span$u8", %"struct.ritz_module_1.Span$u8"* %".5", i32 0, i32 1 , !dbg !304
  %".7" = load i64, i64* %".6", !dbg !304
  %".8" = icmp eq i64 %".7", 0 , !dbg !304
  br i1 %".8", label %"if.then", label %"if.end", !dbg !304
if.then:
  %".10" = trunc i64 1 to i32 , !dbg !305
  ret i32 %".10", !dbg !305
if.end:
...
!49 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 210, name: "vec_push$LineBounds", scopeLine: 210, type: !4, unit: !1)
...
!52 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 79, name: "span_len$u8", scopeLine: 79, type: !4, unit: !1)
!53 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 89, name: "span_get$u8", scopeLine: 89, type: !4, unit: !1)
!54 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 105, name: "span_slice$u8", scopeLine: 105, type: !4, unit: !1)
...
!56 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 97, name: "span_as_ptr$u8", scopeLine: 97, type: !4, unit: !1)
!57 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 93, name: "span_get_ptr$u8", scopeLine: 93, type: !4, unit: !1)
!58 = distinct !DISubprogram(file: !0, isDefinition: true, isLocal: false, line: 83, name: "span_is_empty$u8", scopeLine: 83, type: !4, unit: !1)
...
!212 = !DILocalVariable(file: !0, line: 288, name: "v", scope: !48, type: !203)
!213 = !DILocation(column: 1, line: 288, scope: !48)
!214 = !DIDerivedType(baseType: !12, size: 64, tag: DW_TAG_pointer_type)
!215 = !DILocalVariable(file: !0, line: 288, name: "data", scope: !48, type: !214)
!216 = !DILocalVariable(file: !0, line: 288, name: "len", scope: !48, type: !11)
!217 = !DILocation(column: 5, line: 289, scope: !48)
!218 = !DILocation(column: 13, line: 291, scope: !48)
!219 = !DILocation(column: 5, line: 292, scope: !48)
!220 = !DICompositeType(align: 64, file: !0, name: "Vec$LineBounds", size: 192, tag: DW_TAG_structure_type)
!221 = !DIDerivedType(baseType: !220, size: 64, tag: DW_TAG_reference_type)
!222 = !DIDerivedType(baseType: !221, size: 64, tag: DW_TAG_reference_type)
!223 = !DILocalVariable(file: !0, line: 210, name: "v", scope: !49, type: !222)
!224 = !DILocation(column: 1, line: 210, scope: !49)
!225 = !DICompositeType(align: 64, file: !0, name: "LineBounds", size: 128, tag: DW_TAG_structure_type)
!226 = !DILocalVariable(file: !0, line: 210, name: "item", scope: !49, type: !225)
!227 = !DILocation(column: 5, line: 211, scope: !49)
!228 = !DILocation(column: 9, line: 212, scope: !49)
!229 = !DILocation(column: 5, line: 213, scope: !49)
!230 = !DILocation(column: 5, line: 214, scope: !49)
!231 = !DILocation(column: 5, line: 215, scope: !49)
...
!245 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !51, type: !203)
!246 = !DILocation(column: 1, line: 179, scope: !51)
!247 = !DILocalVariable(file: !0, line: 179, name: "new_cap", scope: !51, type: !11)
!248 = !DILocation(column: 5, line: 180, scope: !51)
!249 = !DILocation(column: 9, line: 181, scope: !51)
!250 = !DILocation(column: 5, line: 183, scope: !51)
!251 = !DILocation(column: 5, line: 184, scope: !51)
!252 = !DILocation(column: 5, line: 185, scope: !51)
!253 = !DILocation(column: 9, line: 186, scope: !51)
!254 = !DILocation(column: 5, line: 188, scope: !51)
!255 = !DILocation(column: 5, line: 189, scope: !51)
!256 = !DILocation(column: 5, line: 190, scope: !51)
!257 = !DILocalVariable(file: !0, line: 79, name: "s", scope: !52, type: !84)
!258 = !DILocation(column: 1, line: 79, scope: !52)
!259 = !DILocation(column: 5, line: 80, scope: !52)
!260 = !DILocalVariable(file: !0, line: 89, name: "s", scope: !53, type: !84)
!261 = !DILocation(column: 1, line: 89, scope: !53)
!262 = !DILocalVariable(file: !0, line: 89, name: "idx", scope: !53, type: !11)
!263 = !DILocation(column: 5, line: 90, scope: !53)
!264 = !DILocalVariable(file: !0, line: 105, name: "s", scope: !54, type: !84)
!265 = !DILocation(column: 1, line: 105, scope: !54)
!266 = !DILocalVariable(file: !0, line: 105, name: "start", scope: !54, type: !11)
!267 = !DILocalVariable(file: !0, line: 105, name: "end", scope: !54, type: !11)
!268 = !DILocation(column: 5, line: 106, scope: !54)
!269 = !DILocalVariable(file: !0, line: 106, name: "result", scope: !54, type: !83)
!270 = !DILocation(column: 1, line: 106, scope: !54)
!271 = !DILocation(column: 5, line: 107, scope: !54)
!272 = !DILocation(column: 9, line: 108, scope: !54)
!273 = !DILocation(column: 5, line: 109, scope: !54)
!274 = !DILocation(column: 9, line: 110, scope: !54)
!275 = !DILocation(column: 5, line: 111, scope: !54)
!276 = !DILocation(column: 9, line: 112, scope: !54)
!277 = !DILocation(column: 9, line: 113, scope: !54)
!278 = !DILocation(column: 9, line: 114, scope: !54)
!279 = !DILocation(column: 5, line: 115, scope: !54)
!280 = !DILocation(column: 5, line: 116, scope: !54)
!281 = !DILocation(column: 5, line: 117, scope: !54)
!282 = !DILocalVariable(file: !0, line: 193, name: "v", scope: !55, type: !222)
!283 = !DILocation(column: 1, line: 193, scope: !55)
!284 = !DILocalVariable(file: !0, line: 193, name: "needed", scope: !55, type: !11)
!285 = !DILocation(column: 5, line: 194, scope: !55)
!286 = !DILocation(column: 9, line: 195, scope: !55)
!287 = !DILocation(column: 5, line: 197, scope: !55)
!288 = !DILocalVariable(file: !0, line: 197, name: "new_cap", scope: !55, type: !11)
!289 = !DILocation(column: 1, line: 197, scope: !55)
!290 = !DILocation(column: 5, line: 198, scope: !55)
!291 = !DILocation(column: 9, line: 199, scope: !55)
!292 = !DILocation(column: 5, line: 200, scope: !55)
!293 = !DILocation(column: 9, line: 201, scope: !55)
!294 = !DILocation(column: 5, line: 203, scope: !55)
!295 = !DILocalVariable(file: !0, line: 97, name: "s", scope: !56, type: !84)
!296 = !DILocation(column: 1, line: 97, scope: !56)
!297 = !DILocation(column: 5, line: 98, scope: !56)
!298 = !DILocalVariable(file: !0, line: 93, name: "s", scope: !57, type: !84)
!299 = !DILocation(column: 1, line: 93, scope: !57)
!300 = !DILocalVariable(file: !0, line: 93, name: "idx", scope: !57, type: !11)
!301 = !DILocation(column: 5, line: 94, scope: !57)
!302 = !DILocalVariable(file: !0, line: 83, name: "s", scope: !58, type: !84)
!303 = !DILocation(column: 1, line: 83, scope: !58)
!304 = !DILocation(column: 5, line: 84, scope: !58)
!305 = !DILocation(column: 9, line: 85, scope: !58)
!306 = !DILocation(column: 5, line: 86, scope: !58)
!307 = !DILocalVariable(file: !0, line: 179, name: "v", scope: !59, type: !222)
